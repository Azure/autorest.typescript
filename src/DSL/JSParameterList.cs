...
namespace AutoRest.TypeScript.DSL
{
    ...
    public class JSParameterList
    {
        ...
        /// </summary>
        /// <param name="builder">The JSBuilder that will be used to collect the generated text.</param>
        public JSParameterList(JSBuilder builder)
        {
        ...
        public void Parameter(JSParameter parameter)
        {
