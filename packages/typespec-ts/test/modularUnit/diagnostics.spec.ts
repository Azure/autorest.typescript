...
describe("Diagnostic reporting tests", () => {
  it("should not crash when emitter encounters error conditions", async () => {
    ...
    const serializerFunction = await import("../../src/modular/serialization/buildSerializerFunction.js");
    const deserializerFunction = await import("../../src/modular/serialization/buildDeserializerFunction.js");
