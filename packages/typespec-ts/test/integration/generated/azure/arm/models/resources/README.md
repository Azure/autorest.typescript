# AzureArmResource REST client library for JavaScript
...
Install the AzureArmResource REST client REST client library for JavaScript with `npm`:

```bash
npm install @azure/arm-resources
```

### Create and authenticate a `AzureArmResourceClient`
