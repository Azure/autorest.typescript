# AzureLroRpc REST client library for JavaScript
...
Install the AzureLroRpc REST client REST client library for JavaScript with `npm`:

```bash
npm install @msinternal/lro-rpc
```

### Create and authenticate a `AzureLroRpcClient`
