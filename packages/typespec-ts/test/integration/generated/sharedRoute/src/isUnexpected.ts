...
export function isUnexpected(
  response: UpdateInt204Response | UpdateIntDefaultResponse
): response is UpdateIntDefaultResponse;
export function isUnexpected(
  response: ReturnsInt200Response | ReturnsIntDefaultResponse
): response is ReturnsIntDefaultResponse;
export function isUnexpected(
  response: ProcessInt200Response | ProcessIntDefaultResponse
): response is ProcessIntDefaultResponse;
export function isUnexpected(
  response:
    | ListByResourceGroup200Response
    | ListByResourceGroupDefaultResponse
