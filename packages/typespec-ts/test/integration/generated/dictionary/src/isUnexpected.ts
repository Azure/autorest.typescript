...
const responseMap: Record<string, string[]> = {
  "GET /type/dictionary/int32": ["200"],
  "PUT /type/dictionary/int32": ["204"],
  "GET /type/dictionary/int64": ["200"],
  "PUT /type/dictionary/int64": ["204"],
  "GET /type/dictionary/boolean": ["200"],
  "PUT /type/dictionary/boolean": ["204"],
  "GET /type/dictionary/string": ["200"],
  "PUT /type/dictionary/string": ["204"],
  "GET /type/dictionary/float32": ["200"],
  "PUT /type/dictionary/float32": ["204"],
  "GET /type/dictionary/datetime": ["200"],
  "PUT /type/dictionary/datetime": ["204"],
  "GET /type/dictionary/duration": ["200"],
  "PUT /type/dictionary/duration": ["204"],
  "GET /type/dictionary/unknown": ["200"],
  "PUT /type/dictionary/unknown": ["204"],
  "GET /type/dictionary/model": ["200"],
  "PUT /type/dictionary/model": ["204"],
  "GET /type/dictionary/model/recursive": ["200"],
  "PUT /type/dictionary/model/recursive": ["204"],
  "GET /type/dictionary/nullable-float": ["200"],
  "PUT /type/dictionary/nullable-float": ["204"],
};
...
export function isUnexpected(
  response:
    | RecursiveModelValueGet200Response
    | RecursiveModelValueGetDefaultResponse
): response is RecursiveModelValueGetDefaultResponse;
export function isUnexpected(
  response:
    | RecursiveModelValuePut204Response
    | RecursiveModelValuePutDefaultResponse
): response is RecursiveModelValuePutDefaultResponse;
export function isUnexpected(
  response:
    | NullableFloatValueGet200Response
    | NullableFloatValueGetDefaultResponse
