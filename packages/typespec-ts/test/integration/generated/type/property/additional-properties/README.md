...
### Install the `@msinternal/additional-property` package

Install the AdditionalProperties REST client REST client library for JavaScript with `npm`:

```bash
npm install @msinternal/additional-property
```
