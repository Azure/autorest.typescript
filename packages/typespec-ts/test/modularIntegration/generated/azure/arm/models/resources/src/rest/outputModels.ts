...
export type TopLevelTrackedResourceListResultOutput =
  Paged<TopLevelTrackedResourceOutput>;
/** The response of a NestedProxyResource list operation. */
export type NestedProxyResourceListResultOutput =
  Paged<NestedProxyResourceOutput>;
