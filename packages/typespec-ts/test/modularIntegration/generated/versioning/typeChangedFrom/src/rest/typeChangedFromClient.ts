...
export default function createClient(
  ...
  const userAgentInfo = `azsdk-js-versionning-typeChangedFrom-modular-rest/1.0.0-beta.1`;
  ...
  const client = getClient(endpointUrl, options) as TypeChangedFromContext;
