...
import {
  ...
  getClientStructureRenamedOperationGroupOperations,
} from "./group/index.js";
...
export interface ClientStructureRenamedOperationOperations {
  ...
  group: ClientStructureRenamedOperationGroupOperations;
}
...
export function getClientStructureRenamedOperationOperations(
  ...
  return {
    ...
    group: getClientStructureRenamedOperationGroupOperations(context),
  };
}
