...
import {
  getRecursiveModelValueOperations,
  RecursiveModelValueOperations,
} from "./classic/recursiveModelValue/index.js";
import {
...
export class DictionaryClient {
  ...
  constructor(options: DictionaryClientOptionalParams = {}) {
    ...
    this.recursiveModelValue = getRecursiveModelValueOperations(this._client);
  ...
  /** The operation groups for RecursiveModelValue */
  public readonly recursiveModelValue: RecursiveModelValueOperations;
