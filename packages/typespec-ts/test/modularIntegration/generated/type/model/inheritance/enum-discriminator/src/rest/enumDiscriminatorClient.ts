...
export default function createClient(
  ...
  const userAgentInfo = `azsdk-js-model-inheritance-enum-discriminator-modular-rest/1.0.0`;
  ...
  const client = getClient(endpointUrl, options) as EnumDiscriminatorContext;
