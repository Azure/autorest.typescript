...
export function _unionFloatLiteralGetAllSend(
  context: Client,
  options: UnionFloatLiteralGetAllOptions = { requestOptions: {} },
...
export function _unionFloatLiteralGetDefaultSend(
  context: Client,
  options: UnionFloatLiteralGetDefaultOptions = { requestOptions: {} },
...
export function _unionFloatLiteralPutAllSend(
  ...
  options: UnionFloatLiteralPutAllOptions = { requestOptions: {} },
...
export function _unionFloatLiteralPutDefaultSend(
  context: Client,
  body: UnionFloatLiteralProperty,
  options: UnionFloatLiteralPutDefaultOptions = { requestOptions: {} },
