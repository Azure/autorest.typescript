...
export function _stringGetAllSend(
  context: Client,
  options: StringGetAllOptions = { requestOptions: {} },
...
export function _stringGetDefaultSend(
  context: Client,
  options: StringGetDefaultOptions = { requestOptions: {} },
...
export function _stringPutAllSend(
  context: Client,
  body: StringProperty,
  options: StringPutAllOptions = { requestOptions: {} },
...
export function _stringPutDefaultSend(
  context: Client,
  body: StringProperty,
  options: StringPutDefaultOptions = { requestOptions: {} },
