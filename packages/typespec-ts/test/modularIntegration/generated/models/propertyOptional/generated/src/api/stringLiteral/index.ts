...
export function _stringLiteralGetAllSend(
  context: Client,
  options: StringLiteralGetAllOptions = { requestOptions: {} },
...
export function _stringLiteralGetDefaultSend(
  context: Client,
  options: StringLiteralGetDefaultOptions = { requestOptions: {} },
...
export function _stringLiteralPutAllSend(
  ...
  options: StringLiteralPutAllOptions = { requestOptions: {} },
...
export function _stringLiteralPutDefaultSend(
  context: Client,
  body: StringLiteralProperty,
  options: StringLiteralPutDefaultOptions = { requestOptions: {} },
