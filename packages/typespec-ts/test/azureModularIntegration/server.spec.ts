...
describe("Single Server Path Client", () => {
  ...
  beforeEach(() => {
    client = new SingleClient("http://localhost:3006", {
...
describe("Multiple Server Path Client", () => {
  ...
  beforeEach(() => {
    client = new MultipleClient("http://localhost:3006", {
      allowInsecureConnection: true,
      retryOptions: {
        maxRetries: 0
      }
...
describe("NotVersioned Server Version Client", () => {
  ...
  beforeEach(() => {
    client = new NotVersionedClient("http://localhost:3006", {
      allowInsecureConnection: true,
      retryOptions: {
        maxRetries: 0
      }
...
describe("Versioned Server Version Client", () => {
  ...
  beforeEach(() => {
    client = new VersionedClient("http://localhost:3006", {
      allowInsecureConnection: true,
      retryOptions: {
        maxRetries: 0
      }
