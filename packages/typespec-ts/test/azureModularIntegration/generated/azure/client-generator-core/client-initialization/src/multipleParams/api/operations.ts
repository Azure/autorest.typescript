...
import { MultipleParamsContext as Client } from "./index.js";
...
export function _withBodySend(
  ...
  const path = expandUrlTemplate(
    "/azure/client-generator-core/client-initialization/multiple-params/with-body{?region}",
    {
...
export function _withQuerySend(
  ...
  const path = expandUrlTemplate(
    "/azure/client-generator-core/client-initialization/multiple-params/with-query{?region,id}",
    {
      region: context.region,
      id: id,
    },
