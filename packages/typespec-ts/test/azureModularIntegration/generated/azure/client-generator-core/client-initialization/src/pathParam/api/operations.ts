...
import { PathParamContext as Client } from "./index.js";
import {
  BlobProperties,
  blobPropertiesDeserializer,
...
export async function _deleteStandaloneDeserialize(
...
export function _withQuerySend(
  ...
  const path = expandUrlTemplate(
    "/azure/client-generator-core/client-initialization/path/{blobName}/with-query{?format}",
    {
      blobName: context.blobName,
