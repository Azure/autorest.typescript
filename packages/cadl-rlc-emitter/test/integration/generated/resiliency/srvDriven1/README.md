...
# Azure ResiliencyServiceDriven1 client library for JavaScript
...
Install the Azure ResiliencyServiceDriven1 client REST client library for JavaScript with `npm`:
