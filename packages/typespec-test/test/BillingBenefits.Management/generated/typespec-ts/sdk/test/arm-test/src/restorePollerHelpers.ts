...
import { BillingBenefitsClient } from "./billingBenefitsClient.js";
import { _updateDeserialize } from "./api/discount/operations.js";
import { _createDeserialize } from "./api/reservationOrderAlias/operations.js";
...
const deserializeMap: Record<string, DeserializationHelper> = {
  ...
  "PATCH /providers/Microsoft.BillingBenefits/savingsPlanOrders/{savingsPlanOrderId}/savingsPlans/{savingsPlanId}":
    {
      deserializer: _updateDeserializeSavingsPlan,
  ...
  "PUT /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.BillingBenefits/discounts/{discountName}":
    {
      deserializer: _createDeserializeDiscounts,
      expectedStatuses: ["200", "201", "202"],
    },
};
