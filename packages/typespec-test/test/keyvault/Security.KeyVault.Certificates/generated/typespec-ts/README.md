...
- [API reference documentation](https://learn.microsoft.com/javascript/api/@azure/keyvault-certificates?view=azure-node-preview)
...
### Install the `@azure/keyvault-certificates` package
