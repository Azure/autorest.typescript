...
import { Attachments, AttachmentsOptionalParams } from "./attachments/attachments.js";
import { createTodoItems, TodoItemsContext, TodoItemsOptionalParams } from "./api/index.js";
...
import { $delete, update, get, createForm, createJson, list } from "./api/operations.js";
import {
...
export class TodoItems {
   ...
   */
  delete(id: number, options: DeleteOptionalParams = { requestOptions: {} }): Promise<void> {
  ...
  get(id: number, options: GetOptionalParams = { requestOptions: {} }): Promise<TodoItem> {
  ...
  list(options: ListOptionalParams = { requestOptions: {} }): PagedAsyncIterableIterator<TodoItem> {
