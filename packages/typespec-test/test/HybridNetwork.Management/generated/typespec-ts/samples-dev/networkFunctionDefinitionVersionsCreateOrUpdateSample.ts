 ...
 * x-ms-original-file: 2025-03-30/AzureCore/VirtualNetworkFunctionDefinitionVersionCreate.json
 */
async function createOrUpdateANetworkFunctionDefinitionVersionResourceForAzureCoreVNF(): Promise<void> {
  ...
  const result = await client.networkFunctionDefinitionVersions.createOrUpdate(
    "rg",
    "TestPublisher",
 ...
 *
 * @summary creates or updates a network function definition version.
 * x-ms-original-file: 2025-03-30/AzureOperatorNexus/VirtualNetworkFunctionDefinitionVersionCreate.json
 */
 ...
 *
 * @summary creates or updates a network function definition version.
 * x-ms-original-file: 2025-03-30/NetworkFunctionDefinitionVersionCreate.json
 */
