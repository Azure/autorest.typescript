...
export function apiKeyPropertiesDeserializer(item: any): APIKeyProperties {
  return {
    metadata: !item["metadata"]
      ? item["metadata"]
      : scMetadataEntityDeserializer(item["metadata"]),
    spec: !item["spec"]
      ? item["spec"]
      : apiKeySpecEntityDeserializer(item["spec"]),
  };
}
...
export function apiKeySpecEntityDeserializer(item: any): APIKeySpecEntity {
  return {
    ...
    owner: !item["owner"]
      ? item["owner"]
      : apiKeyOwnerEntityDeserializer(item["owner"]),
  };
}
...
export function apiKeyResourceEntityDeserializer(
  item: any,
...
export function listRegionsSuccessResponseDeserializer(
  item: any,
): ListRegionsSuccessResponse {
  return {
    data: !item["data"]
      ? item["data"]
      : regionRecordArrayDeserializer(item["data"]),
  };
}

export function regionRecordArrayDeserializer(
  result: Array<RegionRecord>,
): any[] {
  return result.map((item) => {
...
export function regionPropertiesDeserializer(item: any): RegionProperties {
  return {
    ...
    spec: !item["spec"]
      ? item["spec"]
      : regionSpecEntityDeserializer(item["spec"]),
  };
}
...
export function scEnvironmentRecordDeserializer(
  item: any,
): SCEnvironmentRecord {
  return {
    id: item["id"],
...
export function environmentPropertiesSerializer(
  item: EnvironmentProperties,
): any {
  return {
    ...
    metadata: !item["metadata"]
      ? item["metadata"]
      : scMetadataEntitySerializer(item["metadata"]),
  };
}

export function environmentPropertiesDeserializer(
  item: any,
...
export function streamGovernanceConfigSerializer(
  item: StreamGovernanceConfig,
): any {
  return { package: item["package"] };
}

export function streamGovernanceConfigDeserializer(
  item: any,
...
export function _getEnvironmentsResponseDeserializer(
  item: any,
...
export function scEnvironmentRecordArraySerializer(
  result: Array<SCEnvironmentRecord>,
): any[] {
  return result.map((item) => {
...
export function scEnvironmentRecordArrayDeserializer(
  result: Array<SCEnvironmentRecord>,
): any[] {
  return result.map((item) => {
...
export function schemaRegistryClusterRecordDeserializer(
  item: any,
...
export function schemaRegistryClusterPropertiesDeserializer(
  ...
  return {
    ...
    spec: !item["spec"]
      ? item["spec"]
      : schemaRegistryClusterSpecEntityDeserializer(item["spec"]),
    status: !item["status"]
      ? item["status"]
...
export function schemaRegistryClusterSpecEntityDeserializer(
  ...
  return {
    ...
    region: !item["region"]
      ? item["region"]
      : schemaRegistryClusterEnvironmentRegionEntityDeserializer(
          item["region"],
        ),
    environment: !item["environment"]
      ? item["environment"]
...
export function clusterPropertiesSerializer(item: ClusterProperties): any {
  return {
    ...
    spec: !item["spec"]
      ? item["spec"]
      : scClusterSpecEntitySerializer(item["spec"]),
    status: !item["status"]
      ? item["status"]
      : clusterStatusEntitySerializer(item["status"]),
  };
}
...
export function clusterPropertiesDeserializer(item: any): ClusterProperties {
  return {
    ...
    spec: !item["spec"]
      ? item["spec"]
      : scClusterSpecEntityDeserializer(item["spec"]),
    status: !item["status"]
      ? item["status"]
      : clusterStatusEntityDeserializer(item["status"]),
  };
...
export function scClusterSpecEntitySerializer(item: SCClusterSpecEntity): any {
  return {
    ...
    config: !item["config"]
      ? item["config"]
      : clusterConfigEntitySerializer(item["config"]),
    environment: !item["environment"]
      ? item["environment"]
    ...
    byok: !item["byok"]
      ? item["byok"]
      : scClusterByokEntitySerializer(item["byok"]),
  };
}

export function scClusterSpecEntityDeserializer(
  item: any,
): SCClusterSpecEntity {
  return {
    name: item["name"],
    ...
    byok: !item["byok"]
      ? item["byok"]
      : scClusterByokEntityDeserializer(item["byok"]),
  };
}
...
export function scClusterByokEntityDeserializer(
  item: any,
): SCClusterByokEntity {
  return {
    id: item["id"],
...
export function _listClustersSuccessResponseDeserializer(
  item: any,
...
export function scClusterRecordArraySerializer(
  result: Array<SCClusterRecord>,
): any[] {
  return result.map((item) => {
...
export function scClusterRecordArrayDeserializer(
  result: Array<SCClusterRecord>,
): any[] {
  return result.map((item) => {
...
export function connectorResourcePropertiesSerializer(
  item: ConnectorResourceProperties,
): any {
  return {
    ...
    connectorServiceTypeInfo: !item["connectorServiceTypeInfo"]
      ...
      : connectorServiceTypeInfoBaseUnionSerializer(
          item["connectorServiceTypeInfo"],
        ),
...
export function connectorResourcePropertiesDeserializer(
  ...
  return {
    ...
    connectorServiceTypeInfo: !item["connectorServiceTypeInfo"]
      ? item["connectorServiceTypeInfo"]
      : connectorServiceTypeInfoBaseUnionDeserializer(
          item["connectorServiceTypeInfo"],
        ),
    partnerConnectorInfo: !item["partnerConnectorInfo"]
      ? item["partnerConnectorInfo"]
...
export function connectorServiceTypeInfoBaseSerializer(
  item: ConnectorServiceTypeInfoBase,
): any {
  return { connectorServiceType: item["connectorServiceType"] };
}

export function connectorServiceTypeInfoBaseDeserializer(
  item: any,
...
export function partnerInfoBaseUnionSerializer(
  item: PartnerInfoBaseUnion,
): any {
...
export function partnerInfoBaseUnionDeserializer(
  item: any,
...
export function connectorResourceArraySerializer(
  result: Array<ConnectorResource>,
): any[] {
  return result.map((item) => {
...
export function connectorResourceArrayDeserializer(
  result: Array<ConnectorResource>,
): any[] {
  return result.map((item) => {
...
export function topicMetadataEntityDeserializer(
  item: any,
): TopicMetadataEntity {
  return {
    self: item["self"],
...
export function topicsInputConfigArraySerializer(
  result: Array<TopicsInputConfig>,
): any[] {
  return result.map((item) => {
...
export function topicsInputConfigArrayDeserializer(
  result: Array<TopicsInputConfig>,
): any[] {
  return result.map((item) => {
...
export function _listTopicsSuccessResponseDeserializer(
  item: any,
...
export function topicRecordArrayDeserializer(
  result: Array<TopicRecord>,
): any[] {
  return result.map((item) => {
...
export function confluentAgreementResourceSerializer(
...
export function confluentAgreementResourceDeserializer(
  item: any,
...
export function confluentAgreementPropertiesSerializer(
  item: ConfluentAgreementProperties,
): any {
  return {
...
export function confluentAgreementPropertiesDeserializer(
  item: any,
