...
export function $delete(
  ...
  return getLongRunningPoller(
    ...
    ["200", "202", "204"],
    {
      ...
      getInitialResponse: () =>
        _$deleteSend(context, resourceGroupName, organizationName, options),
...
export function _createSend(
  ...
  return context
    ...
    .put({
      ...
      body: !options["body"]
        ? options["body"]
        : organizationResourceSerializer(options["body"]),
    });
}
...
export function create(
  ...
  return getLongRunningPoller(
    ...
    ["200", "201", "202"],
    {
      ...
      abortSignal: options?.abortSignal,
      getInitialResponse: () =>
        _createSend(context, resourceGroupName, organizationName, options),
