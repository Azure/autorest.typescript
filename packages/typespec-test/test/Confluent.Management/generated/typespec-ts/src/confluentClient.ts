...
import {
  createConfluent,
  ConfluentContext,
  ConfluentClientOptionalParams,
} from "./api/index.js";
import {
  ValidationsOperations,
  _getValidationsOperations,
} from "./classic/validations/index.js";
import {
...
import {
  TopicsOperations,
  _getTopicsOperations,
} from "./classic/topics/index.js";
import {
  ConnectorOperations,
...
import {
  ClusterOperations,
  _getClusterOperations,
} from "./classic/cluster/index.js";
import {
...
export { ConfluentClientOptionalParams } from "./api/confluentContext.js";

export class ConfluentClient {
  private _client: ConfluentContext;
  ...
  constructor(
    ...
    options: ConfluentClientOptionalParams = {},
  ) {
    const prefixFromOptions = options?.userAgentOptions?.userAgentPrefix;
    const userAgentPrefix = prefixFromOptions
      ? `${prefixFromOptions} azsdk-js-client`
      : `azsdk-js-client`;
    this._client = createConfluent(credential, subscriptionId, {
      ...options,
      userAgentOptions: { userAgentPrefix },
    });
    this.pipeline = this._client.pipeline;
    this.validations = _getValidationsOperations(this._client);
    this.marketplaceAgreements = _getMarketplaceAgreementsOperations(
      this._client,
    );
