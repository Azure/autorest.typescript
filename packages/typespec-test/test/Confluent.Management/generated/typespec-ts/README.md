...
### Create and authenticate a `ConfluentClient`
...
```ts 
import { ConfluentClient } from "@azure/arm-confluent";
import { DefaultAzureCredential } from "@azure/identity";

const subscriptionId = "00000000-0000-0000-0000-000000000000";
const client = new ConfluentClient(new DefaultAzureCredential(), subscriptionId);
```
...
const subscriptionId = "00000000-0000-0000-0000-000000000000";
const client = new ConfluentClient(credential, subscriptionId);
```
...
`ConfluentClient` is the primary interface for developers using the Azure ConfluentManagement client library. Explore the methods on this client object to understand the different features of the Azure ConfluentManagement service that you can access.
