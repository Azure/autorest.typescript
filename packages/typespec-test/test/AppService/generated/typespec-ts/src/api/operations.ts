...
export function _verifyHostingEnvironmentVnetSend(
  ...
  return context
    ...
    .post({
      ...
      body: vnetParametersSerializer(body),
    });
}
...
export async function verifyHostingEnvironmentVnet(
  ...
  const result = await _verifyHostingEnvironmentVnetSend(context, body, options);
...
export function _regionalCheckNameAvailabilitySend(
  ...
  return context
    ...
    .post({
      ...
      contentType: "application/json",
      headers: { accept: "application/json", ...options.requestOptions?.headers },
      body: dnlResourceNameAvailabilityRequestSerializer(body),
    });
}
...
export async function regionalCheckNameAvailability(
  ...
  const result = await _regionalCheckNameAvailabilitySend(context, location, body, options);
