# Azure ContainerServiceFleet REST client library for JavaScript
...
Install the Azure ContainerServiceFleet REST client REST client library for JavaScript with `npm`:
