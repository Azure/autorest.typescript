...
import { createHelpRP, HelpRPContext, HelpRPOptionalParams } from "./api/index.js";
import {
...
export { HelpRPOptionalParams } from "./api/helpRPContext.js";

export class HelpRP {
  private _client: HelpRPContext;
  ...
  constructor(credential: TokenCredential, options: HelpRPOptionalParams = {}) {
    ...
    const userAgentPrefix = prefixFromOptions
      ...
      : `azsdk-js-client`;
    this._client = createHelpRP(credential, { ...options, userAgentOptions: { userAgentPrefix } });
