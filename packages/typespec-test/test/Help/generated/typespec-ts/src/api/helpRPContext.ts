...
/** Help RP provider */
export interface HelpRPContext extends Client {
...
export function createHelpRP(
  ...
  const userAgentInfo = `azsdk-js-arm-selfhelp/1.0.0-beta.1`;
  ...
  const apiVersion = options.apiVersion ?? "2024-03-01-preview";
  ...
  return { ...clientContext, apiVersion } as HelpRPContext;
}
