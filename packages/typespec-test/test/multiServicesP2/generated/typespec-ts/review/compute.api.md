...
// @public
export interface ComputeActionGroupsGetOptionalParams extends OperationOptions {
    // (undocumented)
    expand?: string;
}

// @public
export interface ComputeActionGroupsOperations {
    get: (resourceGroupName: string, actionGroupName: string, options?: ComputeActionGroupsGetOptionalParams) => Promise<ComputeActionGroup>;
}
...
// @public
export interface ComputeDiskActionGroupsListOptionalParams extends OperationOptions {
}
