...
export async function _snapshotGetDeserialize(
  result: SnapshotGet200Response | SnapshotGetDefaultResponse,
...
export function _snapshotListByReportResourceSend(
  context: Client,
  reportName: string,
  options: SnapshotListByReportResourceOptionalParams = { requestOptions: {} },
): StreamableMethod<
  | SnapshotListByReportResource200Response
  | SnapshotListByReportResourceDefaultResponse
> {
...
export async function _snapshotListByReportResourceDeserialize(
  result:
    | SnapshotListByReportResource200Response
    | SnapshotListByReportResourceDefaultResponse,
...
export function snapshotListByReportResource(
  context: Client,
  reportName: string,
  options: SnapshotListByReportResourceOptionalParams = { requestOptions: {} },
  ...
  return buildPagedAsyncIterator(
    context,
    () => _snapshotListByReportResourceSend(context, reportName, options),
    _snapshotListByReportResourceDeserialize,
...
export async function _snapshotDownloadDeserialize(
  ...
  result = result as SnapshotDownloadLogicalResponse;
  return {
    resourceList:
...
export function snapshotDownload(
  ...
  return getLongRunningPoller(context, _snapshotDownloadDeserialize, {
