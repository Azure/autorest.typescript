...
import {
  ...
  _updateDeserialize,
  _$deleteDeserialize,
  _syncCertRecordDeserialize,
  _fixDeserialize,
  _verifyDeserialize,
} from "./api/reportResources/index.js";
import { _downloadDeserialize } from "./api/snapshotResources/index.js";
import {
  _onboardDeserialize,
  _triggerEvaluationDeserialize,
...
export function restorePoller<TResponse extends PathUncheckedResponse, TResult>(
  client: AppComplianceAutomationContext | AppComplianceAutomationClient,
