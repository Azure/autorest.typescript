...
export async function getLongRunningPoller<
  TResult extends ReportUpdateLogicalResponse | ReportUpdateDefaultResponse,
>(
  client: Client,
  initialResponse:
    | ReportUpdate200Response
...
export async function getLongRunningPoller<
  TResult extends ReportDeleteLogicalResponse | ReportDeleteDefaultResponse,
>(
  client: Client,
  initialResponse:
    | ReportDelete202Response
...
export async function getLongRunningPoller<
  TResult extends ReportFixLogicalResponse | ReportFixDefaultResponse,
>(
  client: Client,
  initialResponse:
    | ReportFix200Response
...
export async function getLongRunningPoller<
  TResult extends ReportVerifyLogicalResponse | ReportVerifyDefaultResponse,
>(
  client: Client,
  initialResponse:
    | ReportVerify200Response
