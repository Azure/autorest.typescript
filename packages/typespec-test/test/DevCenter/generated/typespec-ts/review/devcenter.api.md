## API Report File for "@azure/devcenter"
...
// @public
function createClient(endpointParam: string, credentials: TokenCredential, { apiVersion, ...options }?: DevCenterServiceClientOptions): DevCenterServiceClient;
