...
/**
 * This sample demonstrates how to call operation GetDeviceClassSubgroupDeploymentStatus
 *
 * @summary call operation GetDeviceClassSubgroupDeploymentStatus
 */
async function deviceManagementGetDeviceClassSubgroupDeploymentStatusSample() {
...
async function main() {
  deviceManagementGetDeviceClassSubgroupDeploymentStatusSample();
}
