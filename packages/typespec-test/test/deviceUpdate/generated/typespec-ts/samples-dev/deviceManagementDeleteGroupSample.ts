...
/**
 * This sample demonstrates how to call operation DeleteGroup
 *
 * @summary call operation DeleteGroup
 */
async function deviceManagementDeleteGroupSample() {
...
async function main() {
  deviceManagementDeleteGroupSample();
}
