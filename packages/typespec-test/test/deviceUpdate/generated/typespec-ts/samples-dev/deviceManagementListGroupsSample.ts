...
/**
 * This sample demonstrates how to call operation ListGroups
 *
 * @summary call operation ListGroups
 */
async function deviceManagementListGroupsSample() {
...
async function main() {
  deviceManagementListGroupsSample();
}
