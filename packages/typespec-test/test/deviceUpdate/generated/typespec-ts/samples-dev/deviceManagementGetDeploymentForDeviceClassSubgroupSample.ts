...
/**
 * This sample demonstrates how to call operation GetDeploymentForDeviceClassSubgroup
 *
 * @summary call operation GetDeploymentForDeviceClassSubgroup
 */
async function deviceManagementGetDeploymentForDeviceClassSubgroupSample() {
...
async function main() {
  deviceManagementGetDeploymentForDeviceClassSubgroupSample();
}
