...
import { createAgents, AgentsContext, AgentsOptionalParams } from "./api/index.js";
import {
  Agent,
...
export { AgentsOptionalParams } from "./api/agentsContext.js";
...
export class Agents {
  ...
  constructor(
    ...
    options: AgentsOptionalParams = {},
  ) {
    const prefixFromOptions = options?.userAgentOptions?.userAgentPrefix;
    const userAgentPrefix = prefixFromOptions
      ? `${prefixFromOptions} azsdk-js-client`
      : `azsdk-js-client`;
    this._client = createAgents(
      endpointParam,
      subscriptionId,
      resourceGroupName,
      projectName,
