...
import { ClientClient } from "./clientDefinitions.js";
...
/**
 * Initialize a new instance of `ClientClient`
...
export default function createClient(
  ...
  { apiVersion = "2024-07-01-preview", ...options }: ClientClientOptions = {},
): ClientClient {
  const endpointUrl =
    options.endpoint ??
    options.baseUrl ??
  ...
  const userAgentInfo = `azsdk-js-ai-client-rest/1.0.0-beta.1`;
  ...
  const client = getClient(endpointUrl, credentials, options) as ClientClient;
