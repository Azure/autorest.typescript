...
export function monitoringDataPointSerializer(item: MonitoringDataPoint): any {
  return {
    ...
    Metrics: !item["metrics"]
      ? item["metrics"]
      : metricPointArraySerializer(item["metrics"]),
    ...
    CollectionConfigurationErrors: !item["collectionConfigurationErrors"]
      ...
      : collectionConfigurationErrorArraySerializer(
          item["collectionConfigurationErrors"],
        ),
  };
}
...
export function documentIngressUnionArraySerializer(
  result: Array<DocumentIngressUnion>,
): any[] {
  return result.map((item) => {
...
export function keyValuePairStringStringSerializer(
  item: KeyValuePairStringString,
): any {
...
export function processCpuDataArraySerializer(
  result: Array<ProcessCpuData>,
): any[] {
  return result.map((item) => {
...
export function collectionConfigurationErrorSerializer(
  item: CollectionConfigurationError,
): any {
  return {
...
export function collectionConfigurationInfoDeserializer(
  item: any,
): CollectionConfigurationInfo {
  return {
    eTag: item["ETag"],
    metrics: derivedMetricInfoArrayDeserializer(item["Metrics"]),
    documentStreams: documentStreamInfoArrayDeserializer(
      item["DocumentStreams"],
    ),
...
export function derivedMetricInfoArrayDeserializer(
  result: Array<DerivedMetricInfo>,
): any[] {
  return result.map((item) => {
...
export function derivedMetricInfoDeserializer(item: any): DerivedMetricInfo {
  return {
    ...
    filterGroups: filterConjunctionGroupInfoArrayDeserializer(
      item["FilterGroups"],
    ),
...
export function filterConjunctionGroupInfoDeserializer(
  item: any,
...
export function documentStreamInfoArrayDeserializer(
  result: Array<DocumentStreamInfo>,
): any[] {
  return result.map((item) => {
...
export function quotaConfigurationInfoDeserializer(
  item: any,
...
export function monitoringDataPointArraySerializer(
  result: Array<MonitoringDataPoint>,
): any[] {
  return result.map((item) => {
