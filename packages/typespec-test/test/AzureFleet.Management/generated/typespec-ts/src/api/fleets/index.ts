    ...
    properties: !res.body.properties
      ...
      : {
          ...
          spotPriorityProfile: !res.body.properties?.spotPriorityProfile
            ...
            : {
                capacity:
                  res.body.properties?.spotPriorityProfile?.["capacity"],
                minCapacity:
                  res.body.properties?.spotPriorityProfile?.["minCapacity"],
                maxPricePerVM:
                  res.body.properties?.spotPriorityProfile?.["maxPricePerVM"],
                evictionPolicy:
                  res.body.properties?.spotPriorityProfile?.["evictionPolicy"],
                allocationStrategy:
                  res.body.properties?.spotPriorityProfile?.[
                    "allocationStrategy"
                  ],
                maintain:
                  res.body.properties?.spotPriorityProfile?.["maintain"],
              },
          regularPriorityProfile: !res.body.properties?.regularPriorityProfile
            ? undefined
            : {
                capacity:
                  res.body.properties?.regularPriorityProfile?.["capacity"],
                minCapacity:
                  res.body.properties?.regularPriorityProfile?.["minCapacity"],
                allocationStrategy:
                  res.body.properties?.regularPriorityProfile?.[
                    "allocationStrategy"
                  ],
              },
          ...
          computeProfile: {
            baseVirtualMachineProfile: {
              osProfile: !res.body.properties?.computeProfile
                .baseVirtualMachineProfile.osProfile
                ? undefined
                : {
                    computerNamePrefix:
                      ...
                      : {
                          ...
                          patchSettings: !res.body.properties?.computeProfile
                            ...
                            : {
                                ...
                                automaticByPlatformSettings: !res.body
                                  .properties?.computeProfile
                                  .baseVirtualMachineProfile.osProfile
                                  ?.windowsConfiguration?.patchSettings
                                  ?.automaticByPlatformSettings
                          ...
                          winRM: !res.body.properties?.computeProfile
                            .baseVirtualMachineProfile.osProfile
                            ?.windowsConfiguration?.winRM
                            ? undefined
                            : {
                    ...
                    linuxConfiguration: !res.body.properties?.computeProfile
                      ...
                      : {
                          ...
                          ssh: !res.body.properties?.computeProfile
                            .baseVirtualMachineProfile.osProfile
                            ?.linuxConfiguration?.ssh
                            ? undefined
                            : {
              ...
              storageProfile: !res.body.properties?.computeProfile
                .baseVirtualMachineProfile.storageProfile
                ? undefined
                : {
                    imageReference: !res.body.properties?.computeProfile
                      .baseVirtualMachineProfile.storageProfile?.imageReference
                      ? undefined
                      : {
                          ...
                          offer:
                            res.body.properties?.computeProfile
                              .baseVirtualMachineProfile.storageProfile
                              ?.imageReference?.["offer"],
                          sku: res.body.properties?.computeProfile
                            .baseVirtualMachineProfile.storageProfile
                            ?.imageReference?.["sku"],
                          version:
                            res.body.properties?.computeProfile
                    ...
                    osDisk: !res.body.properties?.computeProfile
                      .baseVirtualMachineProfile.storageProfile?.osDisk
                      ? undefined
                      : {
                          name: res.body.properties?.computeProfile
                            .baseVirtualMachineProfile.storageProfile?.osDisk?.[
                            "name"
                          ],
                          caching:
                          ...
                          osType:
                            res.body.properties?.computeProfile
                              .baseVirtualMachineProfile.storageProfile
                              ?.osDisk?.["osType"],
                          image: !res.body.properties?.computeProfile
                            .baseVirtualMachineProfile.storageProfile?.osDisk
                            ?.image
                            ? undefined
                            : {
                                uri: res.body.properties?.computeProfile
                                  .baseVirtualMachineProfile.storageProfile
                                  ?.osDisk?.image?.["uri"],
                              },
                          vhdContainers:
                          ...
                          managedDisk: !res.body.properties?.computeProfile
                            ...
                            : {
                                ...
                                diskEncryptionSet: !res.body.properties
                                  ?.computeProfile.baseVirtualMachineProfile
                                  .storageProfile?.osDisk?.managedDisk
                                  ?.diskEncryptionSet
                                  ? undefined
                                ...
                                securityProfile: !res.body.properties
                                  ?.computeProfile.baseVirtualMachineProfile
                                  .storageProfile?.osDisk?.managedDisk
                                  ?.securityProfile
                                  ? undefined
              ...
              networkProfile: !res.body.properties?.computeProfile
                .baseVirtualMachineProfile.networkProfile
                ? undefined
                : {
                    healthProbe: !res.body.properties?.computeProfile
                      .baseVirtualMachineProfile.networkProfile?.healthProbe
                      ? undefined
                      : {
                          id: res.body.properties?.computeProfile
              ...
              securityProfile: !res.body.properties?.computeProfile
                ...
                ? undefined
                : {
                    uefiSettings: !res.body.properties?.computeProfile
                      .baseVirtualMachineProfile.securityProfile?.uefiSettings
                      ? undefined
                      : {
                          secureBootEnabled:
                      ...
                      : {
                          enabled:
                            res.body.properties?.computeProfile
                              .baseVirtualMachineProfile.securityProfile
                              ?.proxyAgentSettings?.["enabled"],
                          mode: res.body.properties?.computeProfile
                            .baseVirtualMachineProfile.securityProfile
                            ?.proxyAgentSettings?.["mode"],
                          keyIncarnationId:
                            res.body.properties?.computeProfile
              ...
              diagnosticsProfile: !res.body.properties?.computeProfile
                .baseVirtualMachineProfile.diagnosticsProfile
                ? undefined
                : {
                    bootDiagnostics: !res.body.properties?.computeProfile
                      .baseVirtualMachineProfile.diagnosticsProfile
                      ?.bootDiagnostics
                      ? undefined
                      : {
              ...
              extensionProfile: !res.body.properties?.computeProfile
                .baseVirtualMachineProfile.extensionProfile
                ? undefined
                : {
                    extensions:
              ...
              scheduledEventsProfile: !res.body.properties?.computeProfile
                .baseVirtualMachineProfile.scheduledEventsProfile
                ? undefined
                : {
                    terminateNotificationProfile: !res.body.properties
                      ?.computeProfile.baseVirtualMachineProfile
                      .scheduledEventsProfile?.terminateNotificationProfile
                      ? undefined
                      : {
                    ...
                    osImageNotificationProfile: !res.body.properties
                      ?.computeProfile.baseVirtualMachineProfile
                      .scheduledEventsProfile?.osImageNotificationProfile
                      ? undefined
                      : {
              ...
              capacityReservation: !res.body.properties?.computeProfile
                .baseVirtualMachineProfile.capacityReservation
                ? undefined
                : {
                    capacityReservationGroup: !res.body.properties
                      ?.computeProfile.baseVirtualMachineProfile
                      .capacityReservation?.capacityReservationGroup
                      ? undefined
                      : {
              ...
              applicationProfile: !res.body.properties?.computeProfile
                .baseVirtualMachineProfile.applicationProfile
                ? undefined
                : {
                    galleryApplications:
              ...
              hardwareProfile: !res.body.properties?.computeProfile
                .baseVirtualMachineProfile.hardwareProfile
                ? undefined
                : {
                    vmSizeProperties: !res.body.properties?.computeProfile
                      .baseVirtualMachineProfile.hardwareProfile
                      ?.vmSizeProperties
                      ? undefined
                      : {
            ...
            computeApiVersion:
              res.body.properties?.computeProfile["computeApiVersion"],
            platformFaultDomainCount:
        ...
        properties: !p.properties
          ...
          : {
              ...
              regularPriorityProfile: !p.properties?.regularPriorityProfile
                ...
                : {
                    capacity:
                      p.properties?.regularPriorityProfile?.["capacity"],
                    minCapacity:
                ...
                baseVirtualMachineProfile: {
                                ...
                                return {
                                  ...
                                  properties: !p.properties
                                    ...
                                    : {
                                        ...
                                        suppressFailures:
                                          p.properties?.["suppressFailures"],
                                        protectedSettingsFromKeyVault: !p
                                          .properties
                                          ?.protectedSettingsFromKeyVault
                                          ? undefined
                                          : {
                  ...
                  scheduledEventsProfile: !p.properties?.computeProfile
                    ...
                    : {
                        ...
                        osImageNotificationProfile: !p.properties
                          ?.computeProfile.baseVirtualMachineProfile
                          .scheduledEventsProfile?.osImageNotificationProfile
                          ? undefined
                          : {
