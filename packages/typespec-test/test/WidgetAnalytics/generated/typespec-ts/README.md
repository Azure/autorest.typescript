...
- [Package (NPM)](https://www.npmjs.com/package/@azure-rest/azure-widget-analytics)
- [API reference documentation](https://learn.microsoft.com/javascript/api/@azure-rest/azure-widget-analytics?view=azure-node-preview)
...
### Install the `@azure-rest/azure-widget-analytics` package

Install the Azure WidgetAnalytics client library for JavaScript with `npm`:

```bash
npm install @azure-rest/azure-widget-analytics
```
...
```ts 
import { WidgetAnalyticsClient } from "@azure-rest/azure-widget-analytics";
