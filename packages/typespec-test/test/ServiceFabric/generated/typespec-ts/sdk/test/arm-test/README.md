# Azure ServiceFabricManagement client library for JavaScript
...
```ts 
import { ServiceFabricClient } from "@azure/arm-servicefabric";
...
`ServiceFabricClient` is the primary interface for developers using the Azure ServiceFabricManagement client library. Explore the methods on this client object to understand the different features of the Azure ServiceFabricManagement service that you can access.
