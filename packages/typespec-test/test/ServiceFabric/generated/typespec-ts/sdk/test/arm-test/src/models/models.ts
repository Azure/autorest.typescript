...
export function clusterUpdateParametersSerializer(item: ClusterUpdateParameters): any {
  return {
    properties: !item["properties"]
      ? item["properties"]
      : clusterPropertiesUpdateParametersSerializer(item["properties"]),
    tags: item["tags"],
  };
}
...
export interface VMSizeResource {
  /** VM Size properties. */
...
export interface ApplicationTypeResource extends Resource {
...
export interface ApplicationTypeVersionResource extends Resource {
...
export interface ApplicationResourceUpdate extends ProxyResourceApplicationResourceUpdateProperties {
  /** Resource tags. */
  tags?: Record<string, string>;
  /** The application resource properties for patch operations. */
...
export function applicationResourceUpdateSerializer(item: ApplicationResourceUpdate): any {
  return {
    properties: !item["properties"]
      ? item["properties"]
      : applicationResourceUpdatePropertiesSerializer(item["properties"]),
    tags: item["tags"],
  };
}

/** Concrete proxy resource types can be created by aliasing this type using a specific property type. */
export interface ProxyResourceApplicationResourceUpdateProperties extends ProxyResource {
  /** The resource-specific properties for this resource. */
  properties?: ApplicationResourceUpdateProperties;
}

export function proxyResourceApplicationResourceUpdatePropertiesSerializer(
  item: ProxyResourceApplicationResourceUpdateProperties,
): any {
  return {
    properties: !item["properties"]
      ? item["properties"]
...
export interface ServiceResourceUpdate extends Resource {
...
export function clusterCodeVersionsResultDeserializer(item: any): ClusterCodeVersionsResult {
  return {
    ...
    properties: !item["properties"]
      ? item["properties"]
      : clusterVersionDetailsDeserializer(item["properties"]),
  };
}
