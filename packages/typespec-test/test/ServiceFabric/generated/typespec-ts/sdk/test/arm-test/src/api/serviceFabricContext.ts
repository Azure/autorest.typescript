...
export function createServiceFabric(
  ...
  const userAgentInfo = `azsdk-js-arm-servicefabric/1.0.0-beta.2`;
  ...
  const apiVersion = options.apiVersion ?? "2023-11-01-preview";
  ...
  return { ...clientContext, apiVersion, subscriptionId } as ServiceFabricContext;
}
