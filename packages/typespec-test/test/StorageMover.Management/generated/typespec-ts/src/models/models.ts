...
export function storageMoverPropertiesSerializer(
  item: StorageMoverProperties,
): any {
  return { description: item["description"] };
}

export function storageMoverPropertiesDeserializer(
  item: any,
...
export function storageMoverUpdateParametersSerializer(
  item: StorageMoverUpdateParameters,
): any {
  return {
    properties: !item["properties"]
      ? item["properties"]
...
export function storageMoverUpdatePropertiesSerializer(
  item: StorageMoverUpdateProperties,
): any {
  return { description: item["description"] };
}
...
export function storageMoverArraySerializer(
  result: Array<StorageMover>,
): any[] {
  return result.map((item) => {
...
export function storageMoverArrayDeserializer(
  result: Array<StorageMover>,
): any[] {
  return result.map((item) => {
...
export function uploadLimitScheduleDeserializer(
  item: any,
): UploadLimitSchedule {
  return {
    weeklyRecurrences: !item["weeklyRecurrences"]
...
export function uploadLimitWeeklyRecurrenceSerializer(
  item: UploadLimitWeeklyRecurrence,
): any {
  return {
...
export function uploadLimitWeeklyRecurrenceDeserializer(
  item: any,
...
export function agentPropertiesErrorDetailsDeserializer(
  item: any,
...
export function agentUpdateParametersSerializer(
  item: AgentUpdateParameters,
): any {
  return {
    properties: !item["properties"]
      ? item["properties"]
...
export function agentUpdatePropertiesSerializer(
  item: AgentUpdateProperties,
): any {
  return {
    description: item["description"],
    uploadLimitSchedule: !item["uploadLimitSchedule"]
...
export interface EndpointBaseProperties {
  ...
  /** The discriminator possible values: AzureStorageBlobContainer, NfsMount, AzureStorageSmbFileShare, SmbMount */
...
export function endpointBasePropertiesSerializer(
  item: EndpointBaseProperties,
): any {
  return {
...
export function endpointBasePropertiesDeserializer(
  item: any,
...
export function endpointBasePropertiesUnionSerializer(
  item: EndpointBasePropertiesUnion,
): any {
  switch (item.endpointType) {
    ...
    case "NfsMount":
      return nfsMountEndpointPropertiesSerializer(
        item as NfsMountEndpointProperties,
      );
    ...
    case "SmbMount":
      return smbMountEndpointPropertiesSerializer(
        item as SmbMountEndpointProperties,
      );
...
export function endpointBasePropertiesUnionDeserializer(
  item: any,
  ...
  switch (item.endpointType) {
    ...
    case "NfsMount":
      return nfsMountEndpointPropertiesDeserializer(
        item as NfsMountEndpointProperties,
      );
    ...
    case "SmbMount":
      return smbMountEndpointPropertiesDeserializer(
        item as SmbMountEndpointProperties,
      );
...
export function nfsMountEndpointPropertiesSerializer(
  item: NfsMountEndpointProperties,
): any {
  return {
    endpointType: item["endpointType"],
    description: item["description"],
...
export function nfsMountEndpointPropertiesDeserializer(
  item: any,
): NfsMountEndpointProperties {
  return {
    endpointType: item["endpointType"],
...
export function smbMountEndpointPropertiesSerializer(
  item: SmbMountEndpointProperties,
): any {
  return {
    endpointType: item["endpointType"],
    description: item["description"],
...
export function smbMountEndpointPropertiesDeserializer(
  item: any,
): SmbMountEndpointProperties {
  return {
    endpointType: item["endpointType"],
...
export function azureKeyVaultSmbCredentialsSerializer(
  item: AzureKeyVaultSmbCredentials,
): any {
  return {
    type: item["type"],
...
export function azureKeyVaultSmbCredentialsDeserializer(
  item: any,
...
export function credentialsUnionSerializer(item: CredentialsUnion): any {
  switch (item.type) {
    case "AzureKeyVaultSmb":
      return azureKeyVaultSmbCredentialsSerializer(
        item as AzureKeyVaultSmbCredentials,
      );
...
export function credentialsUnionDeserializer(item: any): CredentialsUnion {
  switch (item.type) {
    case "AzureKeyVaultSmb":
      return azureKeyVaultSmbCredentialsDeserializer(
        item as AzureKeyVaultSmbCredentials,
      );
...
export function endpointBaseUpdateParametersSerializer(
  item: EndpointBaseUpdateParameters,
): any {
  return {
    properties: !item["properties"]
      ? item["properties"]
...
export function endpointBaseUpdatePropertiesSerializer(
  item: EndpointBaseUpdateProperties,
): any {
  return {
    endpointType: item["endpointType"],
    description: item["description"],
...
export function endpointBaseUpdatePropertiesUnionSerializer(
  ...
  switch (item.endpointType) {
    ...
    case "NfsMount":
      return nfsMountEndpointUpdatePropertiesSerializer(
        item as NfsMountEndpointUpdateProperties,
      );
    ...
    case "SmbMount":
      return smbMountEndpointUpdatePropertiesSerializer(
        item as SmbMountEndpointUpdateProperties,
      );
...
export function projectUpdateParametersSerializer(
  item: ProjectUpdateParameters,
): any {
  return {
    properties: !item["properties"]
      ? item["properties"]
...
export function projectUpdatePropertiesSerializer(
  item: ProjectUpdateProperties,
): any {
  return { description: item["description"] };
}
...
export function jobDefinitionPropertiesSerializer(
  item: JobDefinitionProperties,
): any {
  return {
    description: item["description"],
...
export function jobDefinitionPropertiesDeserializer(
  item: any,
...
export function jobDefinitionUpdateParametersSerializer(
  item: JobDefinitionUpdateParameters,
): any {
  return {
    properties: !item["properties"]
      ? item["properties"]
...
export function jobDefinitionUpdatePropertiesSerializer(
  item: JobDefinitionUpdateProperties,
): any {
  return {
    description: item["description"],
    copyMode: item["copyMode"],
...
export function jobDefinitionArraySerializer(
  result: Array<JobDefinition>,
): any[] {
  return result.map((item) => {
...
export function jobDefinitionArrayDeserializer(
  result: Array<JobDefinition>,
): any[] {
  return result.map((item) => {
...
export function jobRunPropertiesDeserializer(item: any): JobRunProperties {
  return {
    ...
    error: !item["error"]
      ? item["error"]
      : jobRunErrorDeserializer(item["error"]),
    provisioningState: item["provisioningState"],
  };
}
