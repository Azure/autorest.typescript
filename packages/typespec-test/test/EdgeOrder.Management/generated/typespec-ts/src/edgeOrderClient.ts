...
import {
  ...
  _getOrderItemsOperations,
} from "./classic/orderItems/index.js";
import {
  AddressesOperations,
  _getAddressesOperations,
} from "./classic/addresses/index.js";
import {
...
export class EdgeOrderClient {
  ...
  constructor(
    ...
    this.productsAndConfigurations = _getProductsAndConfigurationsOperations(
      this._client,
    );
