...
export type CustomGet17Parameters = RequestParameters;
export type CustomGet18Parameters = RequestParameters;
export type CustomGet19Parameters = RequestParameters;
export type CustomGet20Parameters = RequestParameters;
export type CustomGet21Parameters = RequestParameters;
