...
export interface GlossaryGet {
  ...
  delete(
    ...
    GlossaryDeleteOperation204Response | GlossaryDeleteOperationDefaultResponse
  >;
}
...
export interface TypeGetByName {
  ...
  delete(
    ...
    TypeDeleteOperation204Response | TypeDeleteOperationDefaultResponse
  >;
}
...
export interface Routes {
  ...
  /** Resource for '/atlas/v2/glossary/terms/\{termGuid\}/assignedEntities' has methods for the following verbs: get, post, delete */
  (
