# PurviewDataMap REST client library for JavaScript
...
- [Package (NPM)](https://www.npmjs.com/package/@msinternal/analytics-purview-datamap)
...
### Install the `@msinternal/analytics-purview-datamap` package

Install the PurviewDataMap REST client REST client library for JavaScript with `npm`:

```bash
npm install @msinternal/analytics-purview-datamap
```
