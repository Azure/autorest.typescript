# Azure Database REST client library for JavaScript

OracleDatabase Service
...
Install the Azure Database REST client REST client library for JavaScript with `npm`:
