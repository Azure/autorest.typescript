...
import {
  ...
  staticSiteCustomDomainOverviewARMResourceSerializer,
...
export function _createOrUpdateStaticSiteCustomDomainSend(
  ...
  return context
    ...
    .put({
      ...
      contentType: "application/json",
      headers: { accept: "application/json", ...options.requestOptions?.headers },
      body: staticSiteCustomDomainOverviewARMResourceSerializer(
        staticSiteCustomDomainRequestPropertiesEnvelope,
      ),
    });
}
...
export function deleteStaticSite(
  ...
  return getLongRunningPoller(context, _deleteStaticSiteDeserialize, ["200", "202", "201"], {
    updateIntervalInMs: options?.updateIntervalInMs,
    abortSignal: options?.abortSignal,
