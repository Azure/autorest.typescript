...
function _getWebApps(context: WebContext) {
  return {
    listWorkflows: (
      resourceGroupName: string,
      name: string,
    ...
    getWebJobSlot: (
      ...
      webJobName: string,
      options?: WebAppsGetWebJobSlotOptionalParams,
    ) => getWebJobSlot(context, resourceGroupName, name, slot, webJobName, options),
    listTriggeredWebJobHistory: (
      resourceGroupName: string,
      name: string,
      webJobName: string,
    ...
    listTriggeredWebJobHistorySlot: (
      ...
      listTriggeredWebJobHistorySlot(context, resourceGroupName, name, slot, webJobName, options),
    getTriggeredWebJobHistorySlot: (
      resourceGroupName: string,
      name: string,
      slot: string,
    ...
    runTriggeredWebJobSlot: (
      ...
      webJobName: string,
      options?: WebAppsRunTriggeredWebJobSlotOptionalParams,
    ) => runTriggeredWebJobSlot(context, resourceGroupName, name, slot, webJobName, options),
    listTriggeredWebJobsSlot: (
      resourceGroupName: string,
      name: string,
      slot: string,
    ...
    deleteTriggeredWebJobSlot: (
      ...
      webJobName: string,
      options?: WebAppsDeleteTriggeredWebJobSlotOptionalParams,
    ) => deleteTriggeredWebJobSlot(context, resourceGroupName, name, slot, webJobName, options),
    getTriggeredWebJobSlot: (
      resourceGroupName: string,
      name: string,
      slot: string,
      webJobName: string,
      options?: WebAppsGetTriggeredWebJobSlotOptionalParams,
    ) => getTriggeredWebJobSlot(context, resourceGroupName, name, slot, webJobName, options),
    deleteSourceControl: (
      resourceGroupName: string,
      name: string,
      options?: WebAppsDeleteSourceControlOptionalParams,
    ...
    deleteSiteExtensionSlot: (
      ...
      siteExtensionId: string,
      options?: WebAppsDeleteSiteExtensionSlotOptionalParams,
    ) => deleteSiteExtensionSlot(context, resourceGroupName, name, slot, siteExtensionId, options),
    installSiteExtensionSlot: (
      resourceGroupName: string,
      name: string,
      slot: string,
      siteExtensionId: string,
      options?: WebAppsInstallSiteExtensionSlotOptionalParams,
    ) => installSiteExtensionSlot(context, resourceGroupName, name, slot, siteExtensionId, options),
    getSiteExtensionSlot: (
      resourceGroupName: string,
      name: string,
      slot: string,
      siteExtensionId: string,
      options?: WebAppsGetSiteExtensionSlotOptionalParams,
    ) => getSiteExtensionSlot(context, resourceGroupName, name, slot, siteExtensionId, options),
    listSiteExtensions: (
      resourceGroupName: string,
      name: string,
      options?: WebAppsListSiteExtensionsOptionalParams,
    ...
    deletePremierAddOnSlot: (
      ...
      premierAddOnName: string,
      options?: WebAppsDeletePremierAddOnSlotOptionalParams,
    ) => deletePremierAddOnSlot(context, resourceGroupName, name, slot, premierAddOnName, options),
    updatePremierAddOnSlot: (
      resourceGroupName: string,
      name: string,
      slot: string,
    ...
    getPremierAddOnSlot: (
      ...
      premierAddOnName: string,
      options?: WebAppsGetPremierAddOnSlotOptionalParams,
    ) => getPremierAddOnSlot(context, resourceGroupName, name, slot, premierAddOnName, options),
    deletePremierAddOn: (
      resourceGroupName: string,
      name: string,
      premierAddOnName: string,
    ...
    listNetworkFeaturesSlot: (
      ...
      view: string,
      options?: WebAppsListNetworkFeaturesSlotOptionalParams,
    ) => listNetworkFeaturesSlot(context, resourceGroupName, name, slot, view, options),
    listNetworkFeatures: (
      resourceGroupName: string,
      name: string,
      view: string,
    ...
    listProcessModulesSlot: (
      ...
      processId: string,
      options?: WebAppsListProcessModulesSlotOptionalParams,
    ) => listProcessModulesSlot(context, resourceGroupName, name, slot, processId, options),
    getProcessModuleSlot: (
      resourceGroupName: string,
      name: string,
      slot: string,
      ...
      getProcessModuleSlot(context, resourceGroupName, name, slot, processId, baseAddress, options),
    listInstanceProcessModulesSlot: (
      resourceGroupName: string,
      name: string,
      slot: string,
    ...
    listInstanceProcessModules: (
      ...
      listInstanceProcessModules(context, resourceGroupName, name, instanceId, processId, options),
    getInstanceProcessModule: (
      resourceGroupName: string,
      name: string,
      instanceId: string,
    ...
    listProcessThreadsSlot: (
      ...
      processId: string,
      options?: WebAppsListProcessThreadsSlotOptionalParams,
    ) => listProcessThreadsSlot(context, resourceGroupName, name, slot, processId, options),
    getProcessDumpSlot: (
      resourceGroupName: string,
      name: string,
      slot: string,
      processId: string,
      options?: WebAppsGetProcessDumpSlotOptionalParams,
    ) => getProcessDumpSlot(context, resourceGroupName, name, slot, processId, options),
    listProcessesSlot: (
      resourceGroupName: string,
      name: string,
      slot: string,
    ...
    deleteProcessSlot: (
      ...
      processId: string,
      options?: WebAppsDeleteProcessSlotOptionalParams,
    ) => deleteProcessSlot(context, resourceGroupName, name, slot, processId, options),
    getProcessSlot: (
      resourceGroupName: string,
      name: string,
      slot: string,
      processId: string,
      options?: WebAppsGetProcessSlotOptionalParams,
    ) => getProcessSlot(context, resourceGroupName, name, slot, processId, options),
    listInstanceProcessThreadsSlot: (
      resourceGroupName: string,
      name: string,
      slot: string,
    ...
    listInstanceProcessThreads: (
      ...
      listInstanceProcessThreads(context, resourceGroupName, name, instanceId, processId, options),
    getInstanceProcessDump: (
      resourceGroupName: string,
      name: string,
      instanceId: string,
      processId: string,
      options?: WebAppsGetInstanceProcessDumpOptionalParams,
    ) => getInstanceProcessDump(context, resourceGroupName, name, instanceId, processId, options),
    listInstanceProcesses: (
      resourceGroupName: string,
      name: string,
      instanceId: string,
    ...
    deleteInstanceProcess: (
      ...
      processId: string,
      options?: WebAppsDeleteInstanceProcessOptionalParams,
    ) => deleteInstanceProcess(context, resourceGroupName, name, instanceId, processId, options),
    getInstanceProcess: (
      resourceGroupName: string,
      name: string,
      instanceId: string,
      processId: string,
      options?: WebAppsGetInstanceProcessOptionalParams,
    ) => getInstanceProcess(context, resourceGroupName, name, instanceId, processId, options),
    listInstanceIdentifiersSlot: (
      resourceGroupName: string,
      name: string,
      slot: string,
    ...
    getInstanceInfoSlot: (
      ...
      instanceId: string,
      options?: WebAppsGetInstanceInfoSlotOptionalParams,
    ) => getInstanceInfoSlot(context, resourceGroupName, name, slot, instanceId, options),
    listInstanceIdentifiers: (
      resourceGroupName: string,
      name: string,
      options?: WebAppsListInstanceIdentifiersOptionalParams,
    ...
    deleteRelayServiceConnectionSlot: (
      ...
      deleteRelayServiceConnectionSlot(context, resourceGroupName, name, slot, entityName, options),
    updateRelayServiceConnectionSlot: (
      resourceGroupName: string,
      name: string,
      slot: string,
    ...
    getRelayServiceConnectionSlot: (
      ...
      entityName: string,
      options?: WebAppsGetRelayServiceConnectionSlotOptionalParams,
    ) => getRelayServiceConnectionSlot(context, resourceGroupName, name, slot, entityName, options),
    deleteRelayServiceConnection: (
      resourceGroupName: string,
      name: string,
      entityName: string,
    ...
    listFunctionSecretsSlot: (
      ...
      functionName: string,
      options?: WebAppsListFunctionSecretsSlotOptionalParams,
    ) => listFunctionSecretsSlot(context, resourceGroupName, name, slot, functionName, options),
    listFunctionKeysSlot: (
      resourceGroupName: string,
      name: string,
      slot: string,
      functionName: string,
      options?: WebAppsListFunctionKeysSlotOptionalParams,
    ) => listFunctionKeysSlot(context, resourceGroupName, name, slot, functionName, options),
    deleteFunctionSecretSlot: (
      resourceGroupName: string,
      name: string,
      slot: string,
    ...
    deleteInstanceFunctionSlot: (
      ...
      functionName: string,
      options?: WebAppsDeleteInstanceFunctionSlotOptionalParams,
    ) => deleteInstanceFunctionSlot(context, resourceGroupName, name, slot, functionName, options),
    createInstanceFunctionSlot: (
      resourceGroupName: string,
      name: string,
      slot: string,
    ...
    getInstanceFunctionSlot: (
      ...
      functionName: string,
      options?: WebAppsGetInstanceFunctionSlotOptionalParams,
    ) => getInstanceFunctionSlot(context, resourceGroupName, name, slot, functionName, options),
    listFunctionSecrets: (
      resourceGroupName: string,
      name: string,
      functionName: string,
    ...
    listDeploymentLogSlot: (
      ...
      id: string,
      options?: WebAppsListDeploymentLogSlotOptionalParams,
    ) => listDeploymentLogSlot(context, resourceGroupName, name, slot, id, options),
    listDeploymentsSlot: (
      resourceGroupName: string,
      name: string,
      slot: string,
    ...
    deleteDeploymentSlot: (
      ...
      id: string,
      options?: WebAppsDeleteDeploymentSlotOptionalParams,
    ) => deleteDeploymentSlot(context, resourceGroupName, name, slot, id, options),
    createDeploymentSlot: (
      resourceGroupName: string,
      name: string,
      slot: string,
      ...
      deployment: Deployment,
      options?: WebAppsCreateDeploymentSlotOptionalParams,
    ) => createDeploymentSlot(context, resourceGroupName, name, slot, id, deployment, options),
    getDeploymentSlot: (
      resourceGroupName: string,
      name: string,
      slot: string,
      id: string,
      options?: WebAppsGetDeploymentSlotOptionalParams,
    ) => getDeploymentSlot(context, resourceGroupName, name, slot, id, options),
    listDeploymentLog: (
      resourceGroupName: string,
      name: string,
      id: string,
    ...
    stopContinuousWebJobSlot: (
      ...
      webJobName: string,
      options?: WebAppsStopContinuousWebJobSlotOptionalParams,
    ) => stopContinuousWebJobSlot(context, resourceGroupName, name, slot, webJobName, options),
    startContinuousWebJobSlot: (
      resourceGroupName: string,
      name: string,
      slot: string,
      webJobName: string,
      options?: WebAppsStartContinuousWebJobSlotOptionalParams,
    ) => startContinuousWebJobSlot(context, resourceGroupName, name, slot, webJobName, options),
    listContinuousWebJobsSlot: (
      resourceGroupName: string,
      name: string,
      slot: string,
    ...
    deleteContinuousWebJobSlot: (
      ...
      webJobName: string,
      options?: WebAppsDeleteContinuousWebJobSlotOptionalParams,
    ) => deleteContinuousWebJobSlot(context, resourceGroupName, name, slot, webJobName, options),
    getContinuousWebJobSlot: (
      resourceGroupName: string,
      name: string,
      slot: string,
      webJobName: string,
      options?: WebAppsGetContinuousWebJobSlotOptionalParams,
    ) => getContinuousWebJobSlot(context, resourceGroupName, name, slot, webJobName, options),
    stopContinuousWebJob: (
      resourceGroupName: string,
      name: string,
      webJobName: string,
    ...
    getConfigurationSnapshotSlot: (
      ...
      snapshotId: string,
      options?: WebAppsGetConfigurationSnapshotSlotOptionalParams,
    ) => getConfigurationSnapshotSlot(context, resourceGroupName, name, slot, snapshotId, options),
    listConfigurationSnapshotInfoSlot: (
      resourceGroupName: string,
      name: string,
      slot: string,
    ...
    restoreSlot: (
      ...
      request: RestoreRequest,
      options?: WebAppsRestoreSlotOptionalParams,
    ) => restoreSlot(context, resourceGroupName, name, slot, backupId, request, options),
    listBackupStatusSecretsSlot: (
      resourceGroupName: string,
      name: string,
      slot: string,
    ...
    deleteBackupSlot: (
      ...
      backupId: string,
      options?: WebAppsDeleteBackupSlotOptionalParams,
    ) => deleteBackupSlot(context, resourceGroupName, name, slot, backupId, options),
    getBackupStatusSlot: (
      resourceGroupName: string,
      name: string,
      slot: string,
      backupId: string,
      options?: WebAppsGetBackupStatusSlotOptionalParams,
    ) => getBackupStatusSlot(context, resourceGroupName, name, slot, backupId, options),
    restore: (
      resourceGroupName: string,
      name: string,
      backupId: string,
    ...
    migrateStorage: (
      ...
      migrateStorage(context, resourceGroupName, name, subscriptionName, migrationOptions, options),
    updateMachineKey: (
      resourceGroupName: string,
      name: string,
      options?: WebAppsUpdateMachineKeyOptionalParams,
    ...
    deleteVnetConnectionSlot: (
      ...
      vnetName: string,
      options?: WebAppsDeleteVnetConnectionSlotOptionalParams,
    ) => deleteVnetConnectionSlot(context, resourceGroupName, name, slot, vnetName, options),
    updateVnetConnectionSlot: (
      resourceGroupName: string,
      name: string,
      slot: string,
    ...
    getVnetConnectionSlot: (
      ...
      vnetName: string,
      options?: WebAppsGetVnetConnectionSlotOptionalParams,
    ) => getVnetConnectionSlot(context, resourceGroupName, name, slot, vnetName, options),
    deleteHybridConnectionSlot: (
      resourceGroupName: string,
      name: string,
      slot: string,
    ...
    getNetworkTracesSlotV2: (
      ...
      operationId: string,
      options?: WebAppsGetNetworkTracesSlotV2OptionalParams,
    ) => getNetworkTracesSlotV2(context, resourceGroupName, name, slot, operationId, options),
    getNetworkTraceOperationSlotV2: (
      resourceGroupName: string,
      name: string,
      slot: string,
      ...
      getNetworkTraceOperationSlotV2(context, resourceGroupName, name, slot, operationId, options),
    getNetworkTracesSlot: (
      resourceGroupName: string,
      name: string,
      slot: string,
      operationId: string,
      options?: WebAppsGetNetworkTracesSlotOptionalParams,
    ) => getNetworkTracesSlot(context, resourceGroupName, name, slot, operationId, options),
    stopWebSiteNetworkTraceSlot: (
      resourceGroupName: string,
      name: string,
      slot: string,
    ...
    getNetworkTraceOperationSlot: (
      ...
      operationId: string,
      options?: WebAppsGetNetworkTraceOperationSlotOptionalParams,
    ) => getNetworkTraceOperationSlot(context, resourceGroupName, name, slot, operationId, options),
    listSyncFunctionTriggersSlot: (
      resourceGroupName: string,
      name: string,
      slot: string,
    ...
    deleteHostSecretSlot: (
      ...
      keyName: string,
      options?: WebAppsDeleteHostSecretSlotOptionalParams,
    ) => deleteHostSecretSlot(context, resourceGroupName, name, slot, keyType, keyName, options),
    createOrUpdateHostSecretSlot: (
      resourceGroupName: string,
      name: string,
      slot: string,
...
export function _getWebAppsOperations(context: WebContext): WebAppsOperations {
  return {
    ..._getWebApps(context),
  };
}
