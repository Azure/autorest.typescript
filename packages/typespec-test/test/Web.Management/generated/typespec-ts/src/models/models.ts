...
export function staticSiteCustomDomainOverviewARMResourceSerializer(
  item: StaticSiteCustomDomainOverviewARMResource,
): any {
  return { properties: undefined, kind: item["kind"] };
}
...
export function staticSiteCustomDomainOverviewARMResourcePropertiesSerializer(
  item: StaticSiteCustomDomainOverviewARMResourceProperties,
): any {
  return item;
}
...
export function staticSiteCustomDomainOverviewARMResourceArraySerializer(
  result: Array<StaticSiteCustomDomainOverviewARMResource>,
): any[] {
  return result.map((item) => {
    return staticSiteCustomDomainOverviewARMResourceSerializer(item);
  });
}
...
export function workflowEnvelopePropertiesDeserializer(item: any): WorkflowEnvelopeProperties {
  return {
    files: !item["files"]
      ? item["files"]
      : Object.fromEntries(
          Object.entries(item["files"]).map(([k, p]: [string, any]) => [
            k,
...
export function continuousWebJobPropertiesDeserializer(item: any): ContinuousWebJobProperties {
  return {
    ...
    settings: !item["settings"]
      ? item["settings"]
      : Object.fromEntries(
          Object.entries(item["settings"]).map(([k, p]: [string, any]) => [
            k,
            Object.fromEntries(Object.entries(p).map(([k, p]: [string, any]) => [k, p])),
          ]),
        ),
...
/** model interface MSDeployProperties */
...
export function diagnosticDetectorResponsePropertiesDeserializer(
  ...
  return {
    ...
    data: !item["data"] ? item["data"] : nameValuePairArrayDeserializer(item["data"]),
...
export interface StackMajorVersion {
   ...
   */
  appSettingsDictionary?: Record<string, Record<string, any>>;
  /**
   ...
   */
  siteConfigPropertiesDictionary?: Record<string, Record<string, any>>;
}
...
export function stackMajorVersionDeserializer(item: any): StackMajorVersion {
  return {
    ...
    appSettingsDictionary: !item["appSettingsDictionary"]
      ...
      : Object.fromEntries(
          Object.entries(item["appSettingsDictionary"]).map(([k, p]: [string, any]) => [
            k,
            Object.fromEntries(Object.entries(p).map(([k, p]: [string, any]) => [k, p])),
          ]),
        ),
...
export function _staticSiteCustomDomainOverviewARMResourcePropertiesSerializer(
  item: StaticSiteCustomDomainOverviewARMResource,
): any {
  return item;
}
