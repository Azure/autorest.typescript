...
export function _deleteAtManagementGroupSend(
  ...
  const path = expandUrlTemplate(
    "/providers/Microsoft.Management/managementGroups/{managementGroupId}/providers/Microsoft.Resources/deploymentStacks/{deploymentStackName}{?api%2Dversion,unmanageAction.Resources,unmanageAction.ResourceGroups,unmanageAction.ManagementGroups,bypassStackOutOfSyncError}",
    {
      managementGroupId: managementGroupId,
      deploymentStackName: deploymentStackName,
      "api%2Dversion": context.apiVersion,
      ...
      "unmanageAction.ManagementGroups":
        options?.unmanageActionManagementGroups,
...
export async function _validateStackAtManagementGroupDeserialize(
  ...
  const expectedStatuses = ["202", "200", "400"];
  if (!expectedStatuses.includes(result.status)) {
    const error = createRestError(result);
    error.details = errorResponseDeserializer(result.body);
    throw error;
...
export async function exportTemplateAtSubscription(
  ...
  const result = await _exportTemplateAtSubscriptionSend(
    context,
    deploymentStackName,
    options,
  );
...
export function _deleteAtSubscriptionSend(
  ...
  const path = expandUrlTemplate(
    "/subscriptions/{subscriptionId}/providers/Microsoft.Resources/deploymentStacks/{deploymentStackName}{?api%2Dversion,unmanageAction.Resources,unmanageAction.ResourceGroups,unmanageAction.ManagementGroups,bypassStackOutOfSyncError}",
    {
      subscriptionId: context.subscriptionId,
      deploymentStackName: deploymentStackName,
      "api%2Dversion": context.apiVersion,
...
export function deleteAtSubscription(
  ...
  return getLongRunningPoller(
    ...
    ["200", "202", "204"],
    {
      ...
      abortSignal: options?.abortSignal,
      getInitialResponse: () =>
        _deleteAtSubscriptionSend(context, deploymentStackName, options),
      resourceLocationConfig: "location",
    },
  ) as PollerLike<OperationState<void>, void>;
}
...
export function createOrUpdateAtSubscription(
  ...
  return getLongRunningPoller(
    ...
    ["200", "201", "202"],
    {
      ...
      abortSignal: options?.abortSignal,
      getInitialResponse: () =>
        _createOrUpdateAtSubscriptionSend(
          context,
          deploymentStackName,
          deploymentStack,
          options,
...
> {
  return getLongRunningPoller(
    ...
    ["202", "200", "400"],
    {
      ...
      abortSignal: options?.abortSignal,
      getInitialResponse: () =>
        _validateStackAtSubscriptionSend(
          context,
          deploymentStackName,
          deploymentStack,
          options,
...
export function _deleteAtResourceGroupSend(
  ...
  const path = expandUrlTemplate(
    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Resources/deploymentStacks/{deploymentStackName}{?api%2Dversion,unmanageAction.Resources,unmanageAction.ResourceGroups,unmanageAction.ManagementGroups,bypassStackOutOfSyncError}",
    {
      subscriptionId: context.subscriptionId,
      resourceGroupName: resourceGroupName,
      deploymentStackName: deploymentStackName,
