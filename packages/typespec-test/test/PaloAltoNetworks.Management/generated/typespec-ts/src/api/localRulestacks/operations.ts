...
import { CloudngfwContext as Client } from "../index.js";
import {
...
export async function _revertDeserialize(
...
export async function revert(
  ...
  const result = await _revertSend(
    context,
    resourceGroupName,
    localRulestackName,
    options,
...
export function listPredefinedUrlCategories(
  ...
  return buildPagedAsyncIterator(
    context,
    () =>
      _listPredefinedUrlCategoriesSend(
        context,
        resourceGroupName,
        localRulestackName,
        options,
...
export async function listFirewalls(
  ...
  const result = await _listFirewallsSend(
    context,
    resourceGroupName,
    localRulestackName,
    options,
...
export async function getSupportInfo(
  ...
  const result = await _getSupportInfoSend(
    context,
    resourceGroupName,
    localRulestackName,
    options,
...
export async function _getChangeLogDeserialize(
  result: PathUncheckedResponse,
): Promise<Changelog> {
  const expectedStatuses = ["200"];
  if (!expectedStatuses.includes(result.status)) {
...
export async function getChangeLog(
  ...
  const result = await _getChangeLogSend(
    context,
    resourceGroupName,
    localRulestackName,
    options,
...
export async function _commitDeserialize(
  result: PathUncheckedResponse,
): Promise<void> {
...
export function commit(
  ...
  return getLongRunningPoller(
    ...
    ["202", "200", "201"],
    {
      ...
      getInitialResponse: () =>
        _commitSend(context, resourceGroupName, localRulestackName, options),
...
export function $delete(
  ...
  return getLongRunningPoller(
    ...
    ["200", "202", "204", "201"],
    {
      ...
      abortSignal: options?.abortSignal,
      getInitialResponse: () =>
        _$deleteSend(context, resourceGroupName, localRulestackName, options),
...
export function createOrUpdate(
  ...
  return getLongRunningPoller(
    ...
    OperationState<LocalRulestackResource>,
    LocalRulestackResource
  >;
}
