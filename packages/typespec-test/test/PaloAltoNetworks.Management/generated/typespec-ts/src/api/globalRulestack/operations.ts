...
export async function listPredefinedUrlCategories(
  ...
  const result = await _listPredefinedUrlCategoriesSend(
    context,
    globalRulestackName,
    options,
  );
...
export async function listCountries(
  ...
  const result = await _listCountriesSend(
    context,
    globalRulestackName,
    options,
  );
...
export function commit(
  ...
  return getLongRunningPoller(
    ...
    ["202", "200", "201"],
    {
      ...
      getInitialResponse: () =>
        _commitSend(context, globalRulestackName, options),
...
export function $delete(
  ...
  return getLongRunningPoller(
    ...
    ["200", "202", "204", "201"],
    {
      ...
      abortSignal: options?.abortSignal,
      getInitialResponse: () =>
        _$deleteSend(context, globalRulestackName, options),
...
export function createOrUpdate(
  ...
  OperationState<GlobalRulestackResource>,
  GlobalRulestackResource
> {
  return getLongRunningPoller(
    context,
    ...
    ["200", "201", "202"],
    {
      ...
      abortSignal: options?.abortSignal,
      getInitialResponse: () =>
        _createOrUpdateSend(context, globalRulestackName, resource, options),
      resourceLocationConfig: "azure-async-operation",
    },
  ) as PollerLike<
    OperationState<GlobalRulestackResource>,
