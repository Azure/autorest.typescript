...
export async function _saveLogProfileDeserialize(
...
export async function saveLogProfile(
  ...
  const result = await _saveLogProfileSend(
    context,
    resourceGroupName,
    firewallName,
    options,
...
export async function getLogProfile(
  ...
  const result = await _getLogProfileSend(
    context,
    resourceGroupName,
    firewallName,
    options,
...
export async function getGlobalRulestack(
  ...
  const result = await _getGlobalRulestackSend(
    context,
    resourceGroupName,
    firewallName,
    options,
...
export function $delete(
  ...
  return getLongRunningPoller(
    ...
    ["200", "202", "204", "201"],
    {
      ...
      getInitialResponse: () =>
        _$deleteSend(context, resourceGroupName, firewallName, options),
