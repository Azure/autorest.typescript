...
export class CloudngfwClient {
    constructor(credential: TokenCredential, subscriptionId: string, options?: CloudngfwClientOptionalParams);
...
// @public
export function restorePoller<TResponse extends PathUncheckedResponse, TResult>(client: CloudngfwClient, serializedState: string, sourceOperation: (...args: any[]) => PollerLike<OperationState<TResult>, TResult>, options?: RestorePollerOptions<TResult>): PollerLike<OperationState<TResult>, TResult>;
