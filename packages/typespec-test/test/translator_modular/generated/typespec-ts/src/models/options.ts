...
import { TextTypes, ProfanityActions, ProfanityMarkers } from "./models.js";
...
export interface TextTranslationDictionaryLookupOptions
  extends OperationOptions {
  /** A client-generated GUID to uniquely identify the request. */
  clientTraceId?: string;
}

export interface TextTranslationDictionaryExamplesOptions
  extends OperationOptions {
  /** A client-generated GUID to uniquely identify the request. */
  clientTraceId?: string;
}
