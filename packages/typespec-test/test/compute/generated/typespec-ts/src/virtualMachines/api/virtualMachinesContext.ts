...
export interface VirtualMachinesContext extends Client {
  /** The ID of the target subscription. The value must be an UUID. */
  subscriptionId: string;
}

/** Optional parameters for the client. */
export interface VirtualMachinesOptionalParams extends ClientOptions {
  /** Specifies the Azure cloud environment for the client. */
  cloudSetting?: AzureSupportedClouds;
}

export function createVirtualMachines(
  ...
  return { ...clientContext, subscriptionId } as VirtualMachinesContext;
}
