...
export interface ActionGroupsContext extends Client {
  /** The ID of the target subscription. The value must be an UUID. */
  subscriptionId: string;
}

/** Optional parameters for the client. */
export interface ActionGroupsOptionalParams extends ClientOptions {
...
export function createActionGroups(
  ...
  return { ...clientContext, subscriptionId } as ActionGroupsContext;
}
