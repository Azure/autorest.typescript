...
import { DevicesContext as Client } from "../index.js";
import {
...
export async function _listPrivateEndpointConnectionsDeserialize(
  ...
  return __PLACEHOLDER_o87_sdeserializer__(result.body);
}
...
export async function _listKeysDeserialize(
  ...
  return _sharedAccessSignatureAuthorizationRuleListResultDeserializer(
    result.body,
  );
}
