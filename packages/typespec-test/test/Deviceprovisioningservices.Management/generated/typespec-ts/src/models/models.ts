...
export function operationDeserializer(item: any): Operation {
  return {
    ...
    display: !item["display"]
      ? item["display"]
      : _operationDisplayDeserializer(item["display"]),
  };
}
...
export function certificateResponseDeserializer(
  item: any,
): CertificateResponse {
  return {
    id: item["id"],
...
export function certificatePropertiesSerializer(
  item: CertificateProperties,
): any {
  return {
...
export function certificatePropertiesDeserializer(
  item: any,
...
export function certificateListDescriptionDeserializer(
  item: any,
): CertificateListDescription {
  return {
    value: !item["value"]
      ? item["value"]
      : certificateResponseArrayDeserializer(item["value"]),
  };
}

export function certificateResponseArraySerializer(
  result: Array<CertificateResponse>,
): any[] {
  return result.map((item) => {
...
export function certificateResponseArrayDeserializer(
  result: Array<CertificateResponse>,
): any[] {
  return result.map((item) => {
...
export function verificationCodeResponseDeserializer(
  item: any,
...
export function verificationCodeRequestSerializer(
  item: VerificationCodeRequest,
): any {
...
export function asyncOperationResultDeserializer(
  item: any,
  ...
  return {
    ...
    error: !item["error"]
      ? item["error"]
      : errorMessageDeserializer(item["error"]),
  };
}
...
export function iotDpsPropertiesDescriptionSerializer(
  item: IotDpsPropertiesDescription,
): any {
  return {
    state: item["state"],
...
export function iotDpsPropertiesDescriptionDeserializer(
  item: any,
...
export function ipFilterRuleArraySerializer(
  result: Array<IpFilterRule>,
): any[] {
  return result.map((item) => {
...
export function ipFilterRuleArrayDeserializer(
  result: Array<IpFilterRule>,
): any[] {
  return result.map((item) => {
...
export function privateEndpointConnectionDeserializer(
  ...
  return {
    ...
    systemData: !item["systemData"]
      ? item["systemData"]
      : systemDataDeserializer(item["systemData"]),
    properties: privateEndpointConnectionPropertiesDeserializer(
      item["properties"],
    ),
  };
}
...
export function iotHubDefinitionDescriptionSerializer(
  item: IotHubDefinitionDescription,
): any {
  return {
    ...
    selectedUserAssignedIdentityResourceId:
      item["selectedUserAssignedIdentityResourceId"],
  };
}

export function iotHubDefinitionDescriptionDeserializer(
  item: any,
...
export function sharedAccessSignatureAuthorizationRuleAccessRightsDescriptionArraySerializer(
  ...
  return result.map((item) => {
    return sharedAccessSignatureAuthorizationRuleAccessRightsDescriptionSerializer(
      item,
    );
  });
}
...
export function sharedAccessSignatureAuthorizationRuleAccessRightsDescriptionArrayDeserializer(
  ...
  return result.map((item) => {
    return sharedAccessSignatureAuthorizationRuleAccessRightsDescriptionDeserializer(
      item,
    );
  });
}
...
export function iotDpsSkuDefinitionArrayDeserializer(
  result: Array<IotDpsSkuDefinition>,
): any[] {
  return result.map((item) => {
...
export function iotDpsSkuDefinitionDeserializer(
  item: any,
): IotDpsSkuDefinition {
  return {
    name: item["name"],
...
export function groupIdInformationPropertiesDeserializer(
  item: any,
...
export function privateLinkResourcesDeserializer(
  item: any,
): PrivateLinkResources {
  return {
    value: !item["value"]
      ? item["value"]
      : groupIdInformationArrayDeserializer(item["value"]),
  };
}

export function groupIdInformationArrayDeserializer(
  result: Array<GroupIdInformation>,
): any[] {
  return result.map((item) => {
...
export function nameAvailabilityInfoDeserializer(
  item: any,
