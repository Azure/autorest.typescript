...
export type InventoryTypeOutput =
  | "Cloud"
  | "VirtualNetwork"
  | "VirtualMachine"
...
export type OsTypeOutput = "Windows" | "Linux" | "Other" | string;
/** Alias for ProvisioningActionOutput */
export type ProvisioningActionOutput =
  | "install"
  | "uninstall"
  | "repair"
  | string;
/** Alias for LimitCpuForMigrationOutput */
export type LimitCpuForMigrationOutput = "true" | "false" | string;
/** Alias for DynamicMemoryEnabledOutput */
export type DynamicMemoryEnabledOutput = "true" | "false" | string;
/** Alias for IsHighlyAvailableOutput */
export type IsHighlyAvailableOutput = "true" | "false" | string;
/** Alias for AllocationMethodOutput */
export type AllocationMethodOutput = "Dynamic" | "Static" | string;
/** Alias for CreateDiffDiskOutput */
export type CreateDiffDiskOutput = "true" | "false" | string;
/** Alias for IsCustomizableOutput */
export type IsCustomizableOutput = "true" | "false" | string;
