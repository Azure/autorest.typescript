...
export interface OperationsContext extends Client {
...
export interface OperationsOptionalParams extends ClientOptions {
  /** The API version to use for this operation. */
  /** Known values of {@link KnownVersions} that the service accepts. */
  apiVersion?: string;
...
export function createOperations(
  ...
  options: OperationsOptionalParams = {},
): OperationsContext {
  const endpointUrl =
  ...
  return { ...clientContext, apiVersion } as OperationsContext;
}
