...
export interface DataTypesContext extends Client {
...
export interface DataTypesOptionalParams extends ClientOptions {
  /** The API version to use for this operation. */
  /** Known values of {@link KnownVersions} that the service accepts. */
  apiVersion?: string;
...
/** Operations on data type resource. */
export function createDataTypes(
  ...
  return { ...clientContext, apiVersion, subscriptionId } as DataTypesContext;
}
