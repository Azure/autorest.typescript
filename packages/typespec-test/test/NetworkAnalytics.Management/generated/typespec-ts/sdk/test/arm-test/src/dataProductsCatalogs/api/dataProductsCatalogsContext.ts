...
export interface DataProductsCatalogsContext extends Client {
...
export interface DataProductsCatalogsOptionalParams extends ClientOptions {
  /** The API version to use for this operation. */
  /** Known values of {@link KnownVersions} that the service accepts. */
  apiVersion?: string;
...
/** Operations on data catalog resource. */
export function createDataProductsCatalogs(
  ...
  return { ...clientContext, apiVersion, subscriptionId } as DataProductsCatalogsContext;
}
