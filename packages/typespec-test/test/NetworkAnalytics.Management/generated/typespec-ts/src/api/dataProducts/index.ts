...
export async function dataProductsUpdate(
  context: Client,
  subscriptionId: string,
  resourceGroupName: string,
  dataProductName: string,
  ...
  const result = await _dataProductsUpdateSend(
    context,
    subscriptionId,
    resourceGroupName,
    dataProductName,
  ...
  return _dataProductsUpdateDeserialize(result);
}
...
export async function dataProductsDelete(
  context: Client,
  subscriptionId: string,
  resourceGroupName: string,
  dataProductName: string,
  ...
  const result = await _dataProductsDeleteSend(
    context,
    subscriptionId,
    resourceGroupName,
    dataProductName,
  ...
  return _dataProductsDeleteDeserialize(result);
}
