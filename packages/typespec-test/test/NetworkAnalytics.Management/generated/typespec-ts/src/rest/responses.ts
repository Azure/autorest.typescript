...
export interface DataTypesDelete202Headers {
  /** The Location header contains the URL where the status of the long running operation can be checked. */
  location?: string;
  /** The Retry-After header can indicate how long the client should wait before polling the operation status. */
  "retry-after"?: number;
...
export interface DataTypesDelete202Response extends HttpResponse {
  status: "202";
  headers: RawHttpHeaders & DataTypesDelete202Headers;
}

/** Resource does not exist. */
export interface DataTypesDelete204Response extends HttpResponse {
  status: "204";
}

export interface DataTypesDeleteDefaultResponse extends HttpResponse {
  status: string;
  body: ErrorResponseOutput;
}
...
export interface DataProductsDelete202Headers {
  /** The Location header contains the URL where the status of the long running operation can be checked. */
  location?: string;
  /** The Retry-After header can indicate how long the client should wait before polling the operation status. */
  "retry-after"?: number;
...
/** Resource deletion accepted. */
export interface DataProductsDelete202Response extends HttpResponse {
  status: "202";
  headers: RawHttpHeaders & DataProductsDelete202Headers;
}

/** Resource does not exist. */
export interface DataProductsDelete204Response extends HttpResponse {
  status: "204";
}

export interface DataProductsDeleteDefaultResponse extends HttpResponse {
  status: string;
  body: ErrorResponseOutput;
}
