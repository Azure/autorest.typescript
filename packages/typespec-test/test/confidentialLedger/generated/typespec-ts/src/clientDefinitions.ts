...
export interface GetConsortiumMembers {
  ...
  ): StreamableMethod<GetConsortiumMembers200Response | GetConsortiumMembersDefaultResponse>;
}
...
export interface CreateLedgerEntry {
  ...
  ): StreamableMethod<CreateLedgerEntry201Response | CreateLedgerEntryDefaultResponse>;
}
