...
export { DataReplicationClientOptionalParams } from "./api/dataReplicationContext.js";

export class DataReplicationClient {
  private _client: DataReplicationContext;
  ...
  constructor(
    ...
    const userAgentPrefix = prefixFromOptions
      ...
      : `azsdk-js-client`;
    this._client = createDataReplication(credential, subscriptionId, {
      ...options,
