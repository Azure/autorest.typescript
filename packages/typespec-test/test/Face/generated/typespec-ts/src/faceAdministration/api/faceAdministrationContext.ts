...
export interface FaceAdministrationContext extends Client {
  /** API Version */
  apiVersion: Versions;
}
...
export function createFaceAdministration(
  ...
  return { ...clientContext, apiVersion } as FaceAdministrationContext;
}
