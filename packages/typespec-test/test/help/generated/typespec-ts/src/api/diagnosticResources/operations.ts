...
export function _createSend(
  ...
  options: DiagnosticResourcesCreateOptionalParams = { requestOptions: {} },
): StreamableMethod {
  ...
  return context
    ...
    .put({
      ...
      body: diagnosticResourceSerializer(diagnosticResourceRequest),
    });
}
...
export function _getSend(
  ...
  scope: string,
  diagnosticsResourceName: string,
  options: DiagnosticResourcesGetOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
    "/{+scope}/providers/Microsoft.Help/diagnostics/{diagnosticsResourceName}{?api%2Dversion}",
    {
