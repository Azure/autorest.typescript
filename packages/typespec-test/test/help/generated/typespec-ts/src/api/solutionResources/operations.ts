...
export function _warmUpSend(
  ...
  options: SolutionResourcesWarmUpOptionalParams = { requestOptions: {} },
): StreamableMethod {
...
export async function _warmUpDeserialize(
...
export async function warmUp(
  ...
  const result = await _warmUpSend(
    context,
    scope,
...
export function _updateSend(
  ...
  options: SolutionResourcesUpdateOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
  ...
  return context
    ...
    .patch({
      ...
      body: solutionPatchRequestBodySerializer(solutionPatchRequestBody),
    });
}
...
export function _createSend(
  ...
  options: SolutionResourcesCreateOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
    "/{+scope}/providers/Microsoft.Help/solutions/{solutionResourceName}{?api%2Dversion}",
    {
  ...
  return context
    ...
    .put({
      ...
      body: solutionResourceSerializer(solutionRequestBody),
    });
}
...
export function _getSend(
  ...
  scope: string,
  solutionResourceName: string,
  options: SolutionResourcesGetOptionalParams = { requestOptions: {} },
): StreamableMethod {
  const path = expandUrlTemplate(
    "/{+scope}/providers/Microsoft.Help/solutions/{solutionResourceName}{?api%2Dversion}",
    {
