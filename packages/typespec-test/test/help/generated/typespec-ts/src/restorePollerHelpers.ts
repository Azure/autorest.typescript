...
import { HelpClient } from "./helpClient.js";
import { _createDeserialize } from "./api/simplifiedSolutionsResources/operations.js";
import {
  _updateDeserialize,
  _createDeserialize as _createDeserializeSolutionResources,
} from "./api/solutionResources/operations.js";
import { _createDeserialize as _createDeserializeDiagnosticResources } from "./api/diagnosticResources/operations.js";
...
const deserializeMap: Record<string, DeserializationHelper> = {
  ...
  "PUT /{scope}/providers/Microsoft.Help/solutions/{solutionResourceName}": {
    deserializer: _createDeserializeSolutionResources,
    expectedStatuses: ["200", "201"],
  },
  "PUT /{scope}/providers/Microsoft.Help/diagnostics/{diagnosticsResourceName}":
    {
      deserializer: _createDeserializeDiagnosticResources,
      expectedStatuses: ["200", "201"],
    },
};
