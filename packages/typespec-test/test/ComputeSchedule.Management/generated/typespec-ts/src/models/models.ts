...
export function executeCreateRequestSerializer(
  item: ExecuteCreateRequest,
): any {
  return {
    resourceConfigParameters: resourceProvisionPayloadSerializer(
...
export function resourceProvisionPayloadSerializer(
  item: ResourceProvisionPayload,
): any {
  return {
...
export interface ExecuteDeleteRequest {
  ...
  /** Microsoft.Compute API version to target when calling delete endpoint. */
  computeApiVersion?: string;
}

export function executeDeleteRequestSerializer(
  item: ExecuteDeleteRequest,
): any {
  return {
    executionParameters: executionParametersSerializer(
      item["executionParameters"],
