# Azure LoadTestService client library for JavaScript
...
- [Package (NPM)](https://www.npmjs.com/package/@azure/load-testing-experimental)
- [API reference documentation](https://learn.microsoft.com/javascript/api/@azure/load-testing-experimental)
...
### Install the `@azure/load-testing-experimental` package

Install the Azure LoadTestService client library for JavaScript with `npm`:

```bash
npm install @azure/load-testing-experimental
```
...
```ts 
import { LoadTestServiceClient } from "@azure/load-testing-experimental";
