## API Report File for "@azure/load-testing-experimental"
...
export class LoadTestServiceClient {
    ...
    // Warning: (ae-forgotten-export) The symbol "TestProfileAdministrationOperations" needs to be exported by the entry point index.d.ts
    readonly testProfileAdministration: TestProfileAdministrationOperations;
    // Warning: (ae-forgotten-export) The symbol "TestProfileRunAdministrationOperations" needs to be exported by the entry point index.d.ts
