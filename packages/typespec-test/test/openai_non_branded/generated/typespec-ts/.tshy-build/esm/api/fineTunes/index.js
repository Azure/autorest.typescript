...
export function _createSend(context, fineTune, options = { requestOptions: {} }) {
    return context
        .path("/fine-tunes")
        .post({
...
export async function _createDeserialize(result) {
    ...
    return {
        ...
        hyperparams: {
            ...
            learningRateMultiplier: result.body.hyperparams["learning_rate_multiplier"],
            computeClassificationMetrics: result.body.hyperparams["compute_classification_metrics"],
            classificationPositiveClass: result.body.hyperparams["classification_positive_class"],
            classificationNClasses: result.body.hyperparams["classification_n_classes"],
        },
        ...
        events: result.body["events"] === undefined
            ? result.body["events"]
...
export async function create(context, fineTune, options = { requestOptions: {} }) {
    ...
    return {
        ...
        data: result.body["data"].map((p) => ({
            ...
            hyperparams: {
                ...
                computeClassificationMetrics: p.hyperparams["compute_classification_metrics"],
...
export function _retrieveSend(context, fineTuneId, options = { requestOptions: {} }) {
    return context
...
export async function retrieve(context, fineTuneId, options = { requestOptions: {} }) {
    const result = await _retrieveSend(context, fineTuneId, options);
    return _retrieveDeserialize(result);
}
export function _listEventsSend(context, fineTuneId, options = { requestOptions: {} }) {
    return context
...
export async function listEvents(context, fineTuneId, options = { requestOptions: {} }) {
    const result = await _listEventsSend(context, fineTuneId, options);
    return _listEventsDeserialize(result);
}
export function _cancelSend(context, fineTuneId, options = { requestOptions: {} }) {
    return context
...
export async function cancel(context, fineTuneId, options = { requestOptions: {} }) {
