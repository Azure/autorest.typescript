...
export interface FineTuningJobsCreate {
     ...
     */
    post(options: FineTuningJobsCreateParameters): StreamableMethod<FineTuningJobsCreate200Response | FineTuningJobsCreateDefaultResponse>;
    get(options?: FineTuningJobsListParameters): StreamableMethod<FineTuningJobsList200Response | FineTuningJobsListDefaultResponse>;
}
export interface FineTuningJobsRetrieve {
    get(options?: FineTuningJobsRetrieveParameters): StreamableMethod<FineTuningJobsRetrieve200Response | FineTuningJobsRetrieveDefaultResponse>;
}
export interface FineTuningJobsListEvents {
    get(options?: FineTuningJobsListEventsParameters): StreamableMethod<FineTuningJobsListEvents200Response | FineTuningJobsListEventsDefaultResponse>;
}
export interface FineTuningJobsCancel {
    post(options?: FineTuningJobsCancelParameters): StreamableMethod<FineTuningJobsCancel200Response | FineTuningJobsCancelDefaultResponse>;
}
...
export interface Routes {
    ...
    (path: "/fine_tuning/jobs/{fine_tuning_job_id}", fineTuningJobId: string): FineTuningJobsRetrieve;
    /** Resource for '/fine_tuning/jobs/\{fine_tuning_job_id\}/events' has methods for the following verbs: get */
    (path: "/fine_tuning/jobs/{fine_tuning_job_id}/events", fineTuningJobId: string): FineTuningJobsListEvents;
    /** Resource for '/fine_tuning/jobs/\{fine_tuning_job_id\}/cancel' has methods for the following verbs: post */
    (path: "/fine_tuning/jobs/{fine_tuning_job_id}/cancel", fineTuningJobId: string): FineTuningJobsCancel;
