...
import { CreateTranscriptionRequest, CreateTranslationRequest, CreateChatCompletionRequest, CreateFineTuningJobRequest, CreateCompletionRequest, CreateEditRequest, CreateEmbeddingRequest, CreateFileRequest, CreateFineTuneRequest, CreateImageRequest, CreateImageEditRequest, CreateImageVariationRequest, CreateModerationRequest } from "./models.js";
...
export type AudioTranscriptionsCreateParameters = AudioTranscriptionsCreateMediaTypesParam & AudioTranscriptionsCreateBodyParam & RequestParameters;
...
export type AudioTranslationsCreateParameters = AudioTranslationsCreateMediaTypesParam & AudioTranslationsCreateBodyParam & RequestParameters;
export interface ChatCompletionsCreateBodyParam {
    body?: CreateChatCompletionRequest;
}
export type ChatCompletionsCreateParameters = ChatCompletionsCreateBodyParam & RequestParameters;
export interface FineTuningJobsCreateBodyParam {
    body: CreateFineTuningJobRequest;
}
export type FineTuningJobsCreateParameters = FineTuningJobsCreateBodyParam & RequestParameters;
...
export type FineTuningJobsListParameters = FineTuningJobsListQueryParam & RequestParameters;
...
export type FineTuningJobsListEventsParameters = FineTuningJobsListEventsQueryParam & RequestParameters;
