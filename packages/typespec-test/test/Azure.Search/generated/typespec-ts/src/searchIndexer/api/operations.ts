...
import {
  ...
  azureSearchDocumentsIndexesSearchIndexerDataSourceConnectionSerializer,
  azureSearchDocumentsIndexesSearchIndexerDataSourceConnectionDeserializer,
  AzureSearchDocumentsIndexesListDataSourcesResult,
  azureSearchDocumentsIndexesListDataSourcesResultDeserializer,
  azureSearchDocumentsIndexesDocumentKeysOrIdsSerializer,
  AzureSearchDocumentsIndexesSearchIndexer,
  azureSearchDocumentsIndexesSearchIndexerSerializer,
  azureSearchDocumentsIndexesSearchIndexerDeserializer,
  AzureSearchDocumentsIndexesListIndexersResult,
  azureSearchDocumentsIndexesListIndexersResultDeserializer,
  AzureSearchDocumentsIndexesSearchIndexerStatus,
  azureSearchDocumentsIndexesSearchIndexerStatusDeserializer,
  AzureSearchDocumentsIndexesSearchIndexerSkillset,
  azureSearchDocumentsIndexesSearchIndexerSkillsetSerializer,
  azureSearchDocumentsIndexesSearchIndexerSkillsetDeserializer,
  AzureSearchDocumentsIndexesListSkillsetsResult,
  azureSearchDocumentsIndexesListSkillsetsResultDeserializer,
  AzureSearchDocumentsIndexesSkillNames,
  azureSearchDocumentsIndexesSkillNamesSerializer,
...
export function _resetSkillsSend(
  ...
  return context
    ...
    .post({
      ...
      body: azureSearchDocumentsIndexesSkillNamesSerializer(skillNames),
    });
}
...
export function _createSkillsetSend(
  ...
  return context
    ...
    .post({
      ...
      body: azureSearchDocumentsIndexesSearchIndexerSkillsetSerializer(
        skillset,
      ),
    });
}
...
export async function _createSkillsetDeserialize(
  ...
  return azureSearchDocumentsIndexesSearchIndexerSkillsetDeserializer(
    result.body,
  );
}
...
export async function _getSkillsetsDeserialize(
  ...
  return azureSearchDocumentsIndexesListSkillsetsResultDeserializer(
    result.body,
  );
}
...
export async function _getIndexerStatusDeserialize(
  ...
  return azureSearchDocumentsIndexesSearchIndexerStatusDeserializer(
    result.body,
  );
}
...
export function _createIndexerSend(
  ...
  return context
    ...
    .post({
      ...
      body: azureSearchDocumentsIndexesSearchIndexerSerializer(indexer),
    });
}
...
export async function _createIndexerDeserialize(
  ...
  return azureSearchDocumentsIndexesSearchIndexerDeserializer(result.body);
}
...
export async function _getIndexersDeserialize(
  ...
  return azureSearchDocumentsIndexesListIndexersResultDeserializer(result.body);
}
...
export function _createDataSourceConnectionSend(
  ...
  return context
    ...
    .post({
      ...
      body: azureSearchDocumentsIndexesSearchIndexerDataSourceConnectionSerializer(
        dataSource,
      ),
    });
}
...
export async function _getDataSourceConnectionsDeserialize(
  ...
  return azureSearchDocumentsIndexesListDataSourcesResultDeserializer(
    result.body,
  );
}
