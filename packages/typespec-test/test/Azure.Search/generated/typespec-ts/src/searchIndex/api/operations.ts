...
import {
  ...
  azureSearchDocumentsIndexesSynonymMapSerializer,
  azureSearchDocumentsIndexesSynonymMapDeserializer,
  AzureSearchDocumentsIndexesListSynonymMapsResult,
  azureSearchDocumentsIndexesListSynonymMapsResultDeserializer,
  AzureSearchDocumentsIndexesSearchIndex,
  azureSearchDocumentsIndexesSearchIndexSerializer,
  azureSearchDocumentsIndexesSearchIndexDeserializer,
  _AzureSearchDocumentsIndexesListIndexesResult,
  _azureSearchDocumentsIndexesListIndexesResultDeserializer,
  AzureSearchDocumentsIndexesGetIndexStatisticsResult,
  azureSearchDocumentsIndexesGetIndexStatisticsResultDeserializer,
  AzureSearchDocumentsIndexesAnalyzeTextOptions,
  azureSearchDocumentsIndexesAnalyzeTextOptionsSerializer,
  AzureSearchDocumentsIndexesAnalyzeResult,
  azureSearchDocumentsIndexesAnalyzeResultDeserializer,
  AzureSearchDocumentsIndexesSearchAlias,
  azureSearchDocumentsIndexesSearchAliasSerializer,
  azureSearchDocumentsIndexesSearchAliasDeserializer,
  _AzureSearchDocumentsIndexesListAliasesResult,
  _azureSearchDocumentsIndexesListAliasesResultDeserializer,
  AzureSearchDocumentsIndexesKnowledgeBase,
  azureSearchDocumentsIndexesKnowledgeBaseSerializer,
  azureSearchDocumentsIndexesKnowledgeBaseDeserializer,
  ...
  azureSearchDocumentsIndexesSearchServiceStatisticsDeserializer,
  _AzureSearchDocumentsIndexesListIndexStatsSummary,
  _azureSearchDocumentsIndexesListIndexStatsSummaryDeserializer,
  AzureSearchDocumentsIndexesIndexStatisticsSummary,
} from "../../models/azure/search/documents/indexes/models.js";
import { azureSearchDocumentsErrorResponseDeserializer } from "../../models/azure/search/documents/models.js";
import {
...
): Promise<_AzureSearchDocumentsIndexesListIndexStatsSummary> {
  const expectedStatuses = ["200"];
  if (!expectedStatuses.includes(result.status)) {
    const error = createRestError(result);
    error.details = azureSearchDocumentsErrorResponseDeserializer(result.body);
    throw error;
  }

  return _azureSearchDocumentsIndexesListIndexStatsSummaryDeserializer(
    result.body,
  );
}
...
export async function _getServiceStatisticsDeserialize(
  ...
  return azureSearchDocumentsIndexesSearchServiceStatisticsDeserializer(
    result.body,
  );
}
...
export function _createKnowledgeSourceSend(
  ...
  return context
    ...
    .post({
      ...
      body: azureSearchDocumentsIndexesKnowledgeSourceUnionSerializer(
        knowledgeSource,
      ),
    });
}
...
export async function _createKnowledgeSourceDeserialize(
  ...
  return azureSearchDocumentsIndexesKnowledgeSourceUnionDeserializer(
    result.body,
  );
}
...
export async function _listKnowledgeSourcesDeserialize(
  result: PathUncheckedResponse,
): Promise<_AzureSearchDocumentsIndexesListKnowledgeSourcesResult> {
  const expectedStatuses = ["200"];
  if (!expectedStatuses.includes(result.status)) {
    const error = createRestError(result);
    error.details = azureSearchDocumentsErrorResponseDeserializer(result.body);
  ...
  return _azureSearchDocumentsIndexesListKnowledgeSourcesResultDeserializer(
    result.body,
  );
}
...
export function _createKnowledgeBaseSend(
  ...
  return context
    ...
    .post({
      ...
      body: azureSearchDocumentsIndexesKnowledgeBaseSerializer(knowledgeBase),
    });
}
...
export async function _createKnowledgeBaseDeserialize(
  ...
  return azureSearchDocumentsIndexesKnowledgeBaseDeserializer(result.body);
}
...
export async function createKnowledgeBase(
  ...
  const result = await _createKnowledgeBaseSend(
    context,
    knowledgeBase,
    options,
  );
...
export async function _listKnowledgeBasesDeserialize(
  result: PathUncheckedResponse,
): Promise<_AzureSearchDocumentsIndexesListKnowledgeBasesResult> {
  const expectedStatuses = ["200"];
  if (!expectedStatuses.includes(result.status)) {
    const error = createRestError(result);
    error.details = azureSearchDocumentsErrorResponseDeserializer(result.body);
  ...
  return _azureSearchDocumentsIndexesListKnowledgeBasesResultDeserializer(
    result.body,
  );
}
...
export async function getKnowledgeBase(
  ...
  const result = await _getKnowledgeBaseSend(
    context,
    knowledgeBaseName,
    options,
  );
...
export async function deleteKnowledgeBase(
  ...
  const result = await _deleteKnowledgeBaseSend(
    context,
    knowledgeBaseName,
    options,
  );
...
export function _createAliasSend(
  ...
  return context
    ...
    .post({
      ...
      body: azureSearchDocumentsIndexesSearchAliasSerializer(alias),
    });
}

export async function _createAliasDeserialize(
  result: PathUncheckedResponse,
  ...
  return azureSearchDocumentsIndexesSearchAliasDeserializer(result.body);
}
...
export async function _listAliasesDeserialize(
  result: PathUncheckedResponse,
): Promise<_AzureSearchDocumentsIndexesListAliasesResult> {
  const expectedStatuses = ["200"];
  if (!expectedStatuses.includes(result.status)) {
    const error = createRestError(result);
    error.details = azureSearchDocumentsErrorResponseDeserializer(result.body);
  ...
  return _azureSearchDocumentsIndexesListAliasesResultDeserializer(result.body);
}
...
export async function _deleteAliasDeserialize(
  result: PathUncheckedResponse,
): Promise<void> {
  const expectedStatuses = ["204", "404"];
  if (!expectedStatuses.includes(result.status)) {
...
export async function createOrUpdateAlias(
  ...
  const result = await _createOrUpdateAliasSend(
    context,
    alias,
    aliasName,
    options,
...
export function _analyzeTextSend(
  ...
  return context
    ...
    .post({
      ...
      body: azureSearchDocumentsIndexesAnalyzeTextOptionsSerializer(request),
    });
}
...
export async function _analyzeTextDeserialize(
  ...
  return azureSearchDocumentsIndexesAnalyzeResultDeserializer(result.body);
}
...
export async function _getIndexStatisticsDeserialize(
  ...
  return azureSearchDocumentsIndexesGetIndexStatisticsResultDeserializer(
    result.body,
  );
}
...
export function _createIndexSend(
  ...
  return context
    ...
    .post({
      ...
      body: azureSearchDocumentsIndexesSearchIndexSerializer(index),
    });
}

export async function _createIndexDeserialize(
  result: PathUncheckedResponse,
  ...
  return azureSearchDocumentsIndexesSearchIndexDeserializer(result.body);
}
...
export async function _listIndexesDeserialize(
  result: PathUncheckedResponse,
): Promise<_AzureSearchDocumentsIndexesListIndexesResult> {
  const expectedStatuses = ["200"];
  if (!expectedStatuses.includes(result.status)) {
    const error = createRestError(result);
    error.details = azureSearchDocumentsErrorResponseDeserializer(result.body);
  ...
  return _azureSearchDocumentsIndexesListIndexesResultDeserializer(result.body);
}
...
export async function _deleteIndexDeserialize(
  result: PathUncheckedResponse,
): Promise<void> {
  const expectedStatuses = ["204", "404"];
  if (!expectedStatuses.includes(result.status)) {
...
export function _createSynonymMapSend(
  ...
  return context
    ...
    .post({
      ...
      body: azureSearchDocumentsIndexesSynonymMapSerializer(synonymMap),
    });
}
...
export async function _createSynonymMapDeserialize(
  ...
  return azureSearchDocumentsIndexesSynonymMapDeserializer(result.body);
}
...
export async function _getSynonymMapsDeserialize(
  ...
  return azureSearchDocumentsIndexesListSynonymMapsResultDeserializer(
    result.body,
  );
}
...
export async function _deleteSynonymMapDeserialize(
  result: PathUncheckedResponse,
): Promise<void> {
  const expectedStatuses = ["204", "404"];
  if (!expectedStatuses.includes(result.status)) {
...
export async function createOrUpdateSynonymMap(
  ...
  const result = await _createOrUpdateSynonymMapSend(
    context,
    synonymMap,
    synonymMapName,
    options,
