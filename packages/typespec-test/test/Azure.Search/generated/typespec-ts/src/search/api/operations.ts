...
import {
  azureSearchDocumentsErrorResponseDeserializer,
  AzureSearchDocumentsSearchDocumentsResult,
  azureSearchDocumentsSearchDocumentsResultDeserializer,
  azureSearchDocumentsVectorQueryUnionArraySerializer,
  azureSearchDocumentsHybridSearchSerializer,
  AzureSearchDocumentsLookupDocument,
  azureSearchDocumentsLookupDocumentDeserializer,
  AzureSearchDocumentsSuggestDocumentsResult,
  azureSearchDocumentsSuggestDocumentsResultDeserializer,
  AzureSearchDocumentsIndexDocumentsBatch,
  azureSearchDocumentsIndexDocumentsBatchSerializer,
  AzureSearchDocumentsIndexDocumentsResult,
  azureSearchDocumentsIndexDocumentsResultDeserializer,
  AzureSearchDocumentsAutocompleteResult,
  azureSearchDocumentsAutocompleteResultDeserializer,
...
export async function _autocompletePostDeserialize(
...
): Promise<AzureSearchDocumentsAutocompleteResult> {
  ...
  return azureSearchDocumentsAutocompleteResultDeserializer(result.body);
}
...
export function _indexSend(
  context: Client,
  batch: AzureSearchDocumentsIndexDocumentsBatch,
  ...
  return context
    ...
    .post({
      ...
      body: azureSearchDocumentsIndexDocumentsBatchSerializer(batch),
    });
}

export async function _indexDeserialize(
  result: PathUncheckedResponse,
): Promise<AzureSearchDocumentsIndexDocumentsResult> {
  ...
  return azureSearchDocumentsIndexDocumentsResultDeserializer(result.body);
}
...
export async function _suggestPostDeserialize(
  result: PathUncheckedResponse,
): Promise<AzureSearchDocumentsSuggestDocumentsResult> {
  const expectedStatuses = ["200"];
  if (!expectedStatuses.includes(result.status)) {
    const error = createRestError(result);
    error.details = azureSearchDocumentsErrorResponseDeserializer(result.body);
  ...
  return azureSearchDocumentsSuggestDocumentsResultDeserializer(result.body);
}
...
export async function _getDocumentDeserialize(
  result: PathUncheckedResponse,
): Promise<AzureSearchDocumentsLookupDocument> {
  const expectedStatuses = ["200"];
  if (!expectedStatuses.includes(result.status)) {
    const error = createRestError(result);
    error.details = azureSearchDocumentsErrorResponseDeserializer(result.body);
  ...
  return azureSearchDocumentsLookupDocumentDeserializer(result.body);
}
  ...
  return context.path(path).post({
    ...
    body: {
      ...
      hybridSearch: !options?.hybridSearch
        ...
        : azureSearchDocumentsHybridSearchSerializer(options?.hybridSearch),
    },
  });
}
...
export async function _searchPostDeserialize(
  result: PathUncheckedResponse,
): Promise<AzureSearchDocumentsSearchDocumentsResult> {
  const expectedStatuses = ["200"];
  if (!expectedStatuses.includes(result.status)) {
    const error = createRestError(result);
    error.details = azureSearchDocumentsErrorResponseDeserializer(result.body);
  ...
  return azureSearchDocumentsSearchDocumentsResultDeserializer(result.body);
}
