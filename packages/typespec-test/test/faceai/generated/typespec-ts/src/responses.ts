...
import type {
  ...
  FaceListOutput,
  PagedResponseFaceListItemOutput,
  AddFaceResultOutput,
  LargeFaceListOutput,
  PagedResponseLargeFaceListOutput,
  TrainingResultOutput,
  LargeFaceListFaceOutput,
  PagedResponseLargeFaceListFaceOutput,
  PersonGroupOutput,
  PagedResponsePersonGroupOutput,
  CreatePersonResultOutput,
  PersonGroupPersonOutput,
  PagedResponsePersonGroupPersonOutput,
  PersonGroupPersonFaceOutput,
  LargePersonGroupOutput,
  PagedResponseLargePersonGroupOutput,
  LargePersonGroupPersonOutput,
  PagedResponseLargePersonGroupPersonOutput,
...
export interface GetFaceLists200Response extends HttpResponse {
  status: "200";
  body: PagedResponseFaceListItemOutput;
}
...
export interface GetLargeFaceLists200Response extends HttpResponse {
  status: "200";
  body: PagedResponseLargeFaceListOutput;
}
...
export interface GetLargeFaceListFaces200Response extends HttpResponse {
  status: "200";
  body: PagedResponseLargeFaceListFaceOutput;
}
...
export interface GetPersonGroups200Response extends HttpResponse {
  status: "200";
  body: PagedResponsePersonGroupOutput;
}
...
export interface GetPersonGroupPersons200Response extends HttpResponse {
  status: "200";
  body: PagedResponsePersonGroupPersonOutput;
}
...
export interface GetLargePersonGroups200Response extends HttpResponse {
  status: "200";
  body: PagedResponseLargePersonGroupOutput;
}
...
export interface GetLargePersonGroupPersons200Response extends HttpResponse {
  status: "200";
  body: PagedResponseLargePersonGroupPersonOutput;
}
