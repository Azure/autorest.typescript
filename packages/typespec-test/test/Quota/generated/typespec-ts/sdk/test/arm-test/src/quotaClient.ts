...
import {
  ...
  _getGroupQuotasOperations,
} from "./classic/groupQuotas/index.js";
...
import {
  UsagesOperations,
  _getUsagesOperations,
} from "./classic/usages/index.js";
import { TokenCredential } from "@azure/core-auth";
import { Pipeline } from "@azure/core-rest-pipeline";

export { QuotaClientOptionalParams } from "./api/quotaContext.js";

export class QuotaClient {
  private _client: QuotaContext;
  ...
  constructor(
    ...
    options: QuotaClientOptionalParams = {},
  ) {
    const prefixFromOptions = options?.userAgentOptions?.userAgentPrefix;
    const userAgentPrefix = prefixFromOptions
      ? `${prefixFromOptions} azsdk-js-client`
      : `azsdk-js-client`;
    this._client = createQuota(credential, subscriptionId, {
      ...options,
    ...
    this.groupQuotaLocationSettings = _getGroupQuotaLocationSettingsOperations(
      this._client,
    );
    ...
    this.groupQuotaSubscriptionAllocation =
      _getGroupQuotaSubscriptionAllocationOperations(this._client);
    this.groupQuotaLimits = _getGroupQuotaLimitsOperations(this._client);
    this.groupQuotaSubscriptionRequests =
      _getGroupQuotaSubscriptionRequestsOperations(this._client);
    this.groupQuotaSubscriptions = _getGroupQuotaSubscriptionsOperations(
      this._client,
    );
    this.groupQuotaUsages = _getGroupQuotaUsagesOperations(this._client);
    this.groupQuotaLimitsRequest = _getGroupQuotaLimitsRequestOperations(
      this._client,
    );
