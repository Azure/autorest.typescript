...
export function $delete(
  ...
  return getLongRunningPoller(
    ...
    ["202", "204", "200"],
    {
      ...
      getInitialResponse: () =>
        _$deleteSend(context, managementGroupId, groupQuotaName, options),
...
export function update(
  ...
  OperationState<GroupQuotaSubscriptionId>,
  GroupQuotaSubscriptionId
> {
  return getLongRunningPoller(context, _updateDeserialize, ["200", "202"], {
    ...
    abortSignal: options?.abortSignal,
    getInitialResponse: () =>
      _updateSend(context, managementGroupId, groupQuotaName, options),
    resourceLocationConfig: "location",
  }) as PollerLike<
    OperationState<GroupQuotaSubscriptionId>,
    GroupQuotaSubscriptionId
