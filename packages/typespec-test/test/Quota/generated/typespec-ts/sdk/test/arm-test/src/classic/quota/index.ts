...
function _getQuota(context: QuotaContext) {
  return {
    list: (scope: string, options?: QuotaListOptionalParams) =>
...
export function _getQuotaOperations(context: QuotaContext): QuotaOperations {
  return {
    ..._getQuota(context),
  };
}
