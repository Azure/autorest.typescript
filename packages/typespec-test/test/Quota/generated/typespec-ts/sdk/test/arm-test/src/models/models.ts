...
export function operationResponseArrayDeserializer(
  result: Array<OperationResponse>,
): any[] {
...
export function exceptionResponseDeserializer(item: any): ExceptionResponse {
  return {
    error: !item["error"]
      ? item["error"]
      : serviceErrorDeserializer(item["error"]),
  };
}
...
export function serviceErrorDetailArrayDeserializer(
  result: Array<ServiceErrorDetail>,
): any[] {
  return result.map((item) => {
...
export function quotaRequestDetailsDeserializer(
  item: any,
): QuotaRequestDetails {
  return {
    id: item["id"],
...
export function quotaRequestPropertiesDeserializer(
  item: any,
...
export function subRequestDeserializer(item: any): SubRequest {
  return {
    ...
    limit: !item["limit"]
      ? item["limit"]
      : limitJsonObjectUnionDeserializer(item["limit"]),
  };
}
...
export function limitJsonObjectUnionSerializer(
  item: LimitJsonObjectUnion,
): any {
...
export function limitJsonObjectUnionDeserializer(
  item: any,
...
export function _quotaRequestDetailsListDeserializer(
  item: any,
...
export function quotaRequestDetailsArrayDeserializer(
  result: Array<QuotaRequestDetails>,
): any[] {
  return result.map((item) => {
...
export function groupQuotasEntityPropertiesSerializer(
  item: GroupQuotasEntityProperties,
): any {
  return { displayName: item["displayName"] };
}

export function groupQuotasEntityPropertiesDeserializer(
  item: any,
...
export function groupQuotasEntityBaseSerializer(
  item: GroupQuotasEntityBase,
): any {
  return { displayName: item["displayName"] };
}

export function groupQuotasEntityBaseDeserializer(
  item: any,
...
export function groupQuotasEntityPatchSerializer(
  item: GroupQuotasEntityPatch,
): any {
  return {
    properties: !item["properties"]
      ? item["properties"]
...
export function groupQuotasEntityBasePatchSerializer(
  item: GroupQuotasEntityBasePatch,
): any {
  return { displayName: item["displayName"] };
}
...
export function groupQuotasEntityArraySerializer(
  result: Array<GroupQuotasEntity>,
): any[] {
  return result.map((item) => {
...
export function groupQuotasEntityArrayDeserializer(
  result: Array<GroupQuotasEntity>,
): any[] {
  return result.map((item) => {
...
export function submittedResourceRequestStatusDeserializer(
  ...
  return {
    ...
    properties: !item["properties"]
      ? item["properties"]
      : submittedResourceRequestStatusPropertiesDeserializer(
          item["properties"],
        ),
  };
}
...
export function groupQuotaRequestBaseDeserializer(
  item: any,
...
export function groupQuotaLimitListDeserializer(
  item: any,
): GroupQuotaLimitList {
  return {
    id: item["id"],
...
export function groupQuotaLimitListPropertiesSerializer(
  item: GroupQuotaLimitListProperties,
): any {
  return {
    value: !item["value"]
      ? item["value"]
      : groupQuotaLimitArraySerializer(item["value"]),
  };
}
...
export function groupQuotaLimitListPropertiesDeserializer(
  ...
  return {
    ...
    value: !item["value"]
      ? item["value"]
      : groupQuotaLimitArrayDeserializer(item["value"]),
    nextLink: item["nextLink"],
  };
}

export function groupQuotaLimitArraySerializer(
  result: Array<GroupQuotaLimit>,
): any[] {
  return result.map((item) => {
...
export function groupQuotaLimitArrayDeserializer(
  result: Array<GroupQuotaLimit>,
): any[] {
  return result.map((item) => {
...
export function groupQuotaLimitPropertiesSerializer(
  item: GroupQuotaLimitProperties,
): any {
  return {
...
export function groupQuotaLimitPropertiesDeserializer(
  item: any,
...
export function groupQuotaDetailsNameDeserializer(
  item: any,
...
export function allocatedQuotaToSubscriptionListDeserializer(
  ...
  return {
    value: !item["value"]
      ? item["value"]
      : allocatedToSubscriptionArrayDeserializer(item["value"]),
  };
}
...
export function allocatedToSubscriptionDeserializer(
  item: any,
...
export function resourceUsagesArrayDeserializer(
  result: Array<ResourceUsages>,
): any[] {
  return result.map((item) => {
...
export function groupQuotaUsagesBaseDeserializer(
  item: any,
): GroupQuotaUsagesBase {
  return {
    name: !item["name"]
      ? item["name"]
      : groupQuotaUsagesBaseNameDeserializer(item["name"]),
    limit: item["limit"],
    usages: item["usages"],
    unit: item["unit"],
  };
...
export function groupQuotaUsagesBaseNameDeserializer(
  item: any,
...
export function groupQuotaSubscriptionIdDeserializer(
  item: any,
...
export function groupQuotaSubscriptionRequestStatusDeserializer(
  ...
  return {
    ...
    properties: !item["properties"]
      ? item["properties"]
      : groupQuotaSubscriptionRequestStatusPropertiesDeserializer(
          item["properties"],
        ),
  };
}
...
export function subscriptionQuotaAllocationsListSerializer(
  ...
  return {
    properties: !item["properties"]
      ? item["properties"]
      : subscriptionQuotaAllocationsListPropertiesSerializer(
          item["properties"],
        ),
  };
}
...
export function subscriptionQuotaAllocationsListDeserializer(
  ...
  return {
    ...
    properties: !item["properties"]
      ? item["properties"]
      : subscriptionQuotaAllocationsListPropertiesDeserializer(
          item["properties"],
        ),
  };
}
...
export function subscriptionQuotaAllocationsSerializer(
  item: SubscriptionQuotaAllocations,
): any {
  return {
    properties: !item["properties"]
      ? item["properties"]
...
export function subscriptionQuotaAllocationsDeserializer(
  item: any,
...
export function subscriptionQuotaAllocationsPropertiesDeserializer(
  ...
  return {
    ...
    name: !item["name"]
      ? item["name"]
      : subscriptionQuotaDetailsNameDeserializer(item["name"]),
  };
}
...
export function subscriptionQuotaDetailsSerializer(
  item: SubscriptionQuotaDetails,
): any {
  return { resourceName: item["resourceName"], limit: item["limit"] };
}

export function subscriptionQuotaDetailsDeserializer(
  item: any,
...
export function subscriptionQuotaDetailsNameDeserializer(
  item: any,
...
export function quotaAllocationRequestStatusDeserializer(
  item: any,
...
export function quotaAllocationRequestBaseDeserializer(
  item: any,
...
export function groupQuotasEnforcementStatusSerializer(
  item: GroupQuotasEnforcementStatus,
): any {
  return {
    properties: !item["properties"]
      ? item["properties"]
...
export function groupQuotasEnforcementStatusDeserializer(
  item: any,
...
export function usagesPropertiesDeserializer(item: any): UsagesProperties {
  return {
    usages: !item["usages"]
      ? item["usages"]
      : usagesObjectDeserializer(item["usages"]),
    unit: item["unit"],
    name: !item["name"] ? item["name"] : resourceNameDeserializer(item["name"]),
    resourceType: item["resourceType"],
...
export function currentUsagesBaseArrayDeserializer(
  result: Array<CurrentUsagesBase>,
): any[] {
  return result.map((item) => {
...
export function currentQuotaLimitBaseSerializer(
  item: CurrentQuotaLimitBase,
): any {
  return {
    properties: !item["properties"]
      ? item["properties"]
...
export function currentQuotaLimitBaseDeserializer(
  item: any,
...
export function quotaPropertiesSerializer(item: QuotaProperties): any {
  return {
    limit: !item["limit"]
      ? item["limit"]
      : limitJsonObjectUnionSerializer(item["limit"]),
...
export function currentQuotaLimitBaseArraySerializer(
