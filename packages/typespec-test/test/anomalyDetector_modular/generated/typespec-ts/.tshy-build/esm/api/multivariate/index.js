...
export function _getMultivariateBatchDetectionResultSend(context, resultId, options = {
    requestOptions: {},
}) {
    return context
...
export async function _getMultivariateBatchDetectionResultDeserialize(result) {
    ...
    return {
        ...
        summary: {
            ...
            errors: result.body.summary["errors"] === undefined
                ? result.body.summary["errors"]
                : result.body.summary["errors"].map((p) => ({
                    code: p["code"],
                    message: p["message"],
                })),
            variableStates: result.body.summary["variableStates"] === undefined
                ...
                : result.body.summary["variableStates"].map((p) => ({
                    ...
                    firstTimestamp: p["firstTimestamp"] !== undefined
                        ? new Date(p["firstTimestamp"])
                        : undefined,
                    lastTimestamp: p["lastTimestamp"] !== undefined
        ...
        results: result.body["results"].map((p) => ({
            ...
            value: !p.value
                ...
                : {
                    ...
                    score: p.value?.["score"],
                    interpretation: p.value?.["interpretation"] === undefined
 ...
 */
export async function getMultivariateBatchDetectionResult(context, resultId, options = {
    requestOptions: {},
}) {
...
export function _trainMultivariateModelSend(context, modelInfo, options = { requestOptions: {} }) {
    return context
            ...
            diagnosticsInfo: !modelInfo.diagnosticsInfo
                ...
                : {
                    modelState: !modelInfo.diagnosticsInfo?.modelState
                        ? undefined
                        : {
                            epochIds: modelInfo.diagnosticsInfo?.modelState?.["epochIds"],
                            trainLosses: modelInfo.diagnosticsInfo?.modelState?.["trainLosses"],
                            validationLosses: modelInfo.diagnosticsInfo?.modelState?.["validationLosses"],
                            latenciesInSeconds: modelInfo.diagnosticsInfo?.modelState?.["latenciesInSeconds"],
                        },
                    variableStates: modelInfo.diagnosticsInfo?.["variableStates"] === undefined
...
export async function _trainMultivariateModelDeserialize(result) {
    if (isUnexpected(result)) {
        throw createRestError(result);
    }
    return {
        ...
        modelInfo: !result.body.modelInfo
            ...
            : {
                ...
                errors: result.body.modelInfo?.["errors"] === undefined
                ...
                diagnosticsInfo: !result.body.modelInfo?.diagnosticsInfo
                    ...
                    : {
                        modelState: !result.body.modelInfo?.diagnosticsInfo?.modelState
                            ? undefined
                            : {
                                epochIds: result.body.modelInfo?.diagnosticsInfo?.modelState?.["epochIds"],
                                trainLosses: result.body.modelInfo?.diagnosticsInfo?.modelState?.["trainLosses"],
                                validationLosses: result.body.modelInfo?.diagnosticsInfo?.modelState?.["validationLosses"],
                                latenciesInSeconds: result.body.modelInfo?.diagnosticsInfo?.modelState?.["latenciesInSeconds"],
                            },
                        variableStates: result.body.modelInfo?.diagnosticsInfo?.["variableStates"] ===
                            undefined
                            ? result.body.modelInfo?.diagnosticsInfo?.["variableStates"]
                            : result.body.modelInfo?.diagnosticsInfo?.["variableStates"].map((p) => ({
                                variable: p["variable"],
                                filledNARatio: p["filledNARatio"],
                                effectiveCount: p["effectiveCount"],
                                firstTimestamp: p["firstTimestamp"] !== undefined
 ...
 * timestamp column.
 */
export async function trainMultivariateModel(context, modelInfo, options = { requestOptions: {} }) {
    const result = await _trainMultivariateModelSend(context, modelInfo, options);
    return _trainMultivariateModelDeserialize(result);
}
export function _listMultivariateModelsSend(context, options = { requestOptions: {} }) {
    return context
        .path("/multivariate/models")
        .get({
        ...operationOptionsToRequestParameters(options),
...
export async function _listMultivariateModelsDeserialize(result) {
    if (isUnexpected(result)) {
        throw createRestError(result);
    }
    return {
        models: result.body["models"].map((p) => ({
            ...
            modelInfo: !p.modelInfo
                ...
                : {
                    ...
                    errors: p.modelInfo?.["errors"] === undefined
                        ? p.modelInfo?.["errors"]
                        ...
                        : {
                            modelState: !p.modelInfo?.diagnosticsInfo?.modelState
                                ...
                                : {
                                    ...
                                    latenciesInSeconds: p.modelInfo?.diagnosticsInfo?.modelState?.["latenciesInSeconds"],
                                },
                            variableStates: p.modelInfo?.diagnosticsInfo?.["variableStates"] ===
                                undefined
                                ? p.modelInfo?.diagnosticsInfo?.["variableStates"]
                                : p.modelInfo?.diagnosticsInfo?.["variableStates"].map((p) => ({
                                    variable: p["variable"],
                                    filledNARatio: p["filledNARatio"],
                                    effectiveCount: p["effectiveCount"],
                                    firstTimestamp: p["firstTimestamp"] !== undefined
...
export function listMultivariateModels(context, options = { requestOptions: {} }) {
    return buildPagedAsyncIterator(context, () => _listMultivariateModelsSend(context, options), _listMultivariateModelsDeserialize, { itemName: "models", nextLinkName: "nextLink" });
}
export function _deleteMultivariateModelSend(context, modelId, options = { requestOptions: {} }) {
    return context
        .path("/multivariate/models/{modelId}", modelId)
        .delete({ ...operationOptionsToRequestParameters(options) });
}
export async function _deleteMultivariateModelDeserialize(result) {
    if (isUnexpected(result)) {
        throw createRestError(result);
    }
    return;
...
export async function deleteMultivariateModel(context, modelId, options = { requestOptions: {} }) {
    const result = await _deleteMultivariateModelSend(context, modelId, options);
    return _deleteMultivariateModelDeserialize(result);
}
export function _getMultivariateModelSend(context, modelId, options = { requestOptions: {} }) {
    return context
        .path("/multivariate/models/{modelId}", modelId)
        .get({ ...operationOptionsToRequestParameters(options) });
}
export async function _getMultivariateModelDeserialize(result) {
    if (isUnexpected(result)) {
        throw createRestError(result);
    }
    return {
 ...
 */
export async function getMultivariateModel(context, modelId, options = { requestOptions: {} }) {
    const result = await _getMultivariateModelSend(context, modelId, options);
    return _getMultivariateModelDeserialize(result);
}
export function _detectMultivariateBatchAnomalySend(context, modelId, options, options = {
    requestOptions: {},
}) {
    return context
...
export async function _detectMultivariateBatchAnomalyDeserialize(result) {
    if (isUnexpected(result)) {
        throw createRestError(result);
    }
    return {
 ...
 */
export async function detectMultivariateBatchAnomaly(context, modelId, options, options = {
    requestOptions: {},
}) {
    const result = await _detectMultivariateBatchAnomalySend(context, modelId, options, options);
    return _detectMultivariateBatchAnomalyDeserialize(result);
}
export function _detectMultivariateLastAnomalySend(context, modelId, options, options = {
    requestOptions: {},
}) {
    return context
...
export async function _detectMultivariateLastAnomalyDeserialize(result) {
    if (isUnexpected(result)) {
        throw createRestError(result);
    }
    return {
        variableStates: result.body["variableStates"] === undefined
 ...
 */
export async function detectMultivariateLastAnomaly(context, modelId, options, options = {
    requestOptions: {},
}) {
    const result = await _detectMultivariateLastAnomalySend(context, modelId, options, options);
