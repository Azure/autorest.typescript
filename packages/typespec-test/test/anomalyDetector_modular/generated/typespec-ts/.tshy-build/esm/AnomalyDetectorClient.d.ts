...
import { UnivariateOperations } from "./classic/univariate/index.js";
import { MultivariateOperations } from "./classic/multivariate/index.js";
import { AnomalyDetectorClientOptions } from "./api/index.js";
export { AnomalyDetectorClientOptions } from "./api/AnomalyDetectorContext.js";
export declare class AnomalyDetectorClient {
    private _client;
     ...
     */
    constructor(endpoint: string, credential: KeyCredential, options?: AnomalyDetectorClientOptions);
