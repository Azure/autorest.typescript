...
export interface TextTranslationGetLanguagesOptionalParams
...
export interface TextTranslationTranslateOptionalParams
  extends OperationOptions {
  /** A client-generated GUID to uniquely identify the request. */
  clientTraceId?: string;
  /**
...
export interface TextTranslationTransliterateOptionalParams
  extends OperationOptions {
  /** A client-generated GUID to uniquely identify the request. */
  clientTraceId?: string;
}

export interface TextTranslationDetectOptionalParams extends OperationOptions {
  /** A client-generated GUID to uniquely identify the request. */
  clientTraceId?: string;
}

export interface TextTranslationBreakSentenceOptionalParams
  extends OperationOptions {
  /** A client-generated GUID to uniquely identify the request. */
  clientTraceId?: string;
  /**
...
export interface TextTranslationDictionaryLookupOptionalParams
  extends OperationOptions {
  /** A client-generated GUID to uniquely identify the request. */
  clientTraceId?: string;
}

export interface TextTranslationDictionaryExamplesOptionalParams
  extends OperationOptions {
  /** A client-generated GUID to uniquely identify the request. */
  clientTraceId?: string;
}
