...
export interface MtErrorResponse {
  /** Error details. */
  error: ErrorDetails;
}
...
export interface DetectedLanguageWithAlternatives
  extends DetectedLanguageElement {
...
/** Translatpr supported versions */
/** */
export type APIVersion = "3.0";
