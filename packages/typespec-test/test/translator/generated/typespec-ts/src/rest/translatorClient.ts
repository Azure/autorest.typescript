...
import { TranslatorContext } from "./clientDefinitions.js";

/**
 * Initialize a new instance of `TranslatorContext`
...
export default function createClient(
  ...
  const client = getClient(endpointUrl, options) as TranslatorContext;
