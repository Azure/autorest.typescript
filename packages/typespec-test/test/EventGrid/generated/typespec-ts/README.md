...
```ts 
import { EventGridClient } from "@azure/arm-eventgrid";
import { DefaultAzureCredential } from "@azure/identity";

const subscriptionId = "00000000-0000-0000-0000-000000000000";
const client = new EventGridClient(new DefaultAzureCredential(), subscriptionId);
```
...
const subscriptionId = "00000000-0000-0000-0000-000000000000";
const client = new EventGridClient(credential, subscriptionId);
```
...
`EventGridClient` is the primary interface for developers using the Azure EventGridManagement client library. Explore the methods on this client object to understand the different features of the Azure EventGridManagement service that you can access.
