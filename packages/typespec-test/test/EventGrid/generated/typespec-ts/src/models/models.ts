...
/** The Client resource. */
export interface CustomClient extends ProxyResource {
...
export function customClientSerializer(item: CustomClient): any {
  return {
    properties: areAllPropsUndefined(item, [
      "description",
      "authenticationName",
      ...
      ? undefined
      : _customClientPropertiesSerializer(item),
  };
}

export function customClientDeserializer(item: any): CustomClient {
  return {
    id: item["id"],
    name: item["name"],
    type: item["type"],
    ...
    ...(!item["properties"]
      ? item["properties"]
      : _customClientPropertiesDeserializer(item["properties"])),
  };
}
...
export function _clientsListResultDeserializer(item: any): _ClientsListResult {
  return {
    value: customClientArrayDeserializer(item["value"]),
    nextLink: item["nextLink"],
  };
}

export function customClientArraySerializer(result: Array<CustomClient>): any[] {
  return result.map((item) => {
    return customClientSerializer(item);
  });
}

export function customClientArrayDeserializer(result: Array<CustomClient>): any[] {
  return result.map((item) => {
    return customClientDeserializer(item);
  });
}
...
export interface _DeliveryAttributeListResult {
  /** A collection of DeliveryAttributeMapping */
  value?: DeliveryAttributeMappingUnion[];
}

export function _deliveryAttributeListResultDeserializer(item: any): _DeliveryAttributeListResult {
  return {
    value: !item["value"]
      ? item["value"]
...
export interface PrivateLinkResource extends ProxyResource_1 {
  groupId?: string;
  displayName?: string;
...
export interface EventType extends Resource_1 {
...
export function _customClientPropertiesSerializer(item: CustomClient): any {
  return {
    description: item["description"],
    authenticationName: item["authenticationName"],
    clientCertificateAuthentication: !item["clientCertificateAuthentication"]
...
export function _customClientPropertiesDeserializer(item: any) {
  return {
    description: item["description"],
    authenticationName: item["authenticationName"],
    clientCertificateAuthentication: !item["clientCertificateAuthentication"]
