...
import { AzureHealthInsightsContext } from "./api/ClinicalMatchingContext.js";
import { ClinicalMatchingClient } from "./ClinicalMatchingClient.js";
import { getLongRunningPoller } from "./api/pollingHelpers.js";
import { _matchTrialsDeserialize } from "./api/operations.js";
import {
...
export function restorePoller<TResponse extends PathUncheckedResponse, TResult>(
  client: AzureHealthInsightsContext | ClinicalMatchingClient,
...
const deserializeMap: Record<string, Function> = {
  "POST /trialmatcher/jobs": _matchTrialsDeserialize,
};
