...
export function isUnexpected(
  response: TrialMatcherGetJob200Response | TrialMatcherGetJobDefaultResponse,
): response is TrialMatcherGetJobDefaultResponse;
export function isUnexpected(
  response:
    | TrialMatcherCreateJob200Response
    | TrialMatcherCreateJob202Response
    | TrialMatcherCreateJobLogicalResponse
    | TrialMatcherCreateJobDefaultResponse,
): response is TrialMatcherCreateJobDefaultResponse;
export function isUnexpected(
  response:
    | TrialMatcherGetJob200Response
    | TrialMatcherGetJobDefaultResponse
