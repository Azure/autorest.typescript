...
import {
  ...
  LocationsCheckTrialAvailabilityParameters,
  LocationsCheckQuotaAvailabilityParameters,
  PrivateCloudsListByResourceGroupParameters,
  PrivateCloudsListInSubscriptionParameters,
  PrivateCloudsGetParameters,
  PrivateCloudsCreateOrUpdateParameters,
  PrivateCloudsUpdateParameters,
  PrivateCloudsDeleteParameters,
  PrivateCloudsRotateVcenterPasswordParameters,
  PrivateCloudsRotateNsxtPasswordParameters,
  PrivateCloudsListAdminCredentialsParameters,
  ClustersListByPrivateCloudParameters,
  ClustersGetParameters,
  ClustersCreateOrUpdateParameters,
  ClustersUpdateParameters,
  ClustersDeleteParameters,
  ClustersListZonesParameters,
  DatastoresListByClusterParameters,
  DatastoresGetParameters,
  DatastoresCreateOrUpdateParameters,
  DatastoresDeleteParameters,
  HcxEnterpriseSitesListByPrivateCloudParameters,
  HcxEnterpriseSitesGetParameters,
  HcxEnterpriseSitesCreateOrUpdateParameters,
  HcxEnterpriseSitesDeleteParameters,
  AuthorizationsListByPrivateCloudParameters,
  AuthorizationsGetParameters,
  AuthorizationsCreateOrUpdateParameters,
  AuthorizationsDeleteParameters,
  GlobalReachConnectionsListByPrivateCloudParameters,
  GlobalReachConnectionsGetParameters,
  GlobalReachConnectionsCreateOrUpdateParameters,
  GlobalReachConnectionsDeleteParameters,
  WorkloadNetworksGetParameters,
  WorkloadNetworksListByPrivateCloudParameters,
  WorkloadNetworkSegmentsListByWorkloadNetworkParameters,
  WorkloadNetworkSegmentsGetParameters,
  WorkloadNetworkSegmentsCreateParameters,
  WorkloadNetworkSegmentsUpdateParameters,
  WorkloadNetworkSegmentsDeleteSegmentParameters,
  WorkloadNetworkDhcpConfigurationsListByWorkloadNetworkParameters,
  WorkloadNetworkDhcpConfigurationsGetParameters,
  WorkloadNetworkDhcpConfigurationsCreateParameters,
  WorkloadNetworkDhcpConfigurationsUpdateParameters,
  WorkloadNetworkDhcpConfigurationsDeleteParameters,
  WorkloadNetworkGatewaysListByWorkloadNetworkParameters,
  WorkloadNetworkGatewaysGetParameters,
  WorkloadNetworkPortMirroringProfilesListByWorkloadNetworkParameters,
  WorkloadNetworkPortMirroringProfilesGetParameters,
  WorkloadNetworkPortMirroringProfilesCreateParameters,
  WorkloadNetworkPortMirroringProfilesUpdateParameters,
  WorkloadNetworkPortMirroringProfilesDeleteParameters,
  WorkloadNetworkVmGroupsListByWorkloadNetworkParameters,
  WorkloadNetworkVmGroupsGetParameters,
  WorkloadNetworkVmGroupsCreateParameters,
  WorkloadNetworkVmGroupsUpdateParameters,
  WorkloadNetworkVmGroupsDeleteParameters,
  WorkloadNetworkVirtualMachinesListByWorkloadNetworkParameters,
  WorkloadNetworkVirtualMachinesGetParameters,
  WorkloadNetworkDnsServicesListByWorkloadNetworkParameters,
  WorkloadNetworkDnsServicesGetParameters,
  WorkloadNetworkDnsServicesCreateParameters,
  WorkloadNetworkDnsServicesUpdateParameters,
  WorkloadNetworkDnsServicesDeleteParameters,
  WorkloadNetworkDnsZonesListByWorkloadNetworkParameters,
  WorkloadNetworkDnsZonesGetParameters,
  WorkloadNetworkDnsZonesCreateParameters,
  WorkloadNetworkDnsZonesUpdateParameters,
  WorkloadNetworkDnsZonesDeleteParameters,
  WorkloadNetworkPublicIpsListByWorkloadNetworkParameters,
  WorkloadNetworkPublicIpsGetParameters,
  WorkloadNetworkPublicIpsCreateParameters,
  WorkloadNetworkPublicIpsDeleteParameters,
  CloudLinksListByPrivateCloudParameters,
  CloudLinksGetParameters,
  CloudLinksCreateOrUpdateParameters,
  CloudLinksDeleteParameters,
  AddonsListByPrivateCloudParameters,
  AddonsGetParameters,
  AddonsCreateOrUpdateParameters,
  AddonsDeleteParameters,
  VirtualMachinesListByClusterParameters,
  VirtualMachinesGetParameters,
  VirtualMachinesRestrictMovementParameters,
  PlacementPoliciesListByClusterParameters,
  PlacementPoliciesGetParameters,
  PlacementPoliciesCreateOrUpdateParameters,
  PlacementPoliciesUpdateParameters,
  PlacementPoliciesDeleteParameters,
  ScriptPackagesListByPrivateCloudParameters,
  ScriptPackagesGetParameters,
  ScriptCmdletsListByScriptPackageParameters,
  ScriptCmdletsGetParameters,
  ScriptExecutionsListByPrivateCloudParameters,
  ScriptExecutionsGetParameters,
  ScriptExecutionsCreateOrUpdateParameters,
  ScriptExecutionsDeleteParameters,
  ScriptExecutionsGetExecutionLogsParameters,
  IscsiPathsListByPrivateCloudParameters,
  IscsiPathsGetParameters,
  IscsiPathsCreateOrUpdateParameters,
  IscsiPathsDeleteParameters,
} from "./parameters.js";
import {
...
export interface LocationsCheckTrialAvailability {
  ...
  post(
    options?: LocationsCheckTrialAvailabilityParameters,
  ): StreamableMethod<
    | LocationsCheckTrialAvailability200Response
    | LocationsCheckTrialAvailabilityDefaultResponse
  >;
...
export interface LocationsCheckQuotaAvailability {
  ...
  post(
    options?: LocationsCheckQuotaAvailabilityParameters,
  ): StreamableMethod<
    | LocationsCheckQuotaAvailability200Response
    | LocationsCheckQuotaAvailabilityDefaultResponse
  >;
...
export interface PrivateCloudsListByResourceGroup {
  ...
  get(
    options?: PrivateCloudsListByResourceGroupParameters,
  ): StreamableMethod<
    | PrivateCloudsListByResourceGroup200Response
    | PrivateCloudsListByResourceGroupDefaultResponse
  >;
...
export interface PrivateCloudsListInSubscription {
  ...
  get(
    options?: PrivateCloudsListInSubscriptionParameters,
  ): StreamableMethod<
    | PrivateCloudsListInSubscription200Response
    | PrivateCloudsListInSubscriptionDefaultResponse
  >;
...
export interface PrivateCloudsGet {
  ...
  patch(
    options: PrivateCloudsUpdateParameters,
  ): StreamableMethod<
    | PrivateCloudsUpdate200Response
    | PrivateCloudsUpdate201Response
    | PrivateCloudsUpdateDefaultResponse
  ...
  delete(
    options?: PrivateCloudsDeleteParameters,
  ): StreamableMethod<
    | PrivateCloudsDelete200Response
    | PrivateCloudsDelete202Response
    | PrivateCloudsDelete204Response
...
export interface PrivateCloudsRotateVcenterPassword {
  ...
  post(
    options?: PrivateCloudsRotateVcenterPasswordParameters,
  ): StreamableMethod<
    | PrivateCloudsRotateVcenterPassword202Response
    | PrivateCloudsRotateVcenterPassword204Response
    | PrivateCloudsRotateVcenterPasswordDefaultResponse
...
export interface PrivateCloudsRotateNsxtPassword {
  ...
  post(
    options?: PrivateCloudsRotateNsxtPasswordParameters,
  ): StreamableMethod<
    | PrivateCloudsRotateNsxtPassword202Response
    | PrivateCloudsRotateNsxtPassword204Response
    | PrivateCloudsRotateNsxtPasswordDefaultResponse
...
export interface PrivateCloudsListAdminCredentials {
  ...
  post(
    options?: PrivateCloudsListAdminCredentialsParameters,
  ): StreamableMethod<
    | PrivateCloudsListAdminCredentials200Response
    | PrivateCloudsListAdminCredentialsDefaultResponse
  >;
...
export interface ClustersListByPrivateCloud {
  ...
  get(
    options?: ClustersListByPrivateCloudParameters,
  ): StreamableMethod<
    | ClustersListByPrivateCloud200Response
    | ClustersListByPrivateCloudDefaultResponse
  >;
...
export interface ClustersListZones {
  ...
  post(
    options?: ClustersListZonesParameters,
  ): StreamableMethod<
...
export interface DatastoresListByCluster {
  ...
  get(
    options?: DatastoresListByClusterParameters,
  ): StreamableMethod<
...
export interface HcxEnterpriseSitesListByPrivateCloud {
  ...
  get(
    options?: HcxEnterpriseSitesListByPrivateCloudParameters,
  ): StreamableMethod<
    | HcxEnterpriseSitesListByPrivateCloud200Response
    | HcxEnterpriseSitesListByPrivateCloudDefaultResponse
  >;
...
export interface HcxEnterpriseSitesGet {
  ...
  delete(
    options?: HcxEnterpriseSitesDeleteParameters,
  ): StreamableMethod<
    | HcxEnterpriseSitesDelete200Response
    | HcxEnterpriseSitesDelete204Response
    | HcxEnterpriseSitesDeleteDefaultResponse
...
export interface AuthorizationsListByPrivateCloud {
  ...
  get(
    options?: AuthorizationsListByPrivateCloudParameters,
  ): StreamableMethod<
    | AuthorizationsListByPrivateCloud200Response
    | AuthorizationsListByPrivateCloudDefaultResponse
  >;
...
export interface AuthorizationsGet {
  ...
  get(
    options?: AuthorizationsGetParameters,
  ): StreamableMethod<
    AuthorizationsGet200Response | AuthorizationsGetDefaultResponse
  >;
  /** Create a ExpressRouteAuthorization */
  put(
    options: AuthorizationsCreateOrUpdateParameters,
  ): StreamableMethod<
    | AuthorizationsCreateOrUpdate200Response
    | AuthorizationsCreateOrUpdate201Response
    | AuthorizationsCreateOrUpdateDefaultResponse
  ...
  delete(
    options?: AuthorizationsDeleteParameters,
  ): StreamableMethod<
    | AuthorizationsDelete200Response
    | AuthorizationsDelete202Response
    | AuthorizationsDelete204Response
...
export interface GlobalReachConnectionsListByPrivateCloud {
  ...
  get(
    options?: GlobalReachConnectionsListByPrivateCloudParameters,
  ): StreamableMethod<
    | GlobalReachConnectionsListByPrivateCloud200Response
    | GlobalReachConnectionsListByPrivateCloudDefaultResponse
  >;
...
export interface GlobalReachConnectionsGet {
  ...
  get(
    options?: GlobalReachConnectionsGetParameters,
  ): StreamableMethod<
    | GlobalReachConnectionsGet200Response
    | GlobalReachConnectionsGetDefaultResponse
  >;
  ...
  put(
    options: GlobalReachConnectionsCreateOrUpdateParameters,
  ): StreamableMethod<
    | GlobalReachConnectionsCreateOrUpdate200Response
    | GlobalReachConnectionsCreateOrUpdate201Response
    | GlobalReachConnectionsCreateOrUpdateDefaultResponse
  ...
  delete(
    options?: GlobalReachConnectionsDeleteParameters,
  ): StreamableMethod<
    | GlobalReachConnectionsDelete200Response
    | GlobalReachConnectionsDelete202Response
    | GlobalReachConnectionsDelete204Response
...
export interface WorkloadNetworksGet {
  ...
  get(
    options?: WorkloadNetworksGetParameters,
  ): StreamableMethod<
...
export interface WorkloadNetworksListByPrivateCloud {
  ...
  get(
    options?: WorkloadNetworksListByPrivateCloudParameters,
  ): StreamableMethod<
    | WorkloadNetworksListByPrivateCloud200Response
    | WorkloadNetworksListByPrivateCloudDefaultResponse
  >;
...
export interface WorkloadNetworkSegmentsListByWorkloadNetwork {
  ...
  get(
    options?: WorkloadNetworkSegmentsListByWorkloadNetworkParameters,
  ): StreamableMethod<
    | WorkloadNetworkSegmentsListByWorkloadNetwork200Response
    | WorkloadNetworkSegmentsListByWorkloadNetworkDefaultResponse
  >;
...
export interface WorkloadNetworkSegmentsGet {
  ...
  get(
    options?: WorkloadNetworkSegmentsGetParameters,
  ): StreamableMethod<
    | WorkloadNetworkSegmentsGet200Response
    | WorkloadNetworkSegmentsGetDefaultResponse
  >;
  ...
  put(
    options: WorkloadNetworkSegmentsCreateParameters,
  ): StreamableMethod<
    | WorkloadNetworkSegmentsCreate200Response
    | WorkloadNetworkSegmentsCreate201Response
    | WorkloadNetworkSegmentsCreateDefaultResponse
  ...
  patch(
    options: WorkloadNetworkSegmentsUpdateParameters,
  ): StreamableMethod<
    | WorkloadNetworkSegmentsUpdate200Response
    | WorkloadNetworkSegmentsUpdate202Response
    | WorkloadNetworkSegmentsUpdateDefaultResponse
  ...
  delete(
    options?: WorkloadNetworkSegmentsDeleteSegmentParameters,
  ): StreamableMethod<
    | WorkloadNetworkSegmentsDeleteSegment200Response
    | WorkloadNetworkSegmentsDeleteSegment202Response
    | WorkloadNetworkSegmentsDeleteSegment204Response
...
export interface WorkloadNetworkDhcpConfigurationsListByWorkloadNetwork {
  ...
  get(
    options?: WorkloadNetworkDhcpConfigurationsListByWorkloadNetworkParameters,
  ): StreamableMethod<
    | WorkloadNetworkDhcpConfigurationsListByWorkloadNetwork200Response
    | WorkloadNetworkDhcpConfigurationsListByWorkloadNetworkDefaultResponse
  >;
...
export interface WorkloadNetworkDhcpConfigurationsGet {
  ...
  get(
    options?: WorkloadNetworkDhcpConfigurationsGetParameters,
  ): StreamableMethod<
    | WorkloadNetworkDhcpConfigurationsGet200Response
    | WorkloadNetworkDhcpConfigurationsGetDefaultResponse
  >;
  ...
  put(
    options: WorkloadNetworkDhcpConfigurationsCreateParameters,
  ): StreamableMethod<
    | WorkloadNetworkDhcpConfigurationsCreate200Response
    | WorkloadNetworkDhcpConfigurationsCreate201Response
    | WorkloadNetworkDhcpConfigurationsCreateDefaultResponse
  ...
  patch(
    options: WorkloadNetworkDhcpConfigurationsUpdateParameters,
  ): StreamableMethod<
    | WorkloadNetworkDhcpConfigurationsUpdate200Response
    | WorkloadNetworkDhcpConfigurationsUpdate202Response
    | WorkloadNetworkDhcpConfigurationsUpdateDefaultResponse
  ...
  delete(
    options?: WorkloadNetworkDhcpConfigurationsDeleteParameters,
  ): StreamableMethod<
    | WorkloadNetworkDhcpConfigurationsDelete200Response
    | WorkloadNetworkDhcpConfigurationsDelete202Response
    | WorkloadNetworkDhcpConfigurationsDelete204Response
...
export interface WorkloadNetworkGatewaysListByWorkloadNetwork {
  ...
  get(
    options?: WorkloadNetworkGatewaysListByWorkloadNetworkParameters,
  ): StreamableMethod<
    | WorkloadNetworkGatewaysListByWorkloadNetwork200Response
    | WorkloadNetworkGatewaysListByWorkloadNetworkDefaultResponse
  >;
...
export interface WorkloadNetworkGatewaysGet {
  ...
  get(
    options?: WorkloadNetworkGatewaysGetParameters,
  ): StreamableMethod<
    | WorkloadNetworkGatewaysGet200Response
    | WorkloadNetworkGatewaysGetDefaultResponse
  >;
...
export interface WorkloadNetworkPortMirroringProfilesListByWorkloadNetwork {
  ...
  get(
    options?: WorkloadNetworkPortMirroringProfilesListByWorkloadNetworkParameters,
  ): StreamableMethod<
    | WorkloadNetworkPortMirroringProfilesListByWorkloadNetwork200Response
    | WorkloadNetworkPortMirroringProfilesListByWorkloadNetworkDefaultResponse
  >;
...
export interface WorkloadNetworkPortMirroringProfilesGet {
  ...
  get(
    options?: WorkloadNetworkPortMirroringProfilesGetParameters,
  ): StreamableMethod<
    | WorkloadNetworkPortMirroringProfilesGet200Response
    | WorkloadNetworkPortMirroringProfilesGetDefaultResponse
  >;
  ...
  put(
    options: WorkloadNetworkPortMirroringProfilesCreateParameters,
  ): StreamableMethod<
    | WorkloadNetworkPortMirroringProfilesCreate200Response
    | WorkloadNetworkPortMirroringProfilesCreate201Response
    | WorkloadNetworkPortMirroringProfilesCreateDefaultResponse
  ...
  patch(
    options: WorkloadNetworkPortMirroringProfilesUpdateParameters,
  ): StreamableMethod<
    | WorkloadNetworkPortMirroringProfilesUpdate200Response
    | WorkloadNetworkPortMirroringProfilesUpdate202Response
    | WorkloadNetworkPortMirroringProfilesUpdateDefaultResponse
  ...
  delete(
    options?: WorkloadNetworkPortMirroringProfilesDeleteParameters,
  ): StreamableMethod<
    | WorkloadNetworkPortMirroringProfilesDelete200Response
    | WorkloadNetworkPortMirroringProfilesDelete202Response
    | WorkloadNetworkPortMirroringProfilesDelete204Response
...
export interface WorkloadNetworkVmGroupsListByWorkloadNetwork {
  ...
  get(
    options?: WorkloadNetworkVmGroupsListByWorkloadNetworkParameters,
  ): StreamableMethod<
    | WorkloadNetworkVmGroupsListByWorkloadNetwork200Response
    | WorkloadNetworkVmGroupsListByWorkloadNetworkDefaultResponse
  >;
...
export interface WorkloadNetworkVmGroupsGet {
  ...
  get(
    options?: WorkloadNetworkVmGroupsGetParameters,
  ): StreamableMethod<
    | WorkloadNetworkVmGroupsGet200Response
    | WorkloadNetworkVmGroupsGetDefaultResponse
  >;
  ...
  put(
    options: WorkloadNetworkVmGroupsCreateParameters,
  ): StreamableMethod<
    | WorkloadNetworkVmGroupsCreate200Response
    | WorkloadNetworkVmGroupsCreate201Response
    | WorkloadNetworkVmGroupsCreateDefaultResponse
  ...
  patch(
    options: WorkloadNetworkVmGroupsUpdateParameters,
  ): StreamableMethod<
    | WorkloadNetworkVmGroupsUpdate200Response
    | WorkloadNetworkVmGroupsUpdate202Response
    | WorkloadNetworkVmGroupsUpdateDefaultResponse
  ...
  delete(
    options?: WorkloadNetworkVmGroupsDeleteParameters,
  ): StreamableMethod<
    | WorkloadNetworkVmGroupsDelete200Response
    | WorkloadNetworkVmGroupsDelete202Response
    | WorkloadNetworkVmGroupsDelete204Response
...
export interface WorkloadNetworkVirtualMachinesListByWorkloadNetwork {
  ...
  get(
    options?: WorkloadNetworkVirtualMachinesListByWorkloadNetworkParameters,
  ): StreamableMethod<
    | WorkloadNetworkVirtualMachinesListByWorkloadNetwork200Response
    | WorkloadNetworkVirtualMachinesListByWorkloadNetworkDefaultResponse
  >;
...
export interface WorkloadNetworkVirtualMachinesGet {
  ...
  get(
    options?: WorkloadNetworkVirtualMachinesGetParameters,
  ): StreamableMethod<
    | WorkloadNetworkVirtualMachinesGet200Response
    | WorkloadNetworkVirtualMachinesGetDefaultResponse
  >;
...
export interface WorkloadNetworkDnsServicesListByWorkloadNetwork {
  ...
  get(
    options?: WorkloadNetworkDnsServicesListByWorkloadNetworkParameters,
  ): StreamableMethod<
    | WorkloadNetworkDnsServicesListByWorkloadNetwork200Response
    | WorkloadNetworkDnsServicesListByWorkloadNetworkDefaultResponse
  >;
...
export interface WorkloadNetworkDnsServicesGet {
  ...
  get(
    options?: WorkloadNetworkDnsServicesGetParameters,
  ): StreamableMethod<
    | WorkloadNetworkDnsServicesGet200Response
    | WorkloadNetworkDnsServicesGetDefaultResponse
  >;
  ...
  put(
    options: WorkloadNetworkDnsServicesCreateParameters,
  ): StreamableMethod<
    | WorkloadNetworkDnsServicesCreate200Response
    | WorkloadNetworkDnsServicesCreate201Response
    | WorkloadNetworkDnsServicesCreateDefaultResponse
  ...
  patch(
    options: WorkloadNetworkDnsServicesUpdateParameters,
  ): StreamableMethod<
    | WorkloadNetworkDnsServicesUpdate200Response
    | WorkloadNetworkDnsServicesUpdate202Response
    | WorkloadNetworkDnsServicesUpdateDefaultResponse
  ...
  delete(
    options?: WorkloadNetworkDnsServicesDeleteParameters,
  ): StreamableMethod<
    | WorkloadNetworkDnsServicesDelete200Response
    | WorkloadNetworkDnsServicesDelete202Response
    | WorkloadNetworkDnsServicesDelete204Response
...
export interface WorkloadNetworkDnsZonesListByWorkloadNetwork {
  ...
  get(
    options?: WorkloadNetworkDnsZonesListByWorkloadNetworkParameters,
  ): StreamableMethod<
    | WorkloadNetworkDnsZonesListByWorkloadNetwork200Response
    | WorkloadNetworkDnsZonesListByWorkloadNetworkDefaultResponse
  >;
...
export interface WorkloadNetworkDnsZonesGet {
  ...
  get(
    options?: WorkloadNetworkDnsZonesGetParameters,
  ): StreamableMethod<
    | WorkloadNetworkDnsZonesGet200Response
    | WorkloadNetworkDnsZonesGetDefaultResponse
  >;
  ...
  put(
    options: WorkloadNetworkDnsZonesCreateParameters,
  ): StreamableMethod<
    | WorkloadNetworkDnsZonesCreate200Response
    | WorkloadNetworkDnsZonesCreate201Response
    | WorkloadNetworkDnsZonesCreateDefaultResponse
  ...
  patch(
    options: WorkloadNetworkDnsZonesUpdateParameters,
  ): StreamableMethod<
    | WorkloadNetworkDnsZonesUpdate200Response
    | WorkloadNetworkDnsZonesUpdate202Response
    | WorkloadNetworkDnsZonesUpdateDefaultResponse
  ...
  delete(
    options?: WorkloadNetworkDnsZonesDeleteParameters,
  ): StreamableMethod<
    | WorkloadNetworkDnsZonesDelete200Response
    | WorkloadNetworkDnsZonesDelete202Response
    | WorkloadNetworkDnsZonesDelete204Response
...
export interface WorkloadNetworkPublicIpsListByWorkloadNetwork {
  ...
  get(
    options?: WorkloadNetworkPublicIpsListByWorkloadNetworkParameters,
  ): StreamableMethod<
    | WorkloadNetworkPublicIpsListByWorkloadNetwork200Response
    | WorkloadNetworkPublicIpsListByWorkloadNetworkDefaultResponse
  >;
...
export interface WorkloadNetworkPublicIpsGet {
  ...
  get(
    options?: WorkloadNetworkPublicIpsGetParameters,
  ): StreamableMethod<
    | WorkloadNetworkPublicIpsGet200Response
    | WorkloadNetworkPublicIpsGetDefaultResponse
  >;
  ...
  put(
    options: WorkloadNetworkPublicIpsCreateParameters,
  ): StreamableMethod<
    | WorkloadNetworkPublicIpsCreate200Response
    | WorkloadNetworkPublicIpsCreate201Response
    | WorkloadNetworkPublicIpsCreateDefaultResponse
  ...
  delete(
    options?: WorkloadNetworkPublicIpsDeleteParameters,
  ): StreamableMethod<
    | WorkloadNetworkPublicIpsDelete200Response
    | WorkloadNetworkPublicIpsDelete202Response
    | WorkloadNetworkPublicIpsDelete204Response
...
export interface CloudLinksListByPrivateCloud {
  ...
  get(
    options?: CloudLinksListByPrivateCloudParameters,
  ): StreamableMethod<
    | CloudLinksListByPrivateCloud200Response
    | CloudLinksListByPrivateCloudDefaultResponse
  >;
...
export interface CloudLinksGet {
  /** Get a CloudLink */
  get(
    options?: CloudLinksGetParameters,
  ): StreamableMethod<CloudLinksGet200Response | CloudLinksGetDefaultResponse>;
  /** Create a CloudLink */
  put(
    options: CloudLinksCreateOrUpdateParameters,
  ): StreamableMethod<
    | CloudLinksCreateOrUpdate200Response
    | CloudLinksCreateOrUpdate201Response
    | CloudLinksCreateOrUpdateDefaultResponse
  ...
  /** Delete a CloudLink */
  delete(
    options?: CloudLinksDeleteParameters,
  ): StreamableMethod<
    | CloudLinksDelete200Response
    | CloudLinksDelete202Response
    | CloudLinksDelete204Response
...
export interface AddonsListByPrivateCloud {
  ...
  get(
    options?: AddonsListByPrivateCloudParameters,
  ): StreamableMethod<
    | AddonsListByPrivateCloud200Response
    | AddonsListByPrivateCloudDefaultResponse
  >;
...
export interface AddonsGet {
  /** Get a Addon */
  get(
    options?: AddonsGetParameters,
  ): StreamableMethod<AddonsGet200Response | AddonsGetDefaultResponse>;
  /** Create a Addon */
  put(
    options: AddonsCreateOrUpdateParameters,
  ): StreamableMethod<
    | AddonsCreateOrUpdate200Response
    | AddonsCreateOrUpdate201Response
    | AddonsCreateOrUpdateDefaultResponse
  ...
  /** Delete a Addon */
  delete(
    options?: AddonsDeleteParameters,
  ): StreamableMethod<
    | AddonsDelete200Response
    | AddonsDelete202Response
    | AddonsDelete204Response
...
export interface VirtualMachinesListByCluster {
  ...
  get(
    options?: VirtualMachinesListByClusterParameters,
  ): StreamableMethod<
    | VirtualMachinesListByCluster200Response
    | VirtualMachinesListByClusterDefaultResponse
  >;
...
export interface VirtualMachinesRestrictMovement {
  ...
  post(
    options: VirtualMachinesRestrictMovementParameters,
  ): StreamableMethod<
    | VirtualMachinesRestrictMovement202Response
    | VirtualMachinesRestrictMovementDefaultResponse
  >;
...
export interface PlacementPoliciesListByCluster {
  ...
  get(
    options?: PlacementPoliciesListByClusterParameters,
  ): StreamableMethod<
    | PlacementPoliciesListByCluster200Response
    | PlacementPoliciesListByClusterDefaultResponse
  >;
...
export interface PlacementPoliciesGet {
  ...
  get(
    options?: PlacementPoliciesGetParameters,
  ): StreamableMethod<
    PlacementPoliciesGet200Response | PlacementPoliciesGetDefaultResponse
  >;
  /** Create a PlacementPolicy */
  put(
    options: PlacementPoliciesCreateOrUpdateParameters,
  ): StreamableMethod<
    | PlacementPoliciesCreateOrUpdate200Response
    | PlacementPoliciesCreateOrUpdate201Response
    | PlacementPoliciesCreateOrUpdateDefaultResponse
  ...
  patch(
    options: PlacementPoliciesUpdateParameters,
  ): StreamableMethod<
    | PlacementPoliciesUpdate200Response
    | PlacementPoliciesUpdate202Response
    | PlacementPoliciesUpdateDefaultResponse
  ...
  delete(
    options?: PlacementPoliciesDeleteParameters,
  ): StreamableMethod<
    | PlacementPoliciesDelete200Response
    | PlacementPoliciesDelete202Response
    | PlacementPoliciesDelete204Response
...
export interface ScriptPackagesListByPrivateCloud {
  ...
  get(
    options?: ScriptPackagesListByPrivateCloudParameters,
  ): StreamableMethod<
    | ScriptPackagesListByPrivateCloud200Response
    | ScriptPackagesListByPrivateCloudDefaultResponse
  >;
...
export interface ScriptPackagesGet {
  /** Get a ScriptPackage */
  get(
    options?: ScriptPackagesGetParameters,
  ): StreamableMethod<
...
export interface ScriptCmdletsListByScriptPackage {
  ...
  get(
    options?: ScriptCmdletsListByScriptPackageParameters,
  ): StreamableMethod<
    | ScriptCmdletsListByScriptPackage200Response
    | ScriptCmdletsListByScriptPackageDefaultResponse
  >;
...
export interface ScriptCmdletsGet {
  /** Get a ScriptCmdlet */
  get(
    options?: ScriptCmdletsGetParameters,
  ): StreamableMethod<
...
export interface ScriptExecutionsListByPrivateCloud {
  ...
  get(
    options?: ScriptExecutionsListByPrivateCloudParameters,
  ): StreamableMethod<
    | ScriptExecutionsListByPrivateCloud200Response
    | ScriptExecutionsListByPrivateCloudDefaultResponse
  >;
...
export interface ScriptExecutionsGet {
  ...
  delete(
    options?: ScriptExecutionsDeleteParameters,
  ): StreamableMethod<
    | ScriptExecutionsDelete200Response
    | ScriptExecutionsDelete202Response
    | ScriptExecutionsDelete204Response
...
export interface ScriptExecutionsGetExecutionLogs {
  ...
  post(
    options?: ScriptExecutionsGetExecutionLogsParameters,
  ): StreamableMethod<
    | ScriptExecutionsGetExecutionLogs200Response
    | ScriptExecutionsGetExecutionLogsDefaultResponse
  >;
...
export interface IscsiPathsListByPrivateCloud {
  ...
  get(
    options?: IscsiPathsListByPrivateCloudParameters,
  ): StreamableMethod<
    | IscsiPathsListByPrivateCloud200Response
    | IscsiPathsListByPrivateCloudDefaultResponse
  >;
...
export interface IscsiPathsGet {
  /** Get a IscsiPath */
  get(
    options?: IscsiPathsGetParameters,
  ): StreamableMethod<IscsiPathsGet200Response | IscsiPathsGetDefaultResponse>;
  /** Create a IscsiPath */
  put(
    options: IscsiPathsCreateOrUpdateParameters,
  ): StreamableMethod<
    | IscsiPathsCreateOrUpdate200Response
    | IscsiPathsCreateOrUpdate201Response
    | IscsiPathsCreateOrUpdateDefaultResponse
  ...
  /** Delete a IscsiPath */
  delete(
    options?: IscsiPathsDeleteParameters,
  ): StreamableMethod<
    | IscsiPathsDelete200Response
    | IscsiPathsDelete202Response
    | IscsiPathsDelete204Response
...
export interface Routes {
  ...
  ): PrivateCloudsListByResourceGroup;
  ...
  (
    ...
    resourceGroupName: string,
    privateCloudName: string,
  ): HcxEnterpriseSitesListByPrivateCloud;
  ...
  (
    ...
    resourceGroupName: string,
    privateCloudName: string,
  ): AuthorizationsListByPrivateCloud;
  ...
  (
    ...
    resourceGroupName: string,
    privateCloudName: string,
  ): GlobalReachConnectionsListByPrivateCloud;
  ...
  (
    ...
    resourceGroupName: string,
    privateCloudName: string,
  ): WorkloadNetworksListByPrivateCloud;
  ...
  (
    ...
    resourceGroupName: string,
    privateCloudName: string,
  ): WorkloadNetworkSegmentsListByWorkloadNetwork;
  ...
  (
    ...
    resourceGroupName: string,
    privateCloudName: string,
  ): WorkloadNetworkDhcpConfigurationsListByWorkloadNetwork;
  ...
  (
    ...
    resourceGroupName: string,
    privateCloudName: string,
  ): WorkloadNetworkGatewaysListByWorkloadNetwork;
  ...
  (
    ...
    resourceGroupName: string,
    privateCloudName: string,
  ): WorkloadNetworkPortMirroringProfilesListByWorkloadNetwork;
  ...
  (
    ...
    resourceGroupName: string,
    privateCloudName: string,
  ): WorkloadNetworkVmGroupsListByWorkloadNetwork;
  ...
  (
    ...
    resourceGroupName: string,
    privateCloudName: string,
  ): WorkloadNetworkVirtualMachinesListByWorkloadNetwork;
  ...
  (
    ...
    resourceGroupName: string,
    privateCloudName: string,
  ): WorkloadNetworkDnsServicesListByWorkloadNetwork;
  ...
  (
    ...
    resourceGroupName: string,
    privateCloudName: string,
  ): WorkloadNetworkDnsZonesListByWorkloadNetwork;
  ...
  (
    ...
    resourceGroupName: string,
    privateCloudName: string,
  ): WorkloadNetworkPublicIpsListByWorkloadNetwork;
  ...
  (
    ...
    privateCloudName: string,
    clusterName: string,
  ): PlacementPoliciesListByCluster;
  ...
  (
    ...
    resourceGroupName: string,
    privateCloudName: string,
  ): ScriptPackagesListByPrivateCloud;
  ...
  (
    ...
    privateCloudName: string,
    scriptPackageName: string,
  ): ScriptCmdletsListByScriptPackage;
  ...
  (
    ...
    resourceGroupName: string,
    privateCloudName: string,
  ): ScriptExecutionsListByPrivateCloud;
