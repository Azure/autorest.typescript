                        ...
                        : {
                            ...
                            keyVaultProperties: !p.properties?.encryption
                                ...
                                : {
                                    ...
                                    keyState: p.properties?.encryption?.keyVaultProperties?.["keyState"],
                                    versionType: p.properties?.encryption?.keyVaultProperties?.["versionType"],
                                },
                        },
    ...
    return context
        ...
        body: {
            ...
            properties: !privateCloud.properties
                ...
                : {
                    managementCluster: {
                        clusterSize: privateCloud.properties?.managementCluster["clusterSize"],
                        hosts: privateCloud.properties?.managementCluster["hosts"],
                        vsanDatastoreName: privateCloud.properties?.managementCluster["vsanDatastoreName"],
                    },
                    internet: privateCloud.properties?.["internet"],
                    identitySources: privateCloud.properties?.["identitySources"] === undefined
                    ...
                    availability: !privateCloud.properties?.availability
                        ? undefined
                        : {
                            strategy: privateCloud.properties?.availability?.["strategy"],
                            zone: privateCloud.properties?.availability?.["zone"],
                            secondaryZone: privateCloud.properties?.availability?.["secondaryZone"],
                        },
                    encryption: !privateCloud.properties?.encryption
                        ...
                        : {
                            ...
                            keyVaultProperties: !privateCloud.properties?.encryption
                                ...
                                ? undefined
                                : {
                                    keyName: privateCloud.properties?.encryption
                                        ?.keyVaultProperties?.["keyName"],
                                    keyVersion: privateCloud.properties?.encryption
                                        ?.keyVaultProperties?.["keyVersion"],
                                    keyVaultUrl: privateCloud.properties?.encryption
                                        ?.keyVaultProperties?.["keyVaultUrl"],
                                },
                        },
                    extendedNetworkBlocks: privateCloud.properties?.["extendedNetworkBlocks"],
            ...
            properties: !privateCloudUpdate.properties
                ...
                : {
                    managementCluster: !privateCloudUpdate.properties
                        ...
                        ? undefined
                        : {
                            clusterSize: privateCloudUpdate.properties?.managementCluster?.["clusterSize"],
                            hosts: privateCloudUpdate.properties?.managementCluster?.["hosts"],
                            vsanDatastoreName: privateCloudUpdate.properties?.managementCluster?.["vsanDatastoreName"],
                        },
                    internet: privateCloudUpdate.properties?.["internet"],
                    identitySources: privateCloudUpdate.properties?.["identitySources"] === undefined
                        ? privateCloudUpdate.properties?.["identitySources"]
                        : privateCloudUpdate.properties?.["identitySources"].map((p) => ({
                            name: p["name"],
                            alias: p["alias"],
                            domain: p["domain"],
                            baseUserDN: p["baseUserDN"],
                    ...
                    availability: !privateCloudUpdate.properties?.availability
                        ? undefined
                        : {
                            strategy: privateCloudUpdate.properties?.availability?.["strategy"],
                            zone: privateCloudUpdate.properties?.availability?.["zone"],
                            secondaryZone: privateCloudUpdate.properties?.availability?.["secondaryZone"],
                        },
                    encryption: !privateCloudUpdate.properties?.encryption
                        ? undefined
                        : {
                            status: privateCloudUpdate.properties?.encryption?.["status"],
                            keyVaultProperties: !privateCloudUpdate.properties
                                ?.encryption?.keyVaultProperties
                                ? undefined
                                : {
                                    keyName: privateCloudUpdate.properties?.encryption
                                        ?.keyVaultProperties?.["keyName"],
                                    keyVersion: privateCloudUpdate.properties?.encryption
                                        ?.keyVaultProperties?.["keyVersion"],
                                    keyVaultUrl: privateCloudUpdate.properties?.encryption
                                        ?.keyVaultProperties?.["keyVaultUrl"],
                                },
                        },
                    extendedNetworkBlocks: privateCloudUpdate.properties?.["extendedNetworkBlocks"],
