...
export type LocationsCheckTrialAvailabilityParameters = LocationsCheckTrialAvailabilityBodyParam & RequestParameters;
...
export type PrivateCloudsCreateOrUpdateParameters = PrivateCloudsCreateOrUpdateBodyParam & RequestParameters;
export interface PrivateCloudsUpdateBodyParam {
    /** The private cloud properties to be updated. */
    body: PrivateCloudUpdate;
}
export type PrivateCloudsUpdateParameters = PrivateCloudsUpdateBodyParam & RequestParameters;
...
export type ClustersCreateOrUpdateParameters = ClustersCreateOrUpdateBodyParam & RequestParameters;
export interface ClustersUpdateBodyParam {
    /** The cluster properties to be updated. */
    body: ClusterUpdate;
}
export type ClustersUpdateParameters = ClustersUpdateBodyParam & RequestParameters;
...
export type DatastoresCreateOrUpdateParameters = DatastoresCreateOrUpdateBodyParam & RequestParameters;
...
export type HcxEnterpriseSitesCreateOrUpdateParameters = HcxEnterpriseSitesCreateOrUpdateBodyParam & RequestParameters;
...
export type AuthorizationsCreateOrUpdateParameters = AuthorizationsCreateOrUpdateBodyParam & RequestParameters;
export type AuthorizationsDeleteParameters = RequestParameters;
export type GlobalReachConnectionsListByPrivateCloudParameters = RequestParameters;
...
export type GlobalReachConnectionsCreateOrUpdateParameters = GlobalReachConnectionsCreateOrUpdateBodyParam & RequestParameters;
...
export type WorkloadNetworkSegmentsListByWorkloadNetworkParameters = RequestParameters;
...
export type WorkloadNetworkDhcpConfigurationsListByWorkloadNetworkParameters = RequestParameters;
...
export type WorkloadNetworkGatewaysListByWorkloadNetworkParameters = RequestParameters;
export type WorkloadNetworkGatewaysGetParameters = RequestParameters;
export type WorkloadNetworkPortMirroringProfilesListByWorkloadNetworkParameters = RequestParameters;
export type WorkloadNetworkPortMirroringProfilesGetParameters = RequestParameters;
...
export type WorkloadNetworkVmGroupsListByWorkloadNetworkParameters = RequestParameters;
...
export type WorkloadNetworkVirtualMachinesListByWorkloadNetworkParameters = RequestParameters;
export type WorkloadNetworkVirtualMachinesGetParameters = RequestParameters;
export type WorkloadNetworkDnsServicesListByWorkloadNetworkParameters = RequestParameters;
...
export type WorkloadNetworkDnsZonesListByWorkloadNetworkParameters = RequestParameters;
...
export type WorkloadNetworkPublicIpsListByWorkloadNetworkParameters = RequestParameters;
...
export type WorkloadNetworkPublicIpsCreateParameters = WorkloadNetworkPublicIpsCreateBodyParam & RequestParameters;
...
export type CloudLinksCreateOrUpdateParameters = CloudLinksCreateOrUpdateBodyParam & RequestParameters;
...
export type AddonsCreateOrUpdateParameters = AddonsCreateOrUpdateBodyParam & RequestParameters;
...
export type VirtualMachinesRestrictMovementParameters = VirtualMachinesRestrictMovementBodyParam & RequestParameters;
...
export type PlacementPoliciesCreateOrUpdateParameters = PlacementPoliciesCreateOrUpdateBodyParam & RequestParameters;
export interface PlacementPoliciesUpdateBodyParam {
    /** The placement policy properties to be updated. */
    body: PlacementPolicyUpdate;
}
export type PlacementPoliciesUpdateParameters = PlacementPoliciesUpdateBodyParam & RequestParameters;
...
export type ScriptExecutionsCreateOrUpdateParameters = ScriptExecutionsCreateOrUpdateBodyParam & RequestParameters;
...
export type ScriptExecutionsGetExecutionLogsParameters = ScriptExecutionsGetExecutionLogsBodyParam & RequestParameters;
...
export type IscsiPathsCreateOrUpdateParameters = IscsiPathsCreateOrUpdateBodyParam & RequestParameters;
