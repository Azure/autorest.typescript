...
import { workloadNetworkPortMirroringPropertiesSerializer, } from "../../models/models.js";
    ...
    return context
        ...
        body: {
            properties: !workloadNetworkPortMirroring.properties
                ...
                : workloadNetworkPortMirroringPropertiesSerializer(workloadNetworkPortMirroring.properties),
        },
    });
}
