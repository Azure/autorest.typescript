...
export function _listByWorkloadNetworkSend(context, subscriptionId, resourceGroupName, privateCloudName, options = {
    ...
    return context
        .path("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AVS/privateClouds/{privateCloudName}/workloadNetworks/default/gateways", subscriptionId, resourceGroupName, privateCloudName)
...
export function _getSend(context, subscriptionId, resourceGroupName, privateCloudName, gatewayId, options = { requestOptions: {} }) {
    return context
        .path("/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AVS/privateClouds/{privateCloudName}/workloadNetworks/default/gateways/{gatewayId}", subscriptionId, resourceGroupName, privateCloudName, gatewayId)
        .get({ ...operationOptionsToRequestParameters(options) });
}
...
export async function get(context, subscriptionId, resourceGroupName, privateCloudName, gatewayId, options = { requestOptions: {} }) {
    const result = await _getSend(context, subscriptionId, resourceGroupName, privateCloudName, gatewayId, options);
