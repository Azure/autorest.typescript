...
export function tenantBackfillStatusResultDeserializer(
  item: any,
...
export function managementGroupDeserializer(item: any): ManagementGroup {
  return {
    ...
    properties: !item["properties"]
      ? item["properties"]
      : managementGroupPropertiesDeserializer(item["properties"]),
  };
}
...
export function managementGroupDetailsDeserializer(
  item: any,
...
export function managementGroupPathElementDeserializer(
  item: any,
...
export function managementGroupChildInfoDeserializer(
  item: any,
...
export function createManagementGroupRequestSerializer(
  ...
  return {
    ...
    properties: !item["properties"]
      ? item["properties"]
      : createManagementGroupPropertiesSerializer(item["properties"]),
  };
}
...
export function createManagementGroupDetailsSerializer(
  item: CreateManagementGroupDetails,
): any {
  return {
    parent: !item["parent"]
      ? item["parent"]
      : createParentGroupInfoSerializer(item["parent"]),
  };
}
...
export function createParentGroupInfoSerializer(
  item: CreateParentGroupInfo,
): any {
  return { id: item["id"] };
}
...
export function patchManagementGroupRequestSerializer(
  item: PatchManagementGroupRequest,
): any {
  return {
    displayName: item["displayName"],
...
export function _descendantListResultDeserializer(
  item: any,
...
export function descendantInfoArrayDeserializer(
  result: Array<DescendantInfo>,
): any[] {
  return result.map((item) => {
...
export function descendantInfoPropertiesDeserializer(
  item: any,
...
export function descendantParentGroupInfoDeserializer(
  item: any,
...
export function _managementGroupListResultDeserializer(
  item: any,
): _ManagementGroupListResult {
  return {
    value: !item["value"]
      ? item["value"]
      : managementGroupInfoArrayDeserializer(item["value"]),
    nextLink: item["@nextLink"],
  };
}

export function managementGroupInfoArrayDeserializer(
  result: Array<ManagementGroupInfo>,
): any[] {
  return result.map((item) => {
...
export function managementGroupInfoDeserializer(
  item: any,
): ManagementGroupInfo {
  return {
    id: item["id"],
    ...
    properties: !item["properties"]
      ? item["properties"]
      : managementGroupInfoPropertiesDeserializer(item["properties"]),
  };
}

/** Lists all hierarchy settings. */
export interface _HierarchySettingsList {
...
export function _hierarchySettingsListDeserializer(
  item: any,
): _HierarchySettingsList {
  return {
    value: !item["value"]
      ? item["value"]
      : hierarchySettingsInfoArrayDeserializer(item["value"]),
    nextLink: item["@nextLink"],
  };
}
...
export function hierarchySettingsInfoDeserializer(
  item: any,
  ...
  return {
    ...
    properties: !item["properties"]
      ? item["properties"]
      : hierarchySettingsPropertiesDeserializer(item["properties"]),
  };
}
...
export function hierarchySettingsPropertiesDeserializer(
  item: any,
): HierarchySettingsProperties {
  return {
    tenantId: item["tenantId"],
    requireAuthorizationForGroupCreation:
      item["requireAuthorizationForGroupCreation"],
...
export function createOrUpdateSettingsRequestSerializer(
  item: CreateOrUpdateSettingsRequest,
): any {
  return {
    properties: !item["properties"]
      ? item["properties"]
      : createOrUpdateSettingsPropertiesSerializer(item["properties"]),
  };
}
...
export function subscriptionUnderManagementGroupDeserializer(
  ...
  return {
    ...
    properties: !item["properties"]
      ? item["properties"]
      : subscriptionUnderManagementGroupPropertiesDeserializer(
          item["properties"],
        ),
  };
}
...
export function entityInfoPropertiesDeserializer(
  item: any,
  ...
  return {
    ...
    parent: !item["parent"]
      ? item["parent"]
      : entityParentGroupInfoDeserializer(item["parent"]),
    ...
    parentDisplayNameChain: !item["parentDisplayNameChain"]
      ...
      : item["parentDisplayNameChain"].map((p: any) => {
          return p;
        }),
    parentNameChain: !item["parentNameChain"]
      ? item["parentNameChain"]
      : item["parentNameChain"].map((p: any) => {
          return p;
        }),
  };
}
...
export function entityParentGroupInfoDeserializer(
  item: any,
