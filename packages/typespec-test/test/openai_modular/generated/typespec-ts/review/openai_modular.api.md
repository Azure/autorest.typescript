...
export class OpenAIClient {
  ...
  getAudioSpeech(
    ...
    options?: GetAudioSpeechOptions
  ): Promise<Uint8Array>;
  getAudioTranscriptionAsPlainText(
    deploymentId: string,
    body: AudioTranscriptionOptions,
    options?: GetAudioTranscriptionAsPlainTextOptions
  ): Promise<string>;
  ...
  getAudioTranslationAsPlainText(
    ...
    options?: GetAudioTranslationAsPlainTextOptions
  ): Promise<string>;
  ...
  getImageGenerations(
    ...
    options?: GetImageGenerationsOptions
