...
import { _beginAzureBatchImageGenerationDeserialize } from "./api/operations.js";
...
const deserializeMap: Record<string, Function> = {
  "POST /images/generations:submit": _beginAzureBatchImageGenerationDeserialize,
};
...
export function restorePoller<TResponse extends PathUncheckedResponse, TResult>(
  client: OpenAIContext | OpenAIClient,
