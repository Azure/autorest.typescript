...
import { CodeSigningClient } from "./clientDefinitions.js";
...
export default function createClient(
  ...
  options.apiVersion = options.apiVersion ?? "2024-02-05-preview";
  const userAgentInfo = `azsdk-js-arm-code-signing-rest/1.0.0-beta.1`;
