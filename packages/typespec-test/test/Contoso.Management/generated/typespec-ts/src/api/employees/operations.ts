...
export function _listBySubscriptionSend(
  ...
  const path = expandUrlTemplate(
    "/subscriptions/{subscriptionId}/providers/Microsoft.Contoso/employees{?api%2Dversion}",
    {
...
export function _listByResourceGroupSend(
  ...
  const path = expandUrlTemplate(
    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Contoso/employees{?api%2Dversion}",
    {
      subscriptionId: context.subscriptionId,
...
export function _$deleteSend(
  ...
  const path = expandUrlTemplate(
    "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Contoso/employees/{employeeName}{?api%2Dversion}",
    {
      subscriptionId: context.subscriptionId,
      resourceGroupName: resourceGroupName,
