...
export async function listConfigurations(
  ...
  const result = await _listConfigurationsSend(
    context,
    resourceUri,
    linkerName,
    options,
...
> {
  return getLongRunningPoller(context, _validateDeserialize, ["202", "200"], {
    ...
    getInitialResponse: () =>
      _validateSend(context, resourceUri, linkerName, options),
...
export function $delete(
  ...
  return getLongRunningPoller(
    ...
    ["200", "202", "204"],
    {
      ...
      abortSignal: options?.abortSignal,
      getInitialResponse: () =>
        _$deleteSend(context, resourceUri, linkerName, options),
...
export function update(
  ...
  return getLongRunningPoller(
    ...
    ["200", "201", "202"],
    {
      ...
      abortSignal: options?.abortSignal,
      getInitialResponse: () =>
        _updateSend(context, resourceUri, linkerName, parameters, options),
      resourceLocationConfig: "azure-async-operation",
    },
