...
import {
  ...
  _updateDryrunDeserialize,
  _createDryrunDeserialize,
} from "./api/connector/operations.js";
import {
  _validateDeserialize as _validateDeserializeLinker,
  _$deleteDeserialize as _$deleteDeserializeLinker,
  _updateDeserialize as _updateDeserializeLinker,
  _createOrUpdateDeserialize as _createOrUpdateDeserializeLinker,
} from "./api/linker/operations.js";
import {
  _updateDryrunDeserialize as _updateDryrunDeserializeLinkers,
  _createDryrunDeserialize as _createDryrunDeserializeLinkers,
...
const deserializeMap: Record<string, DeserializationHelper> = {
  "POST /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceLinker/locations/{location}/connectors/{connectorName}/validate":
    { deserializer: _validateDeserialize, expectedStatuses: ["202", "200"] },
  ...
  "PATCH /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceLinker/locations/{location}/dryruns/{dryrunName}":
    {
      deserializer: _updateDryrunDeserialize,
