...
export function dryrunPropertiesDeserializer(item: any): DryrunProperties {
  return {
    ...
    prerequisiteResults: !item["prerequisiteResults"]
      ...
      : dryrunPrerequisiteResultUnionArrayDeserializer(
          item["prerequisiteResults"],
        ),
...
export function dryrunParametersUnionSerializer(
  item: DryrunParametersUnion,
): any {
  switch (item.actionName) {
    case "createOrUpdate":
      return createOrUpdateDryrunParametersSerializer(
        item as CreateOrUpdateDryrunParameters,
      );
...
export function dryrunParametersUnionDeserializer(
  item: any,
): DryrunParametersUnion {
  switch (item.actionName) {
    case "createOrUpdate":
      return createOrUpdateDryrunParametersDeserializer(
        item as CreateOrUpdateDryrunParameters,
      );
...
export function createOrUpdateDryrunParametersSerializer(
  ...
  return {
    ...
    authInfo: !item["authInfo"]
      ? item["authInfo"]
      : authInfoBaseUnionSerializer(item["authInfo"]),
...
export function targetServiceBaseUnionSerializer(
  item: TargetServiceBaseUnion,
): any {
  switch (item.type) {
    case "AzureResource":
    ...
    case "ConfluentBootstrapServer":
      return confluentBootstrapServerSerializer(
        item as ConfluentBootstrapServer,
      );
...
export function targetServiceBaseUnionDeserializer(
  item: any,
  ...
  switch (item.type) {
    ...
    case "ConfluentBootstrapServer":
      return confluentBootstrapServerDeserializer(
        item as ConfluentBootstrapServer,
      );
    ...
    case "ConfluentSchemaRegistry":
      return confluentSchemaRegistryDeserializer(
        item as ConfluentSchemaRegistry,
      );
...
export function azureResourceDeserializer(item: any): AzureResource {
  return {
    ...
    resourceProperties: !item["resourceProperties"]
      ? item["resourceProperties"]
      : azureResourcePropertiesBaseUnionDeserializer(
          item["resourceProperties"],
        ),
  };
}
...
export function azureResourcePropertiesBaseSerializer(
  item: AzureResourcePropertiesBase,
): any {
  return { type: item["type"] };
}

export function azureResourcePropertiesBaseDeserializer(
  item: any,
...
export function azureResourcePropertiesBaseUnionSerializer(
  ...
  switch (item.type) {
    ...
    case "AppConfig":
      return azureAppConfigPropertiesSerializer(
        item as AzureAppConfigProperties,
      );
...
export function azureResourcePropertiesBaseUnionDeserializer(
  ...
  switch (item.type) {
    case "KeyVault":
      return azureKeyVaultPropertiesDeserializer(
        item as AzureKeyVaultProperties,
      );

    case "AppConfig":
      return azureAppConfigPropertiesDeserializer(
        item as AzureAppConfigProperties,
      );
...
export function azureKeyVaultPropertiesSerializer(
  item: AzureKeyVaultProperties,
): any {
  return {
    type: item["type"],
...
export function azureKeyVaultPropertiesDeserializer(
  item: any,
): AzureKeyVaultProperties {
  return {
    type: item["type"],
...
export function azureAppConfigPropertiesSerializer(
  item: AzureAppConfigProperties,
): any {
  return {
    type: item["type"],
...
export function azureAppConfigPropertiesDeserializer(
  item: any,
): AzureAppConfigProperties {
  return {
    type: item["type"],
...
export function confluentBootstrapServerSerializer(
  item: ConfluentBootstrapServer,
): any {
  return { type: item["type"], endpoint: item["endpoint"] };
}

export function confluentBootstrapServerDeserializer(
  item: any,
): ConfluentBootstrapServer {
  return {
    type: item["type"],
...
export function confluentSchemaRegistrySerializer(
  item: ConfluentSchemaRegistry,
): any {
  return { type: item["type"], endpoint: item["endpoint"] };
}

export function confluentSchemaRegistryDeserializer(
  item: any,
): ConfluentSchemaRegistry {
  return {
    type: item["type"],
...
export function authInfoBaseUnionSerializer(item: AuthInfoBaseUnion): any {
  switch (item.authType) {
    ...
    case "userAssignedIdentity":
      return userAssignedIdentityAuthInfoSerializer(
        item as UserAssignedIdentityAuthInfo,
      );

    case "systemAssignedIdentity":
      return systemAssignedIdentityAuthInfoSerializer(
        item as SystemAssignedIdentityAuthInfo,
      );

    case "servicePrincipalSecret":
      return servicePrincipalSecretAuthInfoSerializer(
        item as ServicePrincipalSecretAuthInfo,
      );
    ...
    case "easyAuthMicrosoftEntraID":
      return easyAuthMicrosoftEntraIDAuthInfoSerializer(
        item as EasyAuthMicrosoftEntraIDAuthInfo,
      );
...
export function authInfoBaseUnionDeserializer(item: any): AuthInfoBaseUnion {
  switch (item.authType) {
    ...
    case "userAssignedIdentity":
      return userAssignedIdentityAuthInfoDeserializer(
        item as UserAssignedIdentityAuthInfo,
      );

    case "systemAssignedIdentity":
      return systemAssignedIdentityAuthInfoDeserializer(
        item as SystemAssignedIdentityAuthInfo,
      );

    case "servicePrincipalSecret":
      return servicePrincipalSecretAuthInfoDeserializer(
        item as ServicePrincipalSecretAuthInfo,
      );
    ...
    case "easyAuthMicrosoftEntraID":
      return easyAuthMicrosoftEntraIDAuthInfoDeserializer(
        item as EasyAuthMicrosoftEntraIDAuthInfo,
      );
...
export function secretInfoBaseUnionSerializer(item: SecretInfoBaseUnion): any {
  switch (item.secretType) {
    ...
    case "keyVaultSecretReference":
      return keyVaultSecretReferenceSecretInfoSerializer(
        item as KeyVaultSecretReferenceSecretInfo,
      );

    case "keyVaultSecretUri":
      return keyVaultSecretUriSecretInfoSerializer(
        item as KeyVaultSecretUriSecretInfo,
      );
...
export function secretInfoBaseUnionDeserializer(
  item: any,
): SecretInfoBaseUnion {
  switch (item.secretType) {
    case "rawValue":
    ...
    case "keyVaultSecretUri":
      return keyVaultSecretUriSecretInfoDeserializer(
        item as KeyVaultSecretUriSecretInfo,
      );
...
export function keyVaultSecretUriSecretInfoSerializer(
  item: KeyVaultSecretUriSecretInfo,
): any {
  return { secretType: item["secretType"], value: item["value"] };
}

export function keyVaultSecretUriSecretInfoDeserializer(
  item: any,
): KeyVaultSecretUriSecretInfo {
  return {
    secretType: item["secretType"],
...
export function userAssignedIdentityAuthInfoSerializer(
  item: UserAssignedIdentityAuthInfo,
): any {
  return {
    authType: item["authType"],
    authMode: item["authMode"],
...
export function userAssignedIdentityAuthInfoDeserializer(
  item: any,
): UserAssignedIdentityAuthInfo {
  return {
    authType: item["authType"],
...
export function userAccountAuthInfoDeserializer(
  item: any,
): UserAccountAuthInfo {
  return {
    authType: item["authType"],
...
export function publicNetworkSolutionSerializer(
  item: PublicNetworkSolution,
): any {
  return {
    deleteOrUpdateBehavior: item["deleteOrUpdateBehavior"],
...
export function publicNetworkSolutionDeserializer(
  item: any,
...
export function configurationInfoSerializer(item: ConfigurationInfo): any {
  return {
    ...
    additionalConnectionStringProperties:
      item["additionalConnectionStringProperties"],
...
export function daprPropertiesSerializer(item: DaprProperties): any {
  return {
    ...
    metadata: !item["metadata"]
      ? item["metadata"]
      : daprMetadataArraySerializer(item["metadata"]),
    scopes: !item["scopes"]
      ? item["scopes"]
...
export function daprMetadataArraySerializer(
  result: Array<DaprMetadata>,
): any[] {
  return result.map((item) => {
...
export function daprMetadataArrayDeserializer(
  result: Array<DaprMetadata>,
): any[] {
  return result.map((item) => {
...
export function dryrunPrerequisiteResultDeserializer(
  item: any,
...
export function dryrunOperationPreviewDeserializer(
  item: any,
...
export function _dryrunListDeserializer(item: any): _DryrunList {
  return {
    value: !item["value"]
      ? item["value"]
      : dryrunResourceArrayDeserializer(item["value"]),
    nextLink: item["nextLink"],
  };
}

export function dryrunResourceArraySerializer(
  result: Array<DryrunResource>,
): any[] {
  return result.map((item) => {
...
export function dryrunResourceArrayDeserializer(
  result: Array<DryrunResource>,
): any[] {
  return result.map((item) => {
...
export function configurationResultDeserializer(
  item: any,
): ConfigurationResult {
  return {
...
export function sourceConfigurationArrayDeserializer(
  result: Array<SourceConfiguration>,
): any[] {
  return result.map((item) => {
...
export function sourceConfigurationDeserializer(
  item: any,
): SourceConfiguration {
  return {
    name: item["name"],
...
export function _daprConfigurationListDeserializer(
  item: any,
...
export function daprConfigurationResourceDeserializer(
  item: any,
...
export function daprConfigurationPropertiesDeserializer(
  item: any,
...
export function _resourceListDeserializer(item: any): _ResourceList {
  return {
    value: !item["value"]
      ? item["value"]
      : linkerResourceArrayDeserializer(item["value"]),
    nextLink: item["nextLink"],
  };
}

export function linkerResourceArraySerializer(
  result: Array<LinkerResource>,
): any[] {
  return result.map((item) => {
...
export function linkerResourceArrayDeserializer(
  result: Array<LinkerResource>,
): any[] {
  return result.map((item) => {
...
export function validateOperationResultDeserializer(
  item: any,
...
export function validationResultItemArrayDeserializer(
  result: Array<ValidationResultItem>,
): any[] {
  return result.map((item) => {
...
export function validationResultItemDeserializer(
  item: any,
...
export function _configurationNameResultDeserializer(
  item: any,
...
export function configurationNameItemDeserializer(
  item: any,
...
export function configurationNamesDeserializer(item: any): ConfigurationNames {
  return {
    ...
    names: !item["names"]
      ? item["names"]
      : configurationNameArrayDeserializer(item["names"]),
  };
}
...
export function configurationNameArrayDeserializer(
  result: Array<ConfigurationName>,
): any[] {
  return result.map((item) => {
