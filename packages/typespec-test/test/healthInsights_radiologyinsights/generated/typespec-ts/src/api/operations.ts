                    ...
                    : p.info?.["clinicalInfo"].map((p) => ({
                        ...
                        meta: !p.meta
                          ...
                          : {
                              ...
                              security:
                                p.meta?.["security"] === undefined
                                  ? p.meta?.["security"]
                                  : p.meta?.["security"].map((p) => ({
                                      id: p["id"],
                                      extension:
                                                            ...
                                                            : {
                                                                ...
                                                                coding:
                                                                  ...
                                                                  undefined
                                                                    ...
                                                                    : p.valueReference?.identifier?.type?.[
                                                                        "coding"
                                                                      ].map(
                                                                        (
                                                                          p,
                        ...
                        implicitRules: p["implicitRules"],
                        language: p["language"],
                      })),
              },
          encounters:
            p["encounters"] === undefined
              ? p["encounters"]
              : p["encounters"].map((p) => ({
                  id: p["id"],
                  period: !p.period
                                    ...
                                    : p["extension"].map((p) => ({
                                        ...
                                        valueQuantity: !p.valueQuantity
                                          ...
                                          : {
                                              ...
                                              comparator:
                                                p.valueQuantity?.["comparator"],
                                              unit: p.valueQuantity?.["unit"],
                                              system:
                                                p.valueQuantity?.["system"],
                                        ...
                                        valueSampledData: !p.valueSampledData
                                          ...
                                          : {
                                              ...
                                              period:
                                                p.valueSampledData?.["period"],
                                              factor:
                                                p.valueSampledData?.["factor"],
                                              lowerLimit:
                                                p.valueSampledData?.[
                                                  "lowerLimit"
                                                ],
