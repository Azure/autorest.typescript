...
| `--module-kind`                 | Allows controlling between CommonJS and ESM style imports and exports. Accepted values: `esm`, `cjs`. Defaults to `esm` for backwards compatibility. ESM style imports and exports will include the file extension and avoid directory imports.                                                                                                                                                                                                                                                                                                                         
## Contributing
