# MultipleInheritanceRest REST client library for JavaScript
...
Install the MultipleInheritanceRest REST client REST client library for JavaScript with `npm`:

```bash
npm install @msinternal/multiple-inheritance-rest
```
