...
/** Get complex types with datetimeRfc1123 properties */
export interface PrimitiveGetDateTimeRfc1123DefaultResponse extends HttpResponse {
  status: string;
  body: ErrorModelOutput;
}
...
/** Put complex types with datetimeRfc1123 properties */
export interface PrimitivePutDateTimeRfc1123DefaultResponse extends HttpResponse {
  status: string;
  body: ErrorModelOutput;
}
...
export interface PolymorphismGetComposedWithDiscriminator200Response extends HttpResponse {
  status: "200";
  body: DotFishMarketOutput;
}

/** Get complex object composing a polymorphic scalar property and array property with polymorphic element type, with discriminator specified. Deserialization must NOT fail and use the discriminator type specified on the wire. */
export interface PolymorphismGetComposedWithDiscriminatorDefaultResponse extends HttpResponse {
  status: string;
  body: ErrorModelOutput;
}
...
export interface PolymorphismGetComposedWithoutDiscriminator200Response extends HttpResponse {
  status: "200";
  body: DotFishMarketOutput;
}

/** Get complex object composing a polymorphic scalar property and array property with polymorphic element type, without discriminator specified on wire. Deserialization must NOT fail and use the explicit type of the property. */
export interface PolymorphismGetComposedWithoutDiscriminatorDefaultResponse extends HttpResponse {
  status: string;
  body: ErrorModelOutput;
}
...
/** Get complex types that are polymorphic, but not at the root of the hierarchy; also have additional properties */
export interface PolymorphismGetComplicatedDefaultResponse extends HttpResponse {
  status: string;
  body: ErrorModelOutput;
}
...
/** Put complex types that are polymorphic, but not at the root of the hierarchy; also have additional properties */
export interface PolymorphismPutComplicatedDefaultResponse extends HttpResponse {
  status: string;
  body: ErrorModelOutput;
}

/** Put complex types that are polymorphic, omitting the discriminator */
export interface PolymorphismPutMissingDiscriminator200Response extends HttpResponse {
  status: "200";
  body: SalmonOutput;
}

/** Put complex types that are polymorphic, omitting the discriminator */
export interface PolymorphismPutMissingDiscriminatorDefaultResponse extends HttpResponse {
  status: string;
  body: ErrorModelOutput;
}

/** Put complex types that are polymorphic, attempting to omit required 'birthday' field - the request should not be allowed from the client */
export interface PolymorphismPutValidMissingRequired200Response extends HttpResponse {
  status: "200";
}

/** Put complex types that are polymorphic, attempting to omit required 'birthday' field - the request should not be allowed from the client */
export interface PolymorphismPutValidMissingRequiredDefaultResponse extends HttpResponse {
  status: string;
  body: ErrorModelOutput;
}
...
/** Get complex types that are polymorphic and have recursive references */
export interface PolymorphicrecursiveGetValidDefaultResponse extends HttpResponse {
  status: string;
  body: ErrorModelOutput;
}
...
/** Put complex types that are polymorphic and have recursive references */
export interface PolymorphicrecursivePutValidDefaultResponse extends HttpResponse {
  status: string;
  body: ErrorModelOutput;
}
