...
export interface AmazonRdsForSqlServerLinkedService extends LinkedServiceParent {
...
export interface CommonDataServiceForAppsLinkedService extends LinkedServiceParent {
...
export interface WebAnonymousAuthentication extends WebLinkedServiceTypePropertiesParent {
  authenticationType: "Anonymous";
}

/** A WebLinkedService that uses basic authentication to communicate with an HTTP endpoint. */
export interface WebBasicAuthentication extends WebLinkedServiceTypePropertiesParent {
  /** User name for Basic authentication. Type: string (or Expression with resultType string). */
  username: any;
...
export interface WebClientCertificateAuthentication extends WebLinkedServiceTypePropertiesParent {
...
export interface SalesforceServiceCloudLinkedService extends LinkedServiceParent {
...
export interface SalesforceMarketingCloudLinkedService extends LinkedServiceParent {
...
export interface AzureDataLakeAnalyticsLinkedService extends LinkedServiceParent {
...
export interface AzureDatabricksDeltaLakeLinkedService extends LinkedServiceParent {
...
export interface AzureDataLakeStoreReadSettings extends StoreReadSettingsParent {
  /** If true, files under the folder path will be read recursively. Default is true. Type: boolean (or Expression with resultType boolean). */
  recursive?: any;
...
export interface GoogleCloudStorageReadSettings extends StoreReadSettingsParent {
  /** If true, files under the folder path will be read recursively. Default is true. Type: boolean (or Expression with resultType boolean). */
  recursive?: any;
...
export interface AzureBlobStorageWriteSettings extends StoreWriteSettingsParent {
...
export interface AzureDataLakeStoreWriteSettings extends StoreWriteSettingsParent {
...
export interface AzureFileStorageWriteSettings extends StoreWriteSettingsParent {
...
export interface RedirectIncompatibleRowSettings extends Record<
  string,
  unknown
> {
...
/** Cursor methods for Mongodb query */
export interface MongoDbCursorMethodsProperties extends Record<
  string,
  unknown
> {
...
export interface AzureDatabricksDeltaLakeExportCommand extends ExportSettingsParent {
...
export interface AzureDatabricksDeltaLakeImportCommand extends ImportSettingsParent {
...
export interface SqlServerStoredProcedureActivity extends ExecutionActivityParent {
...
export interface AzureDataExplorerCommandActivity extends ExecutionActivityParent {
...
export interface AzureMLExecutePipelineActivity extends ExecutionActivityParent {
...
export interface SynapseSparkJobDefinitionActivity extends ExecutionActivityParent {
...
export interface TriggerDependencyReferenceParent extends DependencyReferenceParent {
  /** Referenced trigger. */
...
export interface TumblingWindowTriggerDependencyReference extends TriggerDependencyReferenceParent {
...
export interface SelfDependencyTumblingWindowTriggerReference extends DependencyReferenceParent {
  /** Timespan applied to the start time of a tumbling window when evaluating dependency. */
  offset: string;
  /** The size of the window when evaluating the dependency. If undefined the frequency of the tumbling window will be used. */
  size?: string;
...
export interface IntegrationRuntimeComputeProperties extends Record<
  string,
  unknown
> {
...
/** Data flow properties for managed integration runtime. */
export interface IntegrationRuntimeDataFlowProperties extends Record<
  string,
  unknown
> {
  /** Compute type of the cluster which will execute data flow job. */
...
/** VNet properties for managed integration runtime. */
export interface IntegrationRuntimeVNetProperties extends Record<
  string,
  unknown
> {
...
/** SSIS properties for managed integration runtime. */
export interface IntegrationRuntimeSsisProperties extends Record<
  string,
  unknown
> {
...
/** Catalog information for managed dedicated integration runtime. */
export interface IntegrationRuntimeSsisCatalogInfo extends Record<
  string,
  unknown
> {
...
export interface LinkedIntegrationRuntimeKeyAuthorization extends LinkedIntegrationRuntimeTypeParent {
...
export interface LinkedIntegrationRuntimeRbacAuthorization extends LinkedIntegrationRuntimeTypeParent {
