...
import {
  ...
  MultivariateGetBatchDetectionResultParameters,
...
import {
  ...
  MultivariateGetBatchDetectionResult200Response,
...
export interface MultivariateGetBatchDetectionResult {
  /**
   * For asynchronous inference, get multivariate anomaly detection result based on
   * resultId returned by the BatchDetectAnomaly api.
   */
  get(
    options?: MultivariateGetBatchDetectionResultParameters
  ): StreamableMethod<
    | MultivariateGetBatchDetectionResult200Response
    | MultivariateGetBatchDetectionResultDefaultResponse
  >;
...
export interface Routes {
  ...
  ): UnivariateDetectUnivariateChangePoint;
  ...
  (
    ...
    resultId: string
  ): MultivariateGetBatchDetectionResult;
  ...
  (
    ...
    modelId: string
  ): MultivariateDeleteMultivariateModel;
