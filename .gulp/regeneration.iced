...
tsTasks = ['regenerate-tscomposite', 'regenerate-tsxml', 'regenerate-ts-enum-union', 'regenerate-ts-metadata', 'regenerate-ts-no-client-validation', 'regenerate-ts-date-as-string']
