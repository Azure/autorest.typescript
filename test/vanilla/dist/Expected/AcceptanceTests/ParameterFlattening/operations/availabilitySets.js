...
class AvailabilitySets {
    ...
    update(resourceGroupName, avset, tags, options, callback) {
        ...
        let cb = callback;
        if (!callback) {
            return this.updateWithHttpOperationResponse(resourceGroupName, avset, tags, options).then((operationRes) => {
            ...
            msRest.promiseToCallback(this.updateWithHttpOperationResponse(resourceGroupName, avset, tags, options))((err, data) => {
                if (err) {
                    return cb(err);
                }
