...
class ByteModel {
    ...
    getNonAscii(options, callback) {
        ...
        let cb = callback;
        if (!callback) {
            return this.getNonAsciiWithHttpOperationResponse(options).then((operationRes) => {
                return Promise.resolve(operationRes.bodyAsJson);
            }).catch((err) => {
                return Promise.reject(err);
            });
            ...
            msRest.promiseToCallback(this.getNonAsciiWithHttpOperationResponse(options))((err, data) => {
                if (err) {
                    return cb(err);
                }
                let result = data.bodyAsJson;
    ...
    putNonAscii(byteBody, options, callback) {
        if (!callback && typeof options === 'function') {
            callback = options;
            options = undefined;
        }
        let cb = callback;
        if (!callback) {
            return this.putNonAsciiWithHttpOperationResponse(byteBody, options).then((operationRes) => {
                return Promise.resolve(operationRes.bodyAsJson);
            }).catch((err) => {
                return Promise.reject(err);
            });
            ...
            msRest.promiseToCallback(this.putNonAsciiWithHttpOperationResponse(byteBody, options))((err, data) => {
                if (err) {
                    return cb(err);
                }
                let result = data.bodyAsJson;
...
exports.ByteModel = ByteModel;
//# sourceMappingURL=byteModel.js.map