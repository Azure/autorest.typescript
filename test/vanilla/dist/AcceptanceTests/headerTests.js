...
const autoRestSwaggerBATHeaderService_1 = require("../Expected/AcceptanceTests/Header/autoRestSwaggerBATHeaderService");
...
describe('typescript', function () {
    describe('Swagger Header BAT', function () {
        describe('Basic Header Operations', function () {
            var testClient = new autoRestSwaggerBATHeaderService_1.AutoRestSwaggerBATHeaderService(baseUri, clientOptions);
