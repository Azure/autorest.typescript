...
const autoRestSwaggerBATService_1 = require("../Expected/AcceptanceTests/BodyString/autoRestSwaggerBATService");
const autoRestIntegerTestService_1 = require("../Expected/AcceptanceTests/BodyInteger/autoRestIntegerTestService");
const compositeBoolInt_1 = require("../Expected/AcceptanceTests/CompositeBoolIntClient/compositeBoolInt");
const autoRestNumberTestService_1 = require("../Expected/AcceptanceTests/BodyNumber/autoRestNumberTestService");
const autoRestSwaggerBATByteService_1 = require("../Expected/AcceptanceTests/BodyByte/autoRestSwaggerBATByteService");
const autoRestDateTestService_1 = require("../Expected/AcceptanceTests/BodyDate/autoRestDateTestService");
const autoRestDateTimeTestService_1 = require("../Expected/AcceptanceTests/BodyDateTime/autoRestDateTimeTestService");
const autoRestRFC1123DateTimeTestService_1 = require("../Expected/AcceptanceTests/BodyDateTimeRfc1123/autoRestRFC1123DateTimeTestService");
const autoRestDurationTestService_1 = require("../Expected/AcceptanceTests/BodyDuration/autoRestDurationTestService");
const autoRestUrlTestService_1 = require("../Expected/AcceptanceTests/Url/autoRestUrlTestService");
const autoRestSwaggerBATFileService_1 = require("../Expected/AcceptanceTests/BodyFile/autoRestSwaggerBATFileService");
const autoRestSwaggerBATArrayService_1 = require("../Expected/AcceptanceTests/BodyArray/autoRestSwaggerBATArrayService");
const autoRestSwaggerBATdictionaryService_1 = require("../Expected/AcceptanceTests/BodyDictionary/autoRestSwaggerBATdictionaryService");
const autoRestHttpInfrastructureTestService_1 = require("../Expected/AcceptanceTests/Http/autoRestHttpInfrastructureTestService");
const autoRestSwaggerBATFormDataService_1 = require("../Expected/AcceptanceTests/BodyFormData/autoRestSwaggerBATFormDataService");
...
const autoRestParameterizedCustomHostTestClient_1 = require("../Expected/AcceptanceTests/CustomBaseUriMoreOptions/autoRestParameterizedCustomHostTestClient");
// TODO: Check types
...
var readStreamCountBytes = function (stream, callback) {
    var bytesRead = 0;
...
describe('typescript', function () {
    describe('Swagger BAT', function () {
        describe('Custom BaseUri Client', function () {
            ...
            var testClient = new autoRestParameterizedHostTestClient_1.AutoRestParameterizedHostTestClient(customOptions);
        ...
        describe('Custom BaseUri Client with more options', function () {
            ...
            var testClient = new autoRestParameterizedCustomHostTestClient_1.AutoRestParameterizedCustomHostTestClient('test12', customOptions);
            it('should return 200', function (done) {
        ...
        describe('Bool Client', function () {
            var testClient = new autoRestBoolTestService_1.AutoRestBoolTestService(baseUri, clientOptions);
        ...
        describe('Integer Client', function () {
            var testClient = new autoRestIntegerTestService_1.AutoRestIntegerTestService(baseUri, clientOptions);
        ...
        describe('CompositeBoolInt Client', function () {
            var testClient = new compositeBoolInt_1.CompositeBoolInt(baseUri, clientOptions);
            it('should get valid boolean values', function (done) {
                testClient.bool.getTrue(function (error, result) {
                    should.not.exist(error);
                    result.should.equal(true);
        ...
        describe('Number Client', function () {
            var testClient = new autoRestNumberTestService_1.AutoRestNumberTestService(baseUri, clientOptions);
        ...
        describe('String Client', function () {
            var testClient = new autoRestSwaggerBATService_1.AutoRestSwaggerBATService(baseUri, clientOptions);
        ...
        describe('Byte Client', function () {
            var testClient = new autoRestSwaggerBATByteService_1.AutoRestSwaggerBATByteService(baseUri, clientOptions);
        ...
        describe('Date Client', function () {
            var testClient = new autoRestDateTestService_1.AutoRestDateTestService(baseUri, clientOptions);
        ...
        describe('DateTime Client', function () {
            var testClient = new autoRestDateTimeTestService_1.AutoRestDateTimeTestService(baseUri, clientOptions);
        ...
        describe('DateTimeRfc1123 Client', function () {
            var testClient = new autoRestRFC1123DateTimeTestService_1.AutoRestRFC1123DateTimeTestService(baseUri, clientOptions);
        ...
        describe('Duration Client', function () {
            var testClient = new autoRestDurationTestService_1.AutoRestDurationTestService(baseUri, clientOptions);
        ...
        describe('Array Client', function () {
            describe('for primitive types', function () {
                var testClient = new autoRestSwaggerBATArrayService_1.AutoRestSwaggerBATArrayService(baseUri, clientOptions);
        ...
        describe('Dictionary Client', function () {
            describe('for primitive types', function () {
                ...
                it('should get base64url dictionaries', function (done) {
                    ...
                    var base64Url2 = new Buffer('test string', 'utf8');
                    var base64Url3 = new Buffer('Lorem ipsum', 'utf8');
                    var dict = { "0": base64Url1, "1": base64Url2, "2": base64Url3 };
        ...
        describe('Files Client', function () {
            var testClient = new autoRestSwaggerBATFileService_1.AutoRestSwaggerBATFileService(baseUri, clientOptions);
        ...
        describe('Form Data Client', function () {
            var testClient = new autoRestSwaggerBATFormDataService_1.AutoRestSwaggerBATFormDataService(baseUri, clientOptions);
        ...
        describe('Url Client', function () {
            var testClient = new autoRestUrlTestService_1.AutoRestUrlTestService('globalStringPath', baseUri, clientOptions);
        ...
        describe('Http infrastructure Client', function () {
            ...
            var testClient = new autoRestHttpInfrastructureTestService_1.AutoRestHttpInfrastructureTestService(baseUri, testOptions);
