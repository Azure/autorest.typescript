...
const autoRestValidationTest_1 = require("../Expected/AcceptanceTests/Validation/autoRestValidationTest");
...
describe('typescript', function () {
    describe('Swagger BAT Validation', function () {
        var testClient = new autoRestValidationTest_1.AutoRestValidationTest("abc123", "12-34-5678", baseUri, clientOptions);
        describe('Of Method Parameters', function () {
            ...
            it('should test the pattern constraint on apiVersion', function (done) {
                var testClient2 = new autoRestValidationTest_1.AutoRestValidationTest("abc123", "12345", baseUri, clientOptions);
