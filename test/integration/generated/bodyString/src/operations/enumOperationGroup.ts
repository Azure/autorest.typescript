...
import {
  EnumOperationGroupGetNotExpandableResponse,
  Colors,
  EnumOperationGroupGetReferencedResponse,
  EnumOperationGroupGetReferencedConstantResponse,
  RefColorConstant
} from "../models";

/**
 * Class representing a EnumOperationGroup.
 */
export class EnumOperationGroup {
  private readonly client: BodyStringClient;

  /**
   * Initialize a new instance of the class EnumOperationGroup class.
  ...
  getNotExpandable(
  ...
  ): Promise<EnumOperationGroupGetNotExpandableResponse> {
    ...
    ) as Promise<EnumOperationGroupGetNotExpandableResponse>;
  }
  ...
  getReferenced(
    options?: coreHttp.OperationOptions
  ): Promise<EnumOperationGroupGetReferencedResponse> {
    const operationOptions: coreHttp.RequestOptionsBase = coreHttp.operationOptionsToRequestOptionsBase(
      options || {}
    );
    return this.client.sendOperationRequest(
    ...
    ) as Promise<EnumOperationGroupGetReferencedResponse>;
  }
  ...
  getReferencedConstant(
    options?: coreHttp.OperationOptions
  ): Promise<EnumOperationGroupGetReferencedConstantResponse> {
    const operationOptions: coreHttp.RequestOptionsBase = coreHttp.operationOptionsToRequestOptionsBase(
      options || {}
    );
    return this.client.sendOperationRequest(
    ...
    ) as Promise<EnumOperationGroupGetReferencedConstantResponse>;
  }
