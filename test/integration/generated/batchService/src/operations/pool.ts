...
export class Pool {
  ...
  patch(
    ...
    return this.client.sendOperationRequest(
      { poolPatchParameter, poolId, options },
      patchOperationSpec
  ...
  enableAutoScale(
    ...
    return this.client.sendOperationRequest(
      { poolEnableAutoScaleParameter, poolId, options },
  ...
  evaluateAutoScale(
    ...
    return this.client.sendOperationRequest(
      { poolEvaluateAutoScaleParameter, poolId, options },
  ...
  resize(
    ...
    return this.client.sendOperationRequest(
      { poolResizeParameter, poolId, options },
      resizeOperationSpec
  ...
  removeNodes(
    ...
    return this.client.sendOperationRequest(
      { nodeRemoveParameter, poolId, options },
