...
export class ComputeNode {
  ...
  updateUser(
    ...
    return this.client.sendOperationRequest(
      { poolId, nodeUpdateUserParameter, nodeId, userName, options },
  ...
  uploadBatchServiceLogs(
    ...
    return this.client.sendOperationRequest(
      { poolId, uploadBatchServiceLogsConfiguration, nodeId, options },
