...
export type BodyComplexRestClientRestClient = Client & {
  ...
  polymorphism: PolymorphismOperations;
  polymorphicrecursive: PolymorphicrecursiveOperations;
  readonlyproperty: ReadonlypropertyOperations;
  flattencomplex: FlattencomplexOperations;
};
...
export default function BodyComplexRestClient(
  ...
  return {
    ...
    basic: {
      getValid: (options) => {
        return client.path("/complex/basic/valid").get(options);
      },
      putValid: (options) => {
        return client.path("/complex/basic/valid").put(options);
      },
      getInvalid: (options) => {
        return client.path("/complex/basic/invalid").get(options);
      },
      getEmpty: (options) => {
        return client.path("/complex/basic/empty").get(options);
      },
      getNull: (options) => {
        return client.path("/complex/basic/null").get(options);
      },
      getNotProvided: (options) => {
        return client.path("/complex/basic/notprovided").get(options);
      }
    },
    primitive: {
      getInt: (options) => {
        return client.path("/complex/primitive/integer").get(options);
      },
      putInt: (options) => {
        return client.path("/complex/primitive/integer").put(options);
      },
      getLong: (options) => {
        return client.path("/complex/primitive/long").get(options);
      },
      putLong: (options) => {
        return client.path("/complex/primitive/long").put(options);
      },
      getFloat: (options) => {
        return client.path("/complex/primitive/float").get(options);
      },
      putFloat: (options) => {
        return client.path("/complex/primitive/float").put(options);
      },
      getDouble: (options) => {
        return client.path("/complex/primitive/double").get(options);
      },
      putDouble: (options) => {
        return client.path("/complex/primitive/double").put(options);
      },
      getBool: (options) => {
        return client.path("/complex/primitive/bool").get(options);
      },
      putBool: (options) => {
        return client.path("/complex/primitive/bool").put(options);
      },
      getString: (options) => {
        return client.path("/complex/primitive/string").get(options);
      },
      putString: (options) => {
        return client.path("/complex/primitive/string").put(options);
      },
      getDate: (options) => {
        return client.path("/complex/primitive/date").get(options);
      },
      putDate: (options) => {
        return client.path("/complex/primitive/date").put(options);
      },
      getDateTime: (options) => {
        return client.path("/complex/primitive/datetime").get(options);
      },
      putDateTime: (options) => {
        return client.path("/complex/primitive/datetime").put(options);
      },
      getDateTimeRfc1123: (options) => {
        return client.path("/complex/primitive/datetimerfc1123").get(options);
      },
      putDateTimeRfc1123: (options) => {
        return client.path("/complex/primitive/datetimerfc1123").put(options);
      },
      getDuration: (options) => {
        return client.path("/complex/primitive/duration").get(options);
      },
      putDuration: (options) => {
        return client.path("/complex/primitive/duration").put(options);
      },
      getByte: (options) => {
        return client.path("/complex/primitive/byte").get(options);
      },
      putByte: (options) => {
        return client.path("/complex/primitive/byte").put(options);
      }
    },
    array: {
      getValid: (options) => {
        return client.path("/complex/array/valid").get(options);
      },
      putValid: (options) => {
        return client.path("/complex/array/valid").put(options);
      },
      getEmpty: (options) => {
        return client.path("/complex/array/empty").get(options);
      },
      putEmpty: (options) => {
        return client.path("/complex/array/empty").put(options);
      },
      getNotProvided: (options) => {
        return client.path("/complex/array/notprovided").get(options);
      }
    },
    dictionary: {
      getValid: (options) => {
        return client.path("/complex/dictionary/typed/valid").get(options);
      },
      putValid: (options) => {
        return client.path("/complex/dictionary/typed/valid").put(options);
      },
      getEmpty: (options) => {
        return client.path("/complex/dictionary/typed/empty").get(options);
      },
      putEmpty: (options) => {
        return client.path("/complex/dictionary/typed/empty").put(options);
      },
      getNull: (options) => {
        return client.path("/complex/dictionary/typed/null").get(options);
      },
      getNotProvided: (options) => {
        return client
    ...
    inheritance: {
      getValid: (options) => {
        return client.path("/complex/inheritance/valid").get(options);
      },
      putValid: (options) => {
        return client.path("/complex/inheritance/valid").put(options);
      }
    },
    polymorphism: {
      getValid: (options) => {
        return client.path("/complex/polymorphism/valid").get(options);
      },
      putValid: (options) => {
        return client.path("/complex/polymorphism/valid").put(options);
      },
      getDotSyntax: (options) => {
        return client.path("/complex/polymorphism/dotsyntax").get(options);
      },
      getComposedWithDiscriminator: (options) => {
        return client
          .path("/complex/polymorphism/composedWithDiscriminator")
          .get(options);
      },
      getComposedWithoutDiscriminator: (options) => {
        return client
          .path("/complex/polymorphism/composedWithoutDiscriminator")
          .get(options);
      },
      getComplicated: (options) => {
        return client.path("/complex/polymorphism/complicated").get(options);
      },
      putComplicated: (options) => {
        return client.path("/complex/polymorphism/complicated").put(options);
      },
      putMissingDiscriminator: (options) => {
        return client
          .path("/complex/polymorphism/missingdiscriminator")
          .put(options);
      },
      putValidMissingRequired: (options) => {
        return client
          .path("/complex/polymorphism/missingrequired/invalid")
          .put(options);
      }
    ...
    polymorphicrecursive: {
      getValid: (options) => {
        return client.path("/complex/polymorphicrecursive/valid").get(options);
      },
      putValid: (options) => {
        return client.path("/complex/polymorphicrecursive/valid").put(options);
      }
    },
    readonlyproperty: {
      getValid: (options) => {
        return client.path("/complex/readonlyproperty/valid").get(options);
      },
      putValid: (options) => {
        return client.path("/complex/readonlyproperty/valid").put(options);
      }
    },
    flattencomplex: {
      getValid: (options) => {
        return client.path("/complex/flatten/valid").get(options);
      }
    }
  };
}
