...
- [Package (NPM)](https://www.npmjs.com/package/@msinternal/url-rest)
...
Install the UrlRest client REST client library for JavaScript with `npm`:

```bash
npm install @msinternal/url-rest
```
...
```typescript
import UrlRestClient from "@azure-rest/purview-catalog";
import { DefaultAzureCredential } from "@azure/identity";
const client = UrlRestClient(
  "<ENDPOINT>",
