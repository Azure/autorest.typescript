# LLC client library for JavaScript
...
Install the LLC client REST client library for JavaScript with `npm`:

```bash
npm install @msinternal/rlcClient
```

### Create and authenticate a `LLCClient`
...
```typescript
import LLCClient from "@azure-rest/purview-catalog";
import { DefaultAzureCredential } from "@azure/identity";
const client = LLCClient(
  "<ENDPOINT>",
