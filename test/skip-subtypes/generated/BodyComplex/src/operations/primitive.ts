...
export class Primitive {
   ...
   * @returns Promise<coreHttp.RestResponse>
   */
  putDuration(complexBody: Models.DurationWrapper, options?: coreHttp.RequestOptionsBase): Promise<coreHttp.RestResponse>;
  /**
   * @param complexBody Please put 'P123DT22H14M12.011S'
   * @param callback The callback
   */
  putDuration(complexBody: Models.DurationWrapper, callback: coreHttp.ServiceCallback<void>): void;
  /**
   * @param complexBody Please put 'P123DT22H14M12.011S'
   * @param options The optional parameters
   * @param callback The callback
   */
  putDuration(complexBody: Models.DurationWrapper, options: coreHttp.RequestOptionsBase, callback: coreHttp.ServiceCallback<void>): void;
  putDuration(complexBody: Models.DurationWrapper, options?: coreHttp.RequestOptionsBase | coreHttp.ServiceCallback<void>, callback?: coreHttp.ServiceCallback<void>): Promise<coreHttp.RestResponse> {
    return this.client.sendOperationRequest(
      {
        complexBody,
        options
   ...
   * @returns Promise<coreHttp.RestResponse>
   */
  putByte(complexBody: Models.ByteWrapper, options?: coreHttp.RequestOptionsBase): Promise<coreHttp.RestResponse>;
  /**
   * @param complexBody Please put non-ascii byte string hex(FF FE FD FC 00 FA F9 F8 F7 F6)
   * @param callback The callback
   */
  putByte(complexBody: Models.ByteWrapper, callback: coreHttp.ServiceCallback<void>): void;
  /**
   * @param complexBody Please put non-ascii byte string hex(FF FE FD FC 00 FA F9 F8 F7 F6)
   * @param options The optional parameters
   * @param callback The callback
   */
  putByte(complexBody: Models.ByteWrapper, options: coreHttp.RequestOptionsBase, callback: coreHttp.ServiceCallback<void>): void;
  putByte(complexBody: Models.ByteWrapper, options?: coreHttp.RequestOptionsBase | coreHttp.ServiceCallback<void>, callback?: coreHttp.ServiceCallback<void>): Promise<coreHttp.RestResponse> {
    return this.client.sendOperationRequest(
      {
        complexBody,
        options
