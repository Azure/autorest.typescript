...
const packageName = "batchai-resource-manager";
const packageVersion = "";

export class BatchAIContext extends coreHttp.ServiceClient {
  $host: string;
  apiVersion: string;
  subscriptionId: string;

  /**
   * Initializes a new instance of the BatchAIContext class.
