...
export type ProviderSpecificFailoverInputUnion =
...
export interface FabricSpecificDetails {
   ...
   * Polymorphic discriminator, which specifies the different types this object can be
   */
  instanceType: "Azure" | "HyperVSite" | "VMM" | "VMware" | "VMwareV2";
}
...
export interface ReplicationProviderSpecificContainerCreationInput {
   ...
   * Polymorphic discriminator, which specifies the different types this object can be
   */
  instanceType: "A2A" | "6c7da455-506f-43ff-a16a-8eb101aebb70";
}
...
export interface UpdateReplicationProtectedItemProviderInput {
   ...
   * Polymorphic discriminator, which specifies the different types this object can be
   */
  instanceType: "A2A" | "HyperVReplicaAzure" | "InMageAzureV2";
}
...
export interface ProviderSpecificRecoveryPointDetails {
   ...
   * Polymorphic discriminator, which specifies the different types this object can be
   */
  instanceType: "A2A" | "InMageAzureV2";
}
...
export interface ReverseReplicationProviderSpecificInput {
   ...
   * Polymorphic discriminator, which specifies the different types this object can be
   */
  instanceType: "A2A" | "HyperVReplicaAzure" | "InMageAzureV2" | "InMage";
}
 ...
 */
export type A2AFailoverProviderInput = ProviderSpecificFailoverInput & {
  /**
 ...
 */
export type FabricReplicationGroupTaskDetails = TaskTypeDetails & {
  /**
   * The skipped reason.
   */
 ...
 */
export type HyperVReplicaAzureFailbackProviderInput = ProviderSpecificFailoverInput & {
  /**
   * Data sync option.
   */
 ...
 */
export type HyperVReplicaAzureFailoverProviderInput = ProviderSpecificFailoverInput & {
  /**
 ...
 */
export type HyperVReplicaBluePolicyInput = PolicyProviderSpecificInput & {
  /**
   * A value indicating the replication interval.
   */
  replicationFrequencyInSeconds?: number;
 ...
 */
export type InMageAzureV2FailoverProviderInput = ProviderSpecificFailoverInput & {
  /**
   * Location of the vault.
   */
  vaultLocation?: string;
 ...
 */
export type InMageFailoverProviderInput = ProviderSpecificFailoverInput & {
  /**
 ...
 */
export type RcmAzureMigrationPolicyDetails = PolicyProviderSpecificDetails & {
  /**
   * The recovery point threshold in minutes.
   */
  recoveryPointThresholdInMinutes?: number;
 ...
 */
export type RecoveryPlanShutdownGroupTaskDetails = GroupTaskDetails & {
  /**
   * The name.
   */
  name?: string;
 ...
 */
export type SanEnableProtectionInput = EnableProtectionProviderSpecificInput & {};
 ...
 */
export type VirtualMachineTaskDetails = TaskTypeDetails & {
  /**
   * The skipped reason.
   */
  skippedReason?: string;
 ...
 */
export type VmmVirtualMachineDetails = ConfigurationSettings & {
  /**
   * The source id of the object.
   */
  sourceItemId?: string;
 ...
 */
export type RecoveryPointSyncType =
 ...
 */
export type A2ARpRecoveryPointType =
  | "Latest"
 ...
 */
export type MultiVmSyncPointOption =
 ...
 */
export type InMageV2RpRecoveryPointType =
  | "Latest"
  | "LatestApplicationConsistent"
  | "LatestCrashConsistent"
  | "LatestProcessed";
