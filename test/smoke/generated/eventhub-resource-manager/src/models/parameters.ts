...
export const parameters7: coreHttp.OperationParameter = {
  parameterPath: "parameters",
  mapper: Mappers.ArmDisasterRecovery
};

export const alias: coreHttp.OperationURLParameter = {
  parameterPath: "alias",
  mapper: {
    constraints: {
      MaxLength: 50,
...
export const parameters8: coreHttp.OperationParameter = {
  parameterPath: "parameters",
  mapper: Mappers.Eventhub
};

export const eventHubName: coreHttp.OperationURLParameter = {
...
export const parameters10: coreHttp.OperationParameter = {
  parameterPath: "parameters",
  mapper: Mappers.ConsumerGroup
};

export const consumerGroupName: coreHttp.OperationURLParameter = {
