...
const packageName = "azsadmin-resource-manager-network";
const packageVersion = "";

export class NetworkAdminClientContext extends coreHttp.ServiceClient {
  $host: string;
  subscriptionId: string;
  apiVersion: string;

  /**
   * Initializes a new instance of the NetworkAdminClientContext class.
  ...
  constructor(
    ...
    this.apiVersion = options.apiVersion || "2015-06-15";
  }
}
