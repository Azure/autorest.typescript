...
export const parameters: coreHttp.OperationParameter = {
  ...
  mapper: Mappers.CreateDataLakeAnalyticsAccountParameters
};
...
export const dataLakeStoreAccountName: coreHttp.OperationURLParameter = {
...
export const dataLakeStoreAccountName1: coreHttp.OperationURLParameter = {
  parameterPath: "dataLakeStoreAccountName",
  mapper: {
    serializedName: "dataLakeStoreAccountName",
    required: true,
...
export const dataLakeStoreAccountName2: coreHttp.OperationURLParameter = {
  parameterPath: "dataLakeStoreAccountName",
  mapper: {
    serializedName: "dataLakeStoreAccountName",
    required: true,
...
export const parameters4: coreHttp.OperationParameter = {
  parameterPath: "parameters",
  mapper: Mappers.AddStorageAccountParameters
};
...
export const storageAccountName4: coreHttp.OperationURLParameter = {
  parameterPath: "storageAccountName",
  mapper: {
    serializedName: "storageAccountName",
    required: true,
...
export const storageAccountName5: coreHttp.OperationURLParameter = {
  parameterPath: "storageAccountName",
  mapper: {
    serializedName: "storageAccountName",
    required: true,
...
export const storageAccountName6: coreHttp.OperationURLParameter = {
  parameterPath: "storageAccountName",
  mapper: {
    serializedName: "storageAccountName",
    required: true,
...
export const parameters6: coreHttp.OperationParameter = {
  parameterPath: "parameters",
  mapper: Mappers.CreateOrUpdateComputePolicyParameters
};

export const computePolicyName: coreHttp.OperationURLParameter = {
...
export const computePolicyName1: coreHttp.OperationURLParameter = {
  parameterPath: "computePolicyName",
  mapper: {
    serializedName: "computePolicyName",
    required: true,
...
export const computePolicyName2: coreHttp.OperationURLParameter = {
  parameterPath: "computePolicyName",
  mapper: {
    serializedName: "computePolicyName",
    required: true,
...
export const computePolicyName3: coreHttp.OperationURLParameter = {
  parameterPath: "computePolicyName",
  mapper: {
    serializedName: "computePolicyName",
    required: true,
