...
const packageName = "redis-resource-manager";
const packageVersion = "";

export class RedisManagementClientContext extends coreHttp.ServiceClient {
  $host: string;
  apiVersion: string;
  ...
  constructor(
    ...
    subscriptionId: string,
    options?: Models.RedisManagementClientOptionalParams
  ) {
    ...
    this.apiVersion = options.apiVersion || "2019-07-01";
  }
}
