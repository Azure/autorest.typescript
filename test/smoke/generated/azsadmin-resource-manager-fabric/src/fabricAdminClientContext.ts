...
const packageName = "azsadmin-resource-manager-fabric";
const packageVersion = "";

export class FabricAdminClientContext extends coreHttp.ServiceClient {
  $host: string;
  subscriptionId: string;

  /**
   * Initializes a new instance of the FabricAdminClientContext class.
