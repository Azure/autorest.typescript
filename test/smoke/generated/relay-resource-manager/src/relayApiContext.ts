...
const packageName = "relay-resource-manager";
const packageVersion = "";

export class RelayApiContext extends coreHttp.ServiceClient {
  $host: string;
  apiVersion: string;
  subscriptionId: string;

  /**
   * Initializes a new instance of the RelayApiContext class.
