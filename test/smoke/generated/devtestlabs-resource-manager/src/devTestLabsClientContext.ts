...
const packageName = "devtestlabs-resource-manager";
const packageVersion = "";

export class DevTestLabsClientContext extends coreHttp.ServiceClient {
  $host: string;
  apiVersion: string;
  subscriptionId: string;

  /**
   * Initializes a new instance of the DevTestLabsClientContext class.
  ...
  constructor(
    ...
    subscriptionId: string,
    options?: Models.DevTestLabsClientOptionalParams
  ) {
