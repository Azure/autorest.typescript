...
export class Secrets {
  ...
  list(
    ...
    return this.client.sendOperationRequest(
      ...
      listOperationSpec
    ) as Promise<SecretsListResponse>;
  }
  ...
  ): Promise<LROPoller<SecretsCreateOrUpdateResponse>> {
  ...
  update(
    ...
    return this.client.sendOperationRequest(
      ...
      updateOperationSpec
    ) as Promise<SecretsUpdateResponse>;
  }
  ...
  listNext(
    ...
    ) as Promise<SecretsListNextResponse>;
  }
...
const getOperationSpec: coreHttp.OperationSpec = {
  ...
  queryParameters: [Parameters.apiVersion, Parameters.expand12],
  urlParameters: [
    Parameters.$host,
    Parameters.subscriptionId,
    Parameters.resourceGroupName,
