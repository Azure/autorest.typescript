...
const packageName = "signalr-resource-manager";
const packageVersion = "";

export class SignalRManagementClientContext extends coreHttp.ServiceClient {
  $host: string;
  apiVersion: string;
  subscriptionId: string;

  /**
   * Initializes a new instance of the SignalRManagementClientContext class.
  ...
  constructor(
    ...
    this.apiVersion = options.apiVersion || "2018-10-01";
  }
}
