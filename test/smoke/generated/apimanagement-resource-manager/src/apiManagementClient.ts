...
class ApiManagementClient extends ApiManagementClientContext {
  ...
  constructor(
    ...
    this.apiManagementServiceSkus = new operations.ApiManagementServiceSkus(
      this
    );
    ...
    this.gatewayHostnameConfiguration = new operations.GatewayHostnameConfiguration(
      this
    );
    ...
    this.notificationRecipientUser = new operations.NotificationRecipientUser(
      this
    );
    this.notificationRecipientEmail = new operations.NotificationRecipientEmail(
      this
    );
    ...
    this.userConfirmationPassword = new operations.UserConfirmationPassword(
      this
    );
  }
