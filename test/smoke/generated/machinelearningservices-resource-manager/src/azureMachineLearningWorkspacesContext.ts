...
const packageName = "machinelearningservices-resource-manager";
const packageVersion = "";

export class AzureMachineLearningWorkspacesContext extends coreHttp.ServiceClient {
  $host: string;
  apiVersion: string;
  subscriptionId: string;

  /**
   * Initializes a new instance of the AzureMachineLearningWorkspacesContext class.
