...
const packageName = "azsadmin-resource-manager-backup";
const packageVersion = "";

export class BackupAdminClientContext extends coreHttp.ServiceClient {
  $host: string;
  apiVersion: string;
  subscriptionId: string;

  /**
   * Initializes a new instance of the BackupAdminClientContext class.
