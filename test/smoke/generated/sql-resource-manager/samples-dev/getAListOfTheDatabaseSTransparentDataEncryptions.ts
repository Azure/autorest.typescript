...
//managedDatabaseTransparentDataEncryption.listByDatabase
async function getAListOfTheDatabaseSTransparentDataEncryptions() {
...
async function main() {
  ...
  await getAListOfTheDatabaseSTransparentDataEncryptions();
}
main();
