...
async function obtainListOfInstanceSTopResourceConsumingQueriesMinimalRequestAndResponse() {
...
async function main() {
  ...
  await obtainListOfInstanceSTopResourceConsumingQueriesMinimalRequestAndResponse();
}
main();
