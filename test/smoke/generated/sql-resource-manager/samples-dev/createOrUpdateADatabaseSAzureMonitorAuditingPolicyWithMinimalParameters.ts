...
async function createOrUpdateADatabaseSAzureMonitorAuditingPolicyWithMinimalParameters() {
...
async function main() {
  ...
  await createOrUpdateADatabaseSAzureMonitorAuditingPolicyWithMinimalParameters();
}
main();
