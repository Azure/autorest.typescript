...
async function uploadATdeCertificate() {
  ...
  await client.managedInstanceTdeCertificates
    .beginCreateAndWait(resourceGroupName, managedInstanceName, parameters)
    .then((res) => {
      console.log(res);
    });
}
