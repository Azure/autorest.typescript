...
async function createOrUpdateAnExtendedDatabasesAzureMonitorAuditingPolicyWithMinimalParameters() {
...
async function main() {
  ...
  await createOrUpdateAnExtendedDatabasesAzureMonitorAuditingPolicyWithMinimalParameters();
}
main();
