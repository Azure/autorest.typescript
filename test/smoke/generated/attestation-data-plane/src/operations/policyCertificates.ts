...
export class PolicyCertificates {
   ...
   * @param policyCertificateToAdd An RFC7519 JSON Web Token containing a claim named
   *                               "aas-policyCertificate" whose value is an RFC7517 JSON Web Key which specifies a new key to add. The
  ...
  add(
    ...
    return this.client.sendOperationRequest(
      { policyCertificateToAdd, options: operationOptions },
      addOperationSpec
   ...
   * @param policyCertificateToRemove An RFC7519 JSON Web Token containing a claim named
   *                                  "aas-policyCertificate" whose value is an RFC7517 JSON Web Key which specifies a new key to update.
  ...
  remove(
    ...
    return this.client.sendOperationRequest(
      { policyCertificateToRemove, options: operationOptions },
      removeOperationSpec
...
const getOperationSpec: coreHttp.OperationSpec = {
  path: "/operations/policy/certificates",
  httpMethod: "GET",
  responses: {
    200: {
