...
export const CsmCopySlotEntity: coreClient.CompositeMapper = {
...
export const KeyVaultReferenceCollection: coreClient.CompositeMapper = {
...
export const KeyVaultReferenceResource: coreClient.CompositeMapper = {
