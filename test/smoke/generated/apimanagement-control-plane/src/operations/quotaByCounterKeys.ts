...
import {
  QuotaByCounterKeysListResponse,
...
export class QuotaByCounterKeys {
  ...
  ): Promise<QuotaByCounterKeysListResponse> {
    const operationOptions: coreHttp.RequestOptionsBase = coreHttp.operationOptionsToRequestOptionsBase(
      options || {}
    );
    return this.client.sendOperationRequest(
      { apimBaseUrl, quotaCounterKey, options: operationOptions },
      listOperationSpec
    ) as Promise<QuotaByCounterKeysListResponse>;
  }
  ...
  update(
    ...
    return this.client.sendOperationRequest(
      { apimBaseUrl, quotaCounterKey, parameters, options: operationOptions },
      updateOperationSpec
...
const listOperationSpec: coreHttp.OperationSpec = {
  ...
  urlParameters: [Parameters.apimBaseUrl, Parameters.quotaCounterKey],
  serializer
};
