...
const packageName = "analysisservices-resource-manager";
const packageVersion = "";

export class AzureAnalysisServicesContext extends coreHttp.ServiceClient {
  $host: string;
  apiVersion: string;
  subscriptionId: string;

  /**
   * Initializes a new instance of the AzureAnalysisServicesContext class.
