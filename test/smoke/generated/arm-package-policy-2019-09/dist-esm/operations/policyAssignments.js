...
export class PolicyAssignmentsImpl {
    ...
    listForResourcePagingPage(resourceGroupName, resourceProviderNamespace, parentResourcePath, resourceType, resourceName, options) {
        return __asyncGenerator(this, arguments, function* listForResourcePagingPage_1() {
            let result = yield __await(this._listForResource(resourceGroupName, resourceProviderNamespace, parentResourcePath, resourceType, resourceName, options));
            yield yield __await(result.value || []);
            let continuationToken = result.nextLink;
            while (continuationToken) {
    ...
    listForResourcePagingAll(resourceGroupName, resourceProviderNamespace, parentResourcePath, resourceType, resourceName, options) {
        return __asyncGenerator(this, arguments, function* listForResourcePagingAll_1() {
            var e_2, _a;
            try {
                for (var _b = __asyncValues(this.listForResourcePagingPage(resourceGroupName, resourceProviderNamespace, parentResourcePath, resourceType, resourceName, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield __await(yield* __asyncDelegator(__asyncValues(page)));
                }
            }
     ...
     * @param options The options parameters.
     */
    listForManagementGroup(managementGroupId, filter, options) {
        const iter = this.listForManagementGroupPagingAll(managementGroupId, filter, options);
        return {
            next() {
                return iter.next();
            },
            ...
            byPage: () => {
                return this.listForManagementGroupPagingPage(managementGroupId, filter, options);
            }
        };
    }
    listForManagementGroupPagingPage(managementGroupId, filter, options) {
        return __asyncGenerator(this, arguments, function* listForManagementGroupPagingPage_1() {
            let result = yield __await(this._listForManagementGroup(managementGroupId, filter, options));
            yield yield __await(result.value || []);
            let continuationToken = result.nextLink;
            while (continuationToken) {
                result = yield __await(this._listForManagementGroupNext(managementGroupId, filter, continuationToken, options));
                continuationToken = result.nextLink;
                yield yield __await(result.value || []);
            }
        });
    }
    listForManagementGroupPagingAll(managementGroupId, filter, options) {
        return __asyncGenerator(this, arguments, function* listForManagementGroupPagingAll_1() {
            var e_3, _a;
            try {
                for (var _b = __asyncValues(this.listForManagementGroupPagingPage(managementGroupId, filter, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield __await(yield* __asyncDelegator(__asyncValues(page)));
                }
            }
     ...
     * @param options The options parameters.
     */
    _listForManagementGroup(managementGroupId, filter, options) {
        return this.client.sendOperationRequest({ managementGroupId, filter, options }, listForManagementGroupOperationSpec);
    }
    /**
     * This operation retrieves the list of all policy assignments associated with the given subscription
     * that match the optional given $filter. Valid values for $filter are: 'atScope()' or
     ...
     * @param options The options parameters.
     */
    _listForManagementGroupNext(managementGroupId, filter, nextLink, options) {
        return this.client.sendOperationRequest({ managementGroupId, filter, nextLink, options }, listForManagementGroupNextOperationSpec);
    }
    /**
     * ListNext
