...
class LogicManagementClient extends LogicManagementClientContext {
  ...
  constructor(
    ...
    options?: Models.LogicManagementClientOptionalParams
  ) {
    ...
    this.workflowTriggerHistories = new operations.WorkflowTriggerHistories(
      this
    );
    this.workflowRuns = new operations.WorkflowRuns(this);
    this.workflowRunActions = new operations.WorkflowRunActions(this);
    this.workflowRunActionRepetitions = new operations.WorkflowRunActionRepetitions(
      this
    );
    this.workflowRunActionRepetitionsRequestHistories = new operations.WorkflowRunActionRepetitionsRequestHistories(
      this
    );
    this.workflowRunActionRequestHistories = new operations.WorkflowRunActionRequestHistories(
      this
    );
    this.workflowRunActionScopeRepetitions = new operations.WorkflowRunActionScopeRepetitions(
      this
    );
    ...
    this.integrationAccountAssemblies = new operations.IntegrationAccountAssemblies(
      this
    );
    this.integrationAccountBatchConfigurations = new operations.IntegrationAccountBatchConfigurations(
      this
    );
    this.integrationAccountSchemas = new operations.IntegrationAccountSchemas(
      this
    );
    this.integrationAccountMaps = new operations.IntegrationAccountMaps(this);
    this.integrationAccountPartners = new operations.IntegrationAccountPartners(
      this
    );
    this.integrationAccountAgreements = new operations.IntegrationAccountAgreements(
      this
    );
    this.integrationAccountCertificates = new operations.IntegrationAccountCertificates(
      this
    );
    this.integrationAccountSessions = new operations.IntegrationAccountSessions(
      this
    );
    this.integrationServiceEnvironments = new operations.IntegrationServiceEnvironments(
      this
    );
    this.integrationServiceEnvironmentSkus = new operations.IntegrationServiceEnvironmentSkus(
      this
    );
    this.integrationServiceEnvironmentNetworkHealth = new operations.IntegrationServiceEnvironmentNetworkHealth(
      this
    );
    this.integrationServiceEnvironmentManagedApis = new operations.IntegrationServiceEnvironmentManagedApis(
      this
    );
    this.integrationServiceEnvironmentManagedApiOperations = new operations.IntegrationServiceEnvironmentManagedApiOperations(
      this
    );
