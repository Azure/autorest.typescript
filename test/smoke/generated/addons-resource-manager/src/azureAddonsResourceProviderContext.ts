...
const packageName = "addons-resource-manager";
const packageVersion = "";

export class AzureAddonsResourceProviderContext extends coreHttp.ServiceClient {
  $host: string;
  apiVersion: string;
  subscriptionId: string;

  /**
   * Initializes a new instance of the AzureAddonsResourceProviderContext class.
  ...
  constructor(
    ...
    this.apiVersion = options.apiVersion || "2018-03-01";
  }
}
