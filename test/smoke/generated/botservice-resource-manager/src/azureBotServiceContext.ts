...
const packageName = "botservice-resource-manager";
const packageVersion = "";

export class AzureBotServiceContext extends coreHttp.ServiceClient {
  $host: string;
  apiVersion: string;
  ...
  constructor(
    ...
    this.apiVersion = options.apiVersion || "2018-07-12";
  }
}
