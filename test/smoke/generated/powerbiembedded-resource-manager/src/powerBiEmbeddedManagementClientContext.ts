...
const packageName = "powerbiembedded-resource-manager";
const packageVersion = "";

export class PowerBiEmbeddedManagementClientContext extends coreHttp.ServiceClient {
  $host: string;
  subscriptionId: string;
  apiVersion: string;

  /**
   * Initializes a new instance of the PowerBiEmbeddedManagementClientContext class.
