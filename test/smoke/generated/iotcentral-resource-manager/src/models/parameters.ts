...
export const app: coreHttp.OperationParameter = {
  parameterPath: "app",
  mapper: Mappers.App
};

export const appPatch: coreHttp.OperationParameter = {
  parameterPath: "appPatch",
  mapper: Mappers.AppPatch
};
...
export const operationInputs1: coreHttp.OperationParameter = {
  parameterPath: "operationInputs",
  mapper: Mappers.OperationInputs
};
