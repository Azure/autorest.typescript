...
const packageName = "hanaonazure-resource-manager";
const packageVersion = "";

export class HanaManagementClientContext extends coreHttp.ServiceClient {
  $host: string;
  apiVersion: string;
  subscriptionId: string;

  /**
   * Initializes a new instance of the HanaManagementClientContext class.
  ...
  constructor(
    ...
    this.apiVersion = options.apiVersion || "2017-11-03-preview";
  }
}
