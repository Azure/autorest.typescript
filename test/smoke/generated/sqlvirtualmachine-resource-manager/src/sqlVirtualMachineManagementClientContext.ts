...
const packageName = "sqlvirtualmachine-resource-manager";
const packageVersion = "";

export class SqlVirtualMachineManagementClientContext extends coreHttp.ServiceClient {
  $host: string;
  subscriptionId: string;
  apiVersion: string;

  /**
   * Initializes a new instance of the SqlVirtualMachineManagementClientContext class.
