...
const packageName = "customer-insights-resource-manager";
const packageVersion = "";

export class CustomerInsightsManagementClientContext extends coreHttp.ServiceClient {
  $host: string;
  apiVersion: string;
  subscriptionId: string;

  /**
   * Initializes a new instance of the CustomerInsightsManagementClientContext class.
