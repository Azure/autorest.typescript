...
const packageName = "powerbidedicated-resource-manager";
const packageVersion = "";

export class PowerBIDedicatedContext extends coreHttp.ServiceClient {
  $host: string;
  apiVersion: string;
  subscriptionId: string;

  /**
   * Initializes a new instance of the PowerBIDedicatedContext class.
  ...
  constructor(
    ...
    this.apiVersion = options.apiVersion || "2017-10-01";
  }
}
