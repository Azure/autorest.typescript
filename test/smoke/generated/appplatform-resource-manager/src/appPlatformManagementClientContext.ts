...
const packageName = "appplatform-resource-manager";
const packageVersion = "";

export class AppPlatformManagementClientContext extends coreHttp.ServiceClient {
  $host: string;
  apiVersion: string;
  ...
  constructor(
    ...
    this.apiVersion = options.apiVersion || "2019-05-01-preview";
  }
}
