...
export class Job {
  ...
  patch(
    ...
    return this.client.sendOperationRequest(
      { jobPatchParameter, jobId, options: operationOptions },
      patchOperationSpec
  ...
  update(
    ...
    return this.client.sendOperationRequest(
      { jobId, jobUpdateParameter, options: operationOptions },
      updateOperationSpec
  ...
  disable(
    ...
    return this.client.sendOperationRequest(
      { jobDisableParameter, jobId, options: operationOptions },
  ...
  listFromJobScheduleNext(
    ...
    return this.client.sendOperationRequest(
      { jobScheduleId, nextLink, options: operationOptions },
  ...
  listPreparationAndReleaseTaskStatusNext(
    ...
    return this.client.sendOperationRequest(
      { jobId, nextLink, options: operationOptions },
