...
export class Task {
  ...
  add(
    ...
    return this.client.sendOperationRequest(
      { task, jobId, options: operationOptions },
      addOperationSpec
  ...
  addCollection(
    ...
    return this.client.sendOperationRequest(
      { taskCollection, jobId, options: operationOptions },
  ...
  update(
    ...
    return this.client.sendOperationRequest(
      { taskUpdateParameter, jobId, taskId, options: operationOptions },
      updateOperationSpec
  ...
  listNext(
    ...
    return this.client.sendOperationRequest(
      { nextLink, jobId, options: operationOptions },
