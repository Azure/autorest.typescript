...
const packageName = "billing-resource-manager";
const packageVersion = "";

export class BillingManagementClientContext extends coreHttp.ServiceClient {
  $host: string;
  apiVersion: string;
  subscriptionId: string;

  /**
   * Initializes a new instance of the BillingManagementClientContext class.
