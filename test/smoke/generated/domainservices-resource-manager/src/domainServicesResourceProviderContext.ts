...
const packageName = "domainservices-resource-manager";
const packageVersion = "";

export class DomainServicesResourceProviderContext extends coreHttp.ServiceClient {
  $host: string;
  apiVersion: string;
  subscriptionId: string;

  /**
   * Initializes a new instance of the DomainServicesResourceProviderContext class.
