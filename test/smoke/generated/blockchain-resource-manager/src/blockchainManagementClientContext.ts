...
const packageName = "blockchain-resource-manager";
const packageVersion = "";

export class BlockchainManagementClientContext extends coreHttp.ServiceClient {
  $host: string;
  apiVersion: string;
  subscriptionId: string;

  /**
   * Initializes a new instance of the BlockchainManagementClientContext class.
  ...
  constructor(
    ...
    this.apiVersion = options.apiVersion || "2018-06-01-preview";
  }
}
