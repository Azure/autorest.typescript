...
export class DdosCustomPoliciesImpl {
    ...
    beginDelete(resourceGroupName, ddosCustomPolicyName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, ddosCustomPolicyName, options }, deleteOperationSpec);
    ...
    beginCreateOrUpdate(resourceGroupName, ddosCustomPolicyName, parameters, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, ddosCustomPolicyName, parameters, options }, createOrUpdateOperationSpec);
            return new LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs,
