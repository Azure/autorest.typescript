...
export class RouteFiltersImpl {
    ...
    beginDelete(resourceGroupName, routeFilterName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, routeFilterName, options }, deleteOperationSpec);
    ...
    beginCreateOrUpdate(resourceGroupName, routeFilterName, routeFilterParameters, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, routeFilterName, routeFilterParameters, options }, createOrUpdateOperationSpec);
            return new LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs,
