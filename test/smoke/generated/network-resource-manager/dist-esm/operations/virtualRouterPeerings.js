...
export class VirtualRouterPeeringsImpl {
    ...
    listPagingPage(resourceGroupName, virtualRouterName, options) {
        return __asyncGenerator(this, arguments, function* listPagingPage_1() {
            let result = yield __await(this._list(resourceGroupName, virtualRouterName, options));
    ...
    listPagingAll(resourceGroupName, virtualRouterName, options) {
        return __asyncGenerator(this, arguments, function* listPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = __asyncValues(this.listPagingPage(resourceGroupName, virtualRouterName, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
    ...
    beginDelete(resourceGroupName, virtualRouterName, peeringName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, virtualRouterName, peeringName, options }, deleteOperationSpec);
