...
export class PublicIPPrefixesImpl {
    ...
    beginDelete(resourceGroupName, publicIpPrefixName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, publicIpPrefixName, options }, deleteOperationSpec);
    ...
    beginCreateOrUpdate(resourceGroupName, publicIpPrefixName, parameters, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, publicIpPrefixName, parameters, options }, createOrUpdateOperationSpec);
            return new LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs,
                lroResourceLocationConfig: "location"
