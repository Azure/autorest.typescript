...
export class ExpressRoutePortsImpl {
    ...
    beginDelete(resourceGroupName, expressRoutePortName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, expressRoutePortName, options }, deleteOperationSpec);
    ...
    beginCreateOrUpdate(resourceGroupName, expressRoutePortName, parameters, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, expressRoutePortName, parameters, options }, createOrUpdateOperationSpec);
            return new LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs,
