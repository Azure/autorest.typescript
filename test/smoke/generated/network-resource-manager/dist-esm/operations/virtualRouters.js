...
export class VirtualRoutersImpl {
    ...
    beginDelete(resourceGroupName, virtualRouterName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, virtualRouterName, options }, deleteOperationSpec);
    ...
    beginCreateOrUpdate(resourceGroupName, virtualRouterName, parameters, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, virtualRouterName, parameters, options }, createOrUpdateOperationSpec);
            return new LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs,
