...
export class SecurityPartnerProvidersImpl {
    ...
    beginDelete(resourceGroupName, securityPartnerProviderName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, securityPartnerProviderName, options }, deleteOperationSpec);
    ...
    beginCreateOrUpdate(resourceGroupName, securityPartnerProviderName, parameters, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, securityPartnerProviderName, parameters, options }, createOrUpdateOperationSpec);
            return new LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs,
