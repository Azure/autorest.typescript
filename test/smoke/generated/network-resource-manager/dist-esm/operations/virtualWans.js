...
export class VirtualWansImpl {
    ...
    beginCreateOrUpdate(resourceGroupName, virtualWANName, wANParameters, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, virtualWANName, wANParameters, options }, createOrUpdateOperationSpec);
    ...
    beginDelete(resourceGroupName, virtualWANName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, virtualWANName, options }, deleteOperationSpec);
            return new LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs,
