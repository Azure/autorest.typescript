...
const packageName = "azsadmin-resource-manager-deployment";
const packageVersion = "";

export class DeploymentAdminClientContext extends coreHttp.ServiceClient {
  $host: string;
  apiVersion: string;
  subscriptionId: string;

  /**
   * Initializes a new instance of the DeploymentAdminClientContext class.
  ...
  constructor(
    ...
    this.apiVersion = options.apiVersion || "2019-01-01";
  }
}
