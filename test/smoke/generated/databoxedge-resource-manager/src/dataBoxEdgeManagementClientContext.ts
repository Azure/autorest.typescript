...
const packageName = "databoxedge-resource-manager";
const packageVersion = "";

export class DataBoxEdgeManagementClientContext extends coreHttp.ServiceClient {
  $host: string;
  apiVersion: string;
  subscriptionId: string;

  /**
   * Initializes a new instance of the DataBoxEdgeManagementClientContext class.
