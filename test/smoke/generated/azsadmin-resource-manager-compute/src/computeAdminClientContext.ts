...
const packageName = "azsadmin-resource-manager-compute";
const packageVersion = "";

export class ComputeAdminClientContext extends coreHttp.ServiceClient {
  $host: string;
  subscriptionId: string;

  /**
   * Initializes a new instance of the ComputeAdminClientContext class.
