...
export const AzureMetricsDocument: coreHttp.CompositeMapper = {
  serializedName: "AzureMetricsDocument",
  type: {
    name: "Composite",
...
export const AzureMetricsData: coreHttp.CompositeMapper = {
  serializedName: "AzureMetricsData",
  type: {
    name: "Composite",
    className: "AzureMetricsData",
    modelProperties: {
...
export const AzureMetricsBaseData: coreHttp.CompositeMapper = {
  serializedName: "AzureMetricsBaseData",
  type: {
    name: "Composite",
    className: "AzureMetricsBaseData",
    modelProperties: {
      ...
      dimNames: {
        ...
        type: {
          ...
          element: {
            type: { name: "String" },
            serializedName: "AzureMetricsBaseDataDimNamesItem"
          }
        }
      },
      series: {
...
export const AzureTimeSeriesData: coreHttp.CompositeMapper = {
  serializedName: "AzureTimeSeriesData",
  type: {
    name: "Composite",
    ...
    modelProperties: {
      dimValues: {
        ...
        type: {
          ...
          element: {
            type: { name: "String" },
            serializedName: "AzureTimeSeriesDataDimValuesItem"
          }
        }
      },
      min: {
...
export const AzureMetricsResult: coreHttp.CompositeMapper = {
  serializedName: "AzureMetricsResult",
  type: {
    name: "Composite",
