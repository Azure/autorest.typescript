 ...
 */
export const AzureMetricsDocument = {
    type: {
        name: "Composite",
...
export const AzureMetricsBaseData = {
    type: {
        name: "Composite",
        className: "AzureMetricsBaseData",
        modelProperties: {
...
export const AzureTimeSeriesData = {
    type: {
        name: "Composite",
        className: "AzureTimeSeriesData",
        modelProperties: {
...
export const AzureMetricsResult = {
    type: {
        name: "Composite",
