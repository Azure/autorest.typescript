...
const packageName = "search-resource-manager";
const packageVersion = "";

export class SearchManagementClientContext extends coreHttp.ServiceClient {
  $host: string;
  apiVersion: string;
  subscriptionId: string;

  /**
   * Initializes a new instance of the SearchManagementClientContext class.
  ...
  constructor(
    ...
    this.apiVersion = options.apiVersion || "2015-08-19";
  }
}
