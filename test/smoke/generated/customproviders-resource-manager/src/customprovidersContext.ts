...
const packageName = "customproviders-resource-manager";
const packageVersion = "";

export class CustomprovidersContext extends coreHttp.ServiceClient {
  $host: string;
  apiVersion: string;
  subscriptionId: string;

  /**
   * Initializes a new instance of the CustomprovidersContext class.
