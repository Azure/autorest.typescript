...
const packageName = "support-resource-manager";
const packageVersion = "";

export class MicrosoftSupportContext extends coreHttp.ServiceClient {
  $host: string;
  apiVersion: string;
  subscriptionId: string;

  /**
   * Initializes a new instance of the MicrosoftSupportContext class.
