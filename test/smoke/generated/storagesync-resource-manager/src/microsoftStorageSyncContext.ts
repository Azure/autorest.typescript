...
const packageName = "storagesync-resource-manager";
const packageVersion = "";

export class MicrosoftStorageSyncContext extends coreHttp.ServiceClient {
  $host: string;
  apiVersion: string;
  subscriptionId: string;

  /**
   * Initializes a new instance of the MicrosoftStorageSyncContext class.
