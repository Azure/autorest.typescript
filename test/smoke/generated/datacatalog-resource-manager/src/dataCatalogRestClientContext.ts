...
const packageName = "datacatalog-resource-manager";
const packageVersion = "";

export class DataCatalogRestClientContext extends coreHttp.ServiceClient {
  $host: string;
  apiVersion: string;
  ...
  /**
   * Initializes a new instance of the DataCatalogRestClientContext class.
