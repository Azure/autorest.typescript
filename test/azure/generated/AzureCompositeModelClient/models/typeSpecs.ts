 ...
 * Optional Parameters.
 */
export const AzureCompositeModelCreateOptionalParams: CompositeTypeSpec = compositeSpec("AzureCompositeModelCreateOptionalParams", {
  /**
   * Dictionary of Array of product
   */
  productDictionaryOfArray: {
 ...
 * Optional Parameters.
 */
export const AzureCompositeModelUpdateOptionalParams: CompositeTypeSpec = compositeSpec("AzureCompositeModelUpdateOptionalParams", {
  /**
   * Array of dictionary of products
   */
  productArrayOfDictionary: {
