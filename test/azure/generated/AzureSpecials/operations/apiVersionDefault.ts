...
export class ApiVersionDefault {
   ...
   */
  getMethodGlobalValidWithHttpOperationResponse(options?: msRest.RequestOptionsBase): Promise<msRest.BaseHttpOperationResponse> {
   ...
   * @reject {Error|ServiceError} The error object.
   */
  getMethodGlobalNotProvidedValidWithHttpOperationResponse(options?: msRest.RequestOptionsBase): Promise<msRest.BaseHttpOperationResponse> {
    return this.client.sendOperationRequest(
      {
        options
      },
   ...
   * @reject {Error|ServiceError} The error object.
   */
  getPathGlobalValidWithHttpOperationResponse(options?: msRest.RequestOptionsBase): Promise<msRest.BaseHttpOperationResponse> {
    return this.client.sendOperationRequest(
      {
        options
      },
   ...
   * @reject {Error|ServiceError} The error object.
   */
  getSwaggerGlobalValidWithHttpOperationResponse(options?: msRest.RequestOptionsBase): Promise<msRest.BaseHttpOperationResponse> {
    return this.client.sendOperationRequest(
      {
        options
      },
