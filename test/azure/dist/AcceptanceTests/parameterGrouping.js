...
const autoRestParameterGroupingTestService_1 = require("../Expected/AcceptanceTests/AzureParameterGrouping/autoRestParameterGroupingTestService");
...
describe('typescript', function () {
    ...
    describe('Azure Parameter Grouping', function () {
        var testClient = new autoRestParameterGroupingTestService_1.AutoRestParameterGroupingTestService(credentials, baseUri, clientOptions);
        ...
        it('should accept valid optional parameters', function (done) {
            testClient.parameterGrouping.postOptional({ parameterGroupingPostOptionalParameters: { query: query, customHeader: header } }, function (error, result, request, response) {
                should.not.exist(error);
                response.status.should.equal(200);
                done();
            });
