...
const autoRestLongRunningOperationTestService_1 = require("../Expected/AcceptanceTests/Lro/autoRestLongRunningOperationTestService");
...
describe('typescript', function () {
    describe('Swagger LRO Happy BAT', function () {
        ...
        var testClient = new autoRestLongRunningOperationTestService_1.AutoRestLongRunningOperationTestService(credentials, baseUri, clientOptions);
