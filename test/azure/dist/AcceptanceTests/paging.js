...
const autoRestPagingTestService_1 = require("../Expected/AcceptanceTests/Paging/autoRestPagingTestService");
...
describe('typescript', function () {
    describe('Swagger Pageable BAT', function () {
        describe('Pageable Operations', function () {
            ...
            var testClient = new autoRestPagingTestService_1.AutoRestPagingTestService(credentials, baseUri, clientOptions);
