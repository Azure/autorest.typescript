...
const autoRestAzureSpecialParametersTestClient_1 = require("../Expected/AcceptanceTests/AzureSpecials/autoRestAzureSpecialParametersTestClient");
...
describe('typescript', function () {
    describe('Azure Special Properties', function () {
        ...
        it('should not overwrite x-ms-client-request-id', function (done) {
            var testClient2 = new autoRestAzureSpecialParametersTestClient_1.AutoRestAzureSpecialParametersTestClient(credentials, dummySubscriptionId, baseUri, clientOptions);
...
//# sourceMappingURL=azureSpecialProperties.js.map